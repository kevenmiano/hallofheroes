...
export class HoleBalance extends FUI_HoleBalance {
    ...
    private addEvent() {
        PlayerManager.Instance.currentPlayerModel.playerInfo.addEventListener(PlayerEvent.PLAYER_INFO_UPDATE, this._runeNumUpdate, this);  
    ...
    private removeEvent() {
        ...
        PlayerManager.Instance.currentPlayerModel.playerInfo.removeEventListener(PlayerEvent.PLAYER_INFO_UPDATE, this._runeNumUpdate, this); 
    }
