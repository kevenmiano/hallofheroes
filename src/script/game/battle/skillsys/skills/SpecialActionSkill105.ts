...
export class SpecialActionSkill105 extends CommonActionSkill {
    public inheritType: InheritIActionType = InheritIActionType.SpecialActionSkill105
    ...
    private addPrepareGas() {
        let heroView: BaseRoleView = (BattleManager.Instance.battleMap.rolesDict[BattleManager.Instance.battleModel.selfHero.livingId]);
