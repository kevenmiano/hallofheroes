...
export default class QuestionNaireWnd extends BaseWindow {
    ...
    private updateCountDown() {
        if (this._countDown > 0) {
            this.leftTime.setVar('text', LangManager.Instance.GetTranslation("map.campaign.view.ui.demon.ConsortiaDemonWoundView.activityTimeTip")).flushVars();
            ...
            this.leftTime.setVar('text', LangManager.Instance.GetTranslation("answer.errinfo.end")).flushVars();
    ...
    private addEvent() {
        ...
        this.awardList.itemRenderer = Laya.Handler.create(this, this.renderListItem, null, false);
    ...
    private initListData() {
        let Questionnaire_reward: t_s_configData = TempleteManager.Instance.getConfigInfoByConfigName( "Questionnaire_reward");
