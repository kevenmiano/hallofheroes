 ...
 * @Description: 战斗场景
 */
export default class BattleScene extends BaseSceneView implements IBaseSceneView, IEnterFrame {
    ...
    public enterOver(): Promise<void> {
        return new Promise(async resolve => {
            ...
            Laya.loader.load(SoundIds.BATTLE_RESULT_WIN, Laya.Handler.create(this, function () {
            ...
            NotificationManager.Instance.dispatchEvent(BattleEvent.ENTER_BATTLE_SCENE)
            resolve();
        });
    }
    ...
    public leaving(): Promise<void> {
        return new Promise(resolve => {
            Logger.yyz("leaving战斗场景:  :  ", SceneManager.Instance.currentType, SceneManager.Instance.nextScene.SceneName);
            ...
            LayerMgr.Instance.clearGameMenuLayer();
            BattleManager.Instance.disposeBattle(SceneManager.Instance.nextScene.SceneName == SceneType.CAMPAIGN_MAP_SCENE);
