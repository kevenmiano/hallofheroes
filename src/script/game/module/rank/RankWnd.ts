...
export default class RankWnd extends BaseWindow {
    ...
    private initTitle() {
        ...
        itemTitle.titleColorList = this.model.getTitleColorByIndex(this.ctrl.rankIndex);
        itemTitle.titleBg = ""
    ...
    helpBtnClick() {
        ...
        switch (this.ctrl.rankIndex) {
            case RankIndex.RankItemR5_001:
                ...
                content = LangManager.Instance.GetTranslation("pvpHeroHelperFrame.content");
                break;
            default:
                break;
        }
    ...
    private initSelfInfo() {
        ...
        switch (this.ctrl.rankIndex) {
            case RankIndex.RankItemR5_001:
                rankInfoSelf = fgui.UIPackage.createObject(EmPackName.Base, "RankInfoSelf") as RankInfoSelf
                break;
            default:
                break;
        }
