...
export default class SettingWnd extends BaseWindow {
    ...
    addEvent() {
        ...
        this.musicProgress.on(fairygui.Events.STATE_CHANGED, this, this.__backMusicSilderchange);
        this.effectProgress.on(fairygui.Events.STATE_CHANGED, this, this.__musicEffectSilderchange);
    ...
    removeEvent() {
        ...
        this.musicProgress.off(fairygui.Events.STATE_CHANGED, this, this.__backMusicSilderchange);
        this.effectProgress.off(fairygui.Events.STATE_CHANGED, this, this.__musicEffectSilderchange);
