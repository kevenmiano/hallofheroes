    ...
    private refreshView() {
        if (this._info) {
            ...
            if (this._info.index == 1 || this._info.index == 3) {
                ...
                if (this.sevenGoalsModel.currentSelectedDay < this.sevenGoalsModel.sevenCurrentDay) {
            ...
            if(this._info.index == 1)//成长任务
            {
                this.red.selectedIndex = this.sevenGoalsModel.checkTabIndex1(this.sevenGoalsModel.currentSelectedDay)?1:0;
            }
            else if(this._info.index == 2)//今日挑战
            {
                if(this.sevenGoalsModel.currentSelectedDay != this.sevenGoalsModel.sevenCurrentDay)
                {
                ...
                {
                    if(this.sevenGoalsModel.checkTabIndex2()){//有未领奖的挑战任务
                        this.red.selectedIndex = 1;
                    }else if(this.sevenGoalsModel.checkTabIndex3()){//有未完成的挑战任务
