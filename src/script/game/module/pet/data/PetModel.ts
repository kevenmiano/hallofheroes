...
export default class PetModel extends FrameDataBase {
  ...
  public static potencyActiveTempIdArr = [
    208067, 208068, 208069, 208070, 208071,
  ]; //英灵潜能激活的五种道具
  ...
  public static get petCompose100CostPoint(): number {
    if (this._petCompose100CostPoint == 0) {
      ...
      var temp: ConfigInfosTempInfo =
        TempleteManager.Instance.getConfigInfoByConfigName("fuse_pet_points");
      if (temp) {
