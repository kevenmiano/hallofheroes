    ...
    public set info(value: ConsortiaEventInfo) {
        ...
        if (this._info) {
            if (this._info.remark.indexOf("|") >= 0) {
                this.tfEvent.text = "<font color='#ffffff'>" + DateFormatter.timeFormat1(this._info.createDate) + " </font>" + this.decode(this._info.remark);
                return;
            }
            this.tfEvent.text = "<font color='#ffffff'>" + DateFormatter.timeFormat1(this._info.createDate) + " </font>" + this._info.remark;
        }
        else {
            this.tfEvent.text = "";
        }
        ...
        switch (this._info.types) {
            ...
            case ConsortiaEventInfo.KICK:
                return "<font color='#fc7d00'>" + arr[0] + "</font>" + arr[1] +
                    "<font color='#fc7d00'>" + arr[2] + "</font>" + arr[3];
            ...
            case ConsortiaEventInfo.EVENT:
                if (arr.length == 3) {
                    return arr[0] + "<font color='#fc7d00'>" + arr[1] + "</font>" + arr[2];
                }
                return arr[0];
            ...
            case ConsortiaEventInfo.CHAIRMAN_SEND:
                return "<font color='#fc7d00'>" + arr[0] + "</font>" + arr[1] +
                    "<font color='#fc7d00'>" + arr[2] + "</font>" + arr[3] + "<font color='#fc7d00'>" + arr[4] + "</font> ";
            default:
                return arr[0];
        }
    }
