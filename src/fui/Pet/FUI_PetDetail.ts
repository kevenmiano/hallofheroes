...
export default class FUI_PetDetail extends fgui.GComponent {
  ...
  protected onConstruct(): void {
    ...
    this.label_development = <fgui.GTextField>(
      this.getChild("label_development")
    );
    ...
    this.label_intelligenceFlair = <fgui.GTextField>(
      this.getChild("label_intelligenceFlair")
    );
    this.txt_intelligenceFlair = <fgui.GTextField>(
      this.getChild("txt_intelligenceFlair")
    );
    ...
    this.txt_selectTargetTip = <fgui.GTextField>(
      this.getChild("txt_selectTargetTip")
    );
