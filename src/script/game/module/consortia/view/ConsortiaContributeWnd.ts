...
export class ConsortiaContributeWnd extends BaseWindow {
  ...
  public OnInitWind() {
    ...
    this.frame.getChild("title").text = LangManager.Instance.GetTranslation(
      "ConsortiaContributeWnd.title",
    );
    this.btnApplayRecord.title = LangManager.Instance.GetTranslation(
      "ConsortiaContributeWnd.btnApplayRecord.title",
    );
    this.btnInviteRecord.title = LangManager.Instance.GetTranslation(
      "ConsortiaContributeWnd.btnInviteRecord.title",
    );
    ...
    this.txtMyContribute.text = LangManager.Instance.GetTranslation(
      "ConsortiaContributeWnd.txtMyContribute.text",
    );
    this.txtGuildContribute.text = LangManager.Instance.GetTranslation(
      "ConsortiaContributeWnd.txtGuildContribute.text",
    );
    this.btnGold.title = this.btnDiamond.title =
      LangManager.Instance.GetTranslation(
        "ConsortiaContributeWnd.btnDiamond.title",
      );
    let cfgItem = TempleteManager.Instance.getConfigInfoByConfigName(
      "PointConsortiaOffer_Price",
    );
    if (cfgItem) {
  ...
  private initView() {
    this.txtExchangeDesc1.text = LangManager.Instance.GetTranslation(
      "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.contributePromptText",
    );
    this.txtExchangeDesc2.text = LangManager.Instance.GetTranslation(
      "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.contributePromptText2",
      this.cfgContributeValue,
    );
    this.itemTitle.getChild("txt1").text = LangManager.Instance.GetTranslation(
      "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.rankingTxtText",
    );
    this.itemTitle.getChild("txt2").text = LangManager.Instance.GetTranslation(
      "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.memberNameTxtText",
    );
    this.itemTitle.getChild("txt3").text = LangManager.Instance.GetTranslation(
      "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.resourceTxtText",
    );
    ...
    this._handler_gold = Laya.Handler.create(
      this,
      this.stepper_goldChangeHandler,
      null,
      false,
    );
    this.stepper_gold.show(
      0,
      0,
      0,
      this.gold.count,
    ...
    this._handler_diamond = Laya.Handler.create(
      this,
      this.stepper_diamondChangeHandler,
      null,
      false,
    );
    this.stepper_diamond.show(
      0,
      0,
      0,
      this.ownDiamond,
      this.ownDiamond,
      this.unitDiamond,
      this._handler_diamond,
    );

    this.stepper_gold.txt_num.promptText = LangManager.Instance.GetTranslation(
      "ConsortiaContributeWnd.tfDiamond.text",
    );
    this.stepper_diamond.txt_num.promptText =
      LangManager.Instance.GetTranslation(
        "ConsortiaContributeWnd.tfDiamond.text",
      );
  ...
  private btnDiamondClick() {
    ...
    if (this.ownDiamond < point) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.command02",
        ),
      );
      return;
    }
    if (this.minDiamond > point) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.command06",
          this.minDiamond,
        ),
      );
      return;
  ...
  private btnGoldClick() {
    ...
    if (this.gold.count < gold) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.command04",
        ),
      );
      return;
    }
    ...
    if (this.minGold > gold) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.contribution.ConsortiaContributeFrame.command05",
          this.minGold,
        ),
      );
      return;
  ...
  private __onSelfGoldUpdata() {
    this.txtGoldValue.text = StringUtils.consortiaTxtStyle(
      this.gold.count + "",
    );
  }
  ...
  private __onSelfPointUpdata() {
    this.txtDiamondValue.text = StringUtils.consortiaTxtStyle(
      this.ownDiamond + "",
    );
  }
  ...
  private stepper_goldChangeHandler(value: number) {
    this.txtGuildContributeValueAdd.text =
      value == 0 ? "" : "+" + Math.floor(value / 1000);
    this.txtMyContributeValueAdd.text =
      value == 0 ? "" : "+" + Math.floor(value / 1000);
  }

  private stepper_diamondChangeHandler(value: number) {
    this.txtGuildContributeValueAdd.text =
      value == 0 ? "" : "+" + Math.floor(value / this.cfgContributeValue);
    this.txtMyContributeValueAdd.text =
      value == 0 ? "" : "+" + Math.floor(value / this.cfgContributeValue);
  }
