...
export class RuneHoldOption extends FUI_RuneHoldOption {
    ...
    private onGetGem() {
        ...
        NotificationManager.Instance.addEventListener(RuneEvent.CLOSE_GEM, this.showView, this);
        this.parent.visible = false;
    }

    private showView() {
        this.parent.visible = true;
        NotificationManager.Instance.removeEventListener(RuneEvent.CLOSE_GEM, this.showView, this);
    }

    public updateRuneReddot() {
        let state = PlayerManager.Instance.currentPlayerModel.playerInfo.runePowerPoint >= 100;
