...
export class DoubleBossInfoView extends FUI_DoubleBossInfoView {
    ...
    protected initView() {
        ...
        let template1: t_s_herotemplateData = ConfigMgr.Instance.getTemplateByID(ConfigType.t_s_herotemplate, (this._info1.heroInfo.templateId).toString());
        if (!template1) {
            return
        }
        ...
        let template2: t_s_herotemplateData = ConfigMgr.Instance.getTemplateByID(ConfigType.t_s_herotemplate, (this._info2.heroInfo.templateId).toString());
        if (!template2) {
            return
        }
    ...
    private initBossHead() {
        if (this._info1) {
            if (this._info1.playerIconId == 0) {
                this._headUrl1 = IconFactory.getHeroIconByPics(this._info1.heroInfo.templateInfo.Icon);
            } else {//使用领主的icon
                this._headUrl1 = IconFactory.getHeroIconByPics(this._info1.heroInfo.templateInfo.Icon);
            }
        ...
        if (this._info2) {
            if (this._info2.playerIconId == 0) {
                this._headUrl2 = IconFactory.getHeroIconByPics(this._info2.heroInfo.templateInfo.Icon);
            } else {//使用领主的icon
                this._headUrl2 = IconFactory.getHeroIconByPics(this._info2.heroInfo.templateInfo.Icon);
            }
    ...
    private initBossHp() {
        this._stripNum1 = BattleModel.getBossHpStripNum(this._info1.heroInfo.templateId)
        this._stripNum2 = BattleModel.getBossHpStripNum(this._info2.heroInfo.templateId)
