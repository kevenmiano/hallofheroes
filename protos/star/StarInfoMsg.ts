...
function createBaseStarInfoMsg(): StarInfoMsg {
  return {
    id: 0,
    templateId: 0,
    userId: 0,
...
export const StarInfoMsg: MessageFns<StarInfoMsg> = {
  encode(message: StarInfoMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StarInfoMsg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStarInfoMsg();
  ...
  fromJSON(object: any): StarInfoMsg {
    return {
  ...
  toJSON(message: StarInfoMsg): unknown {
    const obj: any = {};
    if (message.id !== 0) {
  ...
  create<I extends Exact<DeepPartial<StarInfoMsg>, I>>(base?: I): StarInfoMsg {
    return StarInfoMsg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StarInfoMsg>, I>>(object: I): StarInfoMsg {
    const message = createBaseStarInfoMsg();
