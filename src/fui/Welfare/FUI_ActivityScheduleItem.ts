...
export default class FUI_ActivityScheduleItem extends fgui.GComponent {
  ...
  public static createInstance(): FUI_ActivityScheduleItem {
    return <FUI_ActivityScheduleItem>(
      fgui.UIPackage.createObject("Welfare", "ActivityScheduleItem")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.activityStatusTxt = <fgui.GTextField>(
      this.getChild("activityStatusTxt")
    );
