  ...
  public getBigBoxTip(index: number): string {
    ...
    for (var i: number = 0; i < this.boxAward.length; i++) {
      ...
      if (tempMsg.index == index) {
        itemTemp = TempleteManager.Instance.getGoodsTemplatesByTempleteId(
          tempMsg.itemId,
        );
        if (tempMsg.randomType == 1) {
          ...
          if (str1 == "") {
            str1 +=
              LangManager.Instance.GetTranslation("allmainexchange.str13") +
              "<br>";
          }
          str1 +=
            itemTemp.TemplateNameLang + " x " + tempMsg.itemCount + "<br>";
        } else if (tempMsg.randomType == 4) {
          //随机获得以下道具之一:
          if (str2 == "") {
            str2 +=
              LangManager.Instance.GetTranslation("allmainexchange.str19") +
              "<br>";
          }
          str2 +=
            itemTemp.TemplateNameLang + " x " + tempMsg.itemCount + "<br>";
          ...
          if (str3 == "") {
            str3 +=
              LangManager.Instance.GetTranslation("allmainexchange.str20") +
              "<br>";
          }
          str3 +=
            itemTemp.TemplateNameLang + " x " + tempMsg.itemCount + "<br>";
    ...
    return (
      LangManager.Instance.GetTranslation("allmainexchange.str18") +
      "<br>" +
      str1 +
      str2 +
      str3
