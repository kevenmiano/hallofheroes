...
export default class FUI_ConditionContentItem extends fgui.GComponent {
	...
	public static createInstance():FUI_ConditionContentItem {
		return <FUI_ConditionContentItem>(fgui.UIPackage.createObject("Task", "ConditionContentItem"));
	}

	protected onConstruct():void {
		this.ConditionContentTxt = <fgui.GRichTextField>(this.getChild("ConditionContentTxt"));
	}
}