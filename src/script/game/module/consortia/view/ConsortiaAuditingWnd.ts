...
export class ConsortiaAuditingWnd extends BaseWindow {
    ...
    private initEvent() {
        this._data.addEventListener(ConsortiaEvent.UPDA_APPLY_CONSORTIA_INFO, this.__onApplyConsortiaInfoUpdata, this);
    }
    ...
    private removeEvent() {
        this._data.removeEventListener(ConsortiaEvent.UPDA_APPLY_CONSORTIA_INFO, this.__onApplyConsortiaInfoUpdata, this);
    }
