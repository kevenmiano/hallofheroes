...
export default class QQGiftWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.tabData = ['box.novice.GradeBoxFrame.title','QQ.Hall.Gift.levelGift','QQ.Hall.Gift.dailyGift'];
        this.addEvent();
        this.initView();
    ...
    private addEvent() {
        ...
        this.tabList.selectedIndex = 0;
        this.cType.selectedIndex = 0;
        this._model.addEventListener(QQ_HALL_EVENT.GIFT_CHANGE, this.refreshView, this);
        this._model.addEventListener(QQ_HALL_EVENT.GIFT_TAB_CHANGE, this.refreshView, this);
        this.list.itemRenderer = Laya.Handler.create(this, this.renderListItem, null, false);
        this.levelList.itemRenderer = Laya.Handler.create(this, this.renderLevelListItem, null, false);
    ...
    private offEvent() {
        ...
        this._model.removeEventListener(QQ_HALL_EVENT.GIFT_CHANGE, this.refreshView, this);
        this._model.removeEventListener(QQ_HALL_EVENT.GIFT_TAB_CHANGE, this.refreshView, this);
    ...
    initText() {
        this.txtTitle.text = LangManager.Instance.GetTranslation('QQ.Hall.Gift.title');
        ...
        this.txt3.text = LangManager.Instance.GetTranslation('consortia.view.club.ConsortiaSearchRightView.operationTxtText');

        this.btn_receive.title = LangManager.Instance.GetTranslation('GrowthFundItem.getTxt');
     ...
     */
    private setTabBtnState(index: number, redPointState: boolean, count: number = 0) {
