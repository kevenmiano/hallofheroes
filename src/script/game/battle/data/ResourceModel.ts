...
import { BattleLoadFUITask, BattleLoadItemTask, BattleLoadFigureTask } from "./BattleLoadTask";
...
export class ResourceModel extends GameEventDispatcher {
    ...
    public static PublicSkill = [
        { url: PathManager.solveSkillPublicResPath(ResourceModel.PublicSkill_Names[0]), type: Laya.Loader.ATLAS, priority: 1 },
        { url: PathManager.solveSkillPublicResPath(ResourceModel.PublicSkill_Names[1]), type: Laya.Loader.ATLAS, priority: 1 },
    ...
    public static Resist_Sheld = [
        { url: PathManager.solveResistSheldResPath(ResourceModel.Resist_Sheld_Names[0]), type: Laya.Loader.ATLAS, priority: 1 },
        { url: PathManager.solveResistSheldResPath(ResourceModel.Resist_Sheld_Names[1]), type: Laya.Loader.ATLAS, priority: 1 },
        { url: PathManager.solveResistSheldResPath(ResourceModel.Resist_Sheld_Names[2]), type: Laya.Loader.ATLAS, priority: 1 },
        { url: PathManager.solveResistSheldResPath(ResourceModel.Resist_Sheld_Names[3]), type: Laya.Loader.ATLAS, priority: 1 },
        { url: PathManager.solveResistSheldResPath(ResourceModel.Resist_Sheld_Names[4]), type: Laya.Loader.ATLAS, priority: 1 },
        { url: PathManager.solveResistSheldResPath(ResourceModel.Resist_Sheld_Names[5]), type: Laya.Loader.ATLAS, priority: 1 },
    ]
    ...
    private _loadFigureTaskMgr = new SequenceList(ActionsExecutionMode.RunInSequence);
    ...
    public startLoad(first: boolean = true) {
        ...
        if (first) {
            ...
            this._totalNeedCountMap.set(ResourceModel.SkillEffect_GroupKey, SkillResourceLoader.loadList.length)
            this._totalNeedCountMap.set(ResourceModel.SkillSound_GroupKey, SkillResourceLoader.soundLoadList.length)
        ...
        switch (this._step) {
            ...
            case 1://BattleMap
                ...
                break;
            case 2://SkillEffect
                Logger.battle("[ResourceModel]loadSkillEffect:", SkillResourceLoader.loadList);
                this.loadSkillEffect();
                break;
            case 3://
                Logger.battle("[ResourceModel]loadSkillSound:", SkillResourceLoader.soundLoadList);
                this.loadSkillSound();
                break;
            case 4://加载完成
                this.complete();
    ...
    private loadBattleCommonUI() {
        ResMgr.Instance.loadFairyGui(EmPackName.Battle, this.onComplete.bind(this), this.onProgress.bind(this));
    }
    ...
    private loadBattleMap() {
        let path = PathManager.getBattleMapPath(BattleManager.Instance.battleModel.mapResId);
        ResMgr.Instance.loadRes(path, this.onComplete.bind(this), this.onProgress.bind(this), Laya.Loader.IMAGE);
    }
    ...
    private loadSkillEffect() {
        ResMgr.Instance.loadGroup(SkillResourceLoader.loadList, this.onComplete.bind(this), this.onProgress.bind(this), undefined, undefined, undefined, ResourceModel.SkillEffect_GroupKey);
    }
    ...
    private loadSkillSound() {
        ...
        ResMgr.Instance.loadGroup(SkillResourceLoader.soundLoadList, this.onComplete.bind(this), this.onProgress.bind(this), undefined, undefined, undefined, ResourceModel.SkillSound_GroupKey);
    }
    ...
    private onProgress(prog: number) {
        ...
        switch (this._step) {
            case 0://BattleCommonUI
                this._totalModuleProgMap.set(ResourceModel.BattleCommonUI_GroupKey, prog)
            ...
            case 2://SkillEffect
                ...
                loadedCnt = this._totalNeedCountMap.get(ResourceModel.SkillEffect_GroupKey) * prog
                this._totalLoadedCountMap.set(ResourceModel.BattleCommonUI_GroupKey, loadedCnt)
                break;
            case 3://
                this._totalModuleProgMap.set(ResourceModel.SkillSound_GroupKey, prog)
                loadedCnt = this._totalNeedCountMap.get(ResourceModel.SkillSound_GroupKey) * prog
                this._totalLoadedCountMap.set(ResourceModel.SkillSound_GroupKey, loadedCnt)
                break;
            case 4://加载完成
                break;
        }
    ...
    public getEffectMC(effectName: string): Object {
        ...
        if (!cacheJson) {
            let success = AnimationManager.Instance.createAnimation(prefix, "", 0, "", AnimationManager.BattleEffectFormatLen)
            if (success) {
                cacheName = prefix
            } else {
    ...
    public startSilentlyLoad() {
        ...
        this.skillPublicRes = this.skillPublicRes.concat(ResourceModel.PublicSkill, ResourceModel.Resist_Sheld, SkillResourceLoader.skillNames);
        ...
        seq3.setComplete(Laya.Handler.create(this, () => {
            Logger.battle(">>> 加载战斗LoadItem资源任务完成");
        }))

        this._loadTaskMgr.addTask(seq1).addTask(seq2).addTask(seq3)
    ...
    public startSilentlyLoadFigure() {
        ...
        this._loadFigureTaskMgr.setComplete(Laya.Handler.create(this, () => {
    ...
    public dispose(returnToCampaign: boolean = true) {
        ...
        if (mapModel) {
            if (WorldBossHelper.checkPetLand(mapModel.mapId)
