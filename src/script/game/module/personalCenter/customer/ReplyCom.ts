...
export default class ReplyCom extends FUI_ReplyCom {
  ...
  init() {
    ...
    this.combox1.getChild("title").asTextField.text =
      date.getFullYear() + LangManager.Instance.GetTranslation("public.year");
    this.combox2.getChild("title").asTextField.text =
      date.getMonth() + 1 + LangManager.Instance.GetTranslation("public.month");
    this.combox3.getChild("title").asTextField.text =
      date.getDate() + LangManager.Instance.GetTranslation("public.daily");
