...
export default class FUI_TattooCom extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.txt_tips_core_name = <fgui.GTextField>(this.getChild("txt_tips_core_name"));
		this.txt_tips_core_0 = <fgui.GRichTextField>(this.getChild("txt_tips_core_0"));
		this.txt_tips_core_1 = <fgui.GRichTextField>(this.getChild("txt_tips_core_1"));
		...
		this.txt_tips_core_2 = <fgui.GRichTextField>(this.getChild("txt_tips_core_2"));
