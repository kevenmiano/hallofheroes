...
export default class ConsortiaMethodItem extends FUI_ConsortiaMethodItem {
  ...
  onConstruct() {
    super.onConstruct();
    this.addEvent();
    this.openDescTxt.text = LangManager.Instance.GetTranslation(
      "CastleBuildingView.clickHookBuild",
    );
  ...
  private refreshView() {
    ...
    switch (this._data.id) {
      case ConsortiaModel.ACTIVITY_INFO_TYPE1: //公会秘境
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_method01");
        this.methodNameTxt.text = LangManager.Instance.GetTranslation(
          "ConsortiaActivityItem.activityName2",
        );
        if (
          this.descTxt.text ==
          LangManager.Instance.GetTranslation(
            "consortia.view.myConsortia.activity.ConsortiaActivityListView.bossPromptTxt1",
          )
        ) {
          this.descTxt.color = ColorConstant.GREEN_COLOR;
        }
        this.redCtr.selectedIndex =
          ConsortiaManager.Instance.model.checkSecretRedDot() ? 1 : 0;
        break;
      case ConsortiaModel.ACTIVITY_INFO_TYPE2: //勇者之战
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_method02");
        this.methodNameTxt.text = LangManager.Instance.GetTranslation(
          "ConsortiaBossWnd.title",
        );
        this.operationBtn.icon = fgui.UIPackage.getItemURL(
          "Consortia",
          "Icon_Guildboss",
        );
        ...
        if (openTimeArr) {
          ...
          this.openTimeTxt.text = LangManager.Instance.GetTranslation(
      ...
      case ConsortiaModel.ACTIVITY_INFO_TYPE3: //公会战
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_method03");
        this.methodNameTxt.text = LangManager.Instance.GetTranslation(
      ...
      case ConsortiaModel.ACTIVITY_INFO_TYPE4: //宝藏矿脉
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_method04");
        this.operationBtn.icon = fgui.UIPackage.getItemURL(
          "Consortia",
          "Icon_ore",
        );
      ...
      case ConsortiaModel.ACTIVITY_INFO_TYPE14: //公会任务
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_function05");
        this.functionNameTxt.text = LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.building.ConsortiaCaseFrame.titleText",
      ...
      case ConsortiaModel.ACTIVITY_INFO_TYPE13: //祭坛
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_function02");
        this.functionNameTxt.text = LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.building.ConsortiaAltarFrame.titleText",
          this.consortiaInfo.altarLevel,
        );
        this.redCtr.selectedIndex =
          ConsortiaManager.Instance.model.checkPrayHasLeftCount() ? 1 : 0;
        break;
      case ConsortiaModel.ACTIVITY_INFO_TYPE11: //商城
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_function03");
        this.functionNameTxt.text = LangManager.Instance.GetTranslation(
      ...
      case ConsortiaModel.ACTIVITY_INFO_TYPE12: //技能
        this.enterBtn.selectedIcon = this.enterBtn.icon =
          fgui.UIPackage.getItemURL("Consortia", "Img_function04");
        this.functionNameTxt.text = LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.skill.ConsortiaResearchSkillFrame.title",
