...
export default class ChatAirBubbleWnd extends BaseWindow {
    ...
    onEvent() {
        ...
        NotificationManager.Instance.addEventListener(CharBubbleEvent.CHAT_BUBBLES_OPT, this.onOptBubbleData, this);
    }
    ...
    offEvent() {
        ...
        NotificationManager.Instance.removeEventListener(CharBubbleEvent.CHAT_BUBBLES_OPT, this.onOptBubbleData, this);
    }
