...
export class FilterRuneWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        if(this.isResolve){
            this.frame.getChild('title').asCom.text = LangManager.Instance.GetTranslation('runeGem.str4');
        }
        this.qualityBtns = [this.qBtn1, this.qBtn2, this.qBtn3, this.qBtn4, this.qBtn5];
        this.statsBtns = [this.sBtn1, this.sBtn2, this.sBtn3, this.sBtn4, this.sBtn5, this.sBtn6, this.sBtn7];
        this.setCenter();
    }
    ...
    private init() {
        ...
        if(this.isResolve){
            ...
            this.filterProfile = this.filterType == 1 ? skillModel.runeProfileFilter : skillModel.runeHoldProfileFilter;
            this.filterAttributes = this.filterType == 1 ? skillModel.runeAttributeFilter : skillModel.runeHoldAttributeFilter;
        }
    ...
    private onOkClick() {
        this.save();
        this.hide();
        this.skillWndData.dispatchEvent(this.isResolve ? SkillWndData.CHAMGE_RUNE_FILTER : SkillWndData.CHAMGE_HOLD_FILTER);
    }
    ...
    public get skillWndData() {
        return FrameCtrlManager.Instance.getCtrl(EmWindow.Skill).data as SkillWndData
    }
