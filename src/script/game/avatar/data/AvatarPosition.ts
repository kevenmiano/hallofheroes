...
export class AvatarPosition
{
    ...
    {
        return [AvatarPosition.ARMY, AvatarPosition.BODY, AvatarPosition.HAIR_UP, AvatarPosition.HAIR_DOWN
            , AvatarPosition.CLOAK, AvatarPosition.WING, AvatarPosition.MOUNT, AvatarPosition.MOUNT_WING
            , AvatarPosition.PET, AvatarPosition.TRANSLUCENCE]
    }
}
