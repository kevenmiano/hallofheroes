...
export default class Appelltips extends BaseTips {
    ...
    public OnInitWind() {
        ...
        LangManager.Instance.GetTranslation("yishi.view.tips.AppellInfoTips.AppellTopDescribeTxt");//装备栏效果
        LangManager.Instance.GetTranslation("yishi.view.tips.AppellInfoTips.AppellTalkDescribeTxt");//聊天栏效果
        ...
        this.txt_name.titleFontSize = this._data.TextFontSize ? this._data.TextFontSize : 20;
