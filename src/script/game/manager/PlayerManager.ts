...
export class PlayerManager extends GameEventDispatcher {
  ...
  public initEvent() {
    ServerDataManager.listen(
      S2CProtocol.U_C_PLAYER_INFO,
      this,
      this.__uPlayerInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_REFUSEFRIEND_REFRESH,
      this,
      this.__uRefusefriend,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_REFUSEINVITE_REFRESH,
      this,
      this.__uRefuseInvite,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_PLAYER_SETTING,
      this,
      this.__recvPlayerSetting,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_REFUSETEAMINVITE_REFRESH,
      this,
      this.__uRefuseTeamInvite,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_PLAYER_EFFECT,
      this,
      this.__playerEffectHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_ITEM_SMITH,
      this,
      this.__addComposeTempHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_BUILDING_TRANSCASTLE,
      this,
      this.__transferCastleHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_TRASNBUILDING_RESULT,
      this,
      this.__transferResultHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_CAMPAIGN_WAITING_PLAYER_LIST,
      this,
      this.__playerListHandler,
    );
    // ServerDataManager.listen(S2CProtocol.U_C_OFFLINE_REWARD, this, this.__hookRewardHandler);
    ServerDataManager.listen(
      S2CProtocol.U_C_SIMPLEUSER_INFO,
      this,
      this.__getSimpleInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_CH_SIMPLEUSER_INFO,
      this,
      this.__getSimpleAndSnsInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_TOWERINFO,
      this,
      this.__towerInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_TOWERLIST,
      this,
      this.__towerListHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_SYNCHRONIZED_TIME,
      this,
      this.__sysTimeHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_ENTER_COPY_NUM_REFRESH,
      this,
      this.__uPlayerEnterCopyNumHandler,
    );
    // ServerDataManager.listen(S2CProtocol.U_C_OPEN_CUSTOMER, this, this._openCustomerHandler);
    ServerDataManager.listen(
      S2CProtocol.U_C_CROSS_USER_INFO,
      this,
      this.__crossPlayerInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_DAYGESTE_SEND,
      this,
      this.__daygesteUpdateHandler,
    );
    ...
    ServerDataManager.listen(
      S2CProtocol.U_C_PLAYER_PETINFO,
      this,
      this.__petInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_PLAYER_LOGIN_SYNC_MAPID,
      this,
      this.__loginSyncMapIdHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_BAG_EQUIPLOOK,
      this,
      this.__receiveEquipHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_MOUNT_INFO_SEND,
      this,
      this.__recvPlayerMountInfo,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_RECEIVE_PET_DATA,
      this,
      this.__receivePetDataHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_BATTLEGUARD_INFO,
      this,
      this.__battleguardInfoHandler,
    );
    // ServerDataManager.listen(S2CProtocol.U_C_DRAGON_REQ, this, this.__dragonSoulReqHandler);
    ServerDataManager.listen(
      S2CProtocol.U_C_FETCH_TOKEN,
      this,
      this.onRecvToken,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_CHANGE_PRODUCT_COUNT,
      this,
      this.onRecvProductCount,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_CHANGE_PRODUCT_TODAYCOUNT,
      this,
      this.onRecvTodayProductCount,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_CHANGE_PRODUCT_WEEKCOUNT,
      this,
      this.onRecvWeekProductCount,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_CHARGE_ARRIVE,
      this,
      this.onRecvChargeArrive,
    );
    ServerDataManager.listen(
    ...
    ServerDataManager.listen(
      S2CProtocol.U_C_SELECT_NEW_YEAR_BOX_NODE,
      this,
      this.__receiveYearNodeDataHandler,
    );
    ...
    ServerDataManager.listen(
      S2CProtocol.U_C_STORE_RATINGS_NOTIFY,
      this,
      this.__storeRatingNotify,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_STORE_RATINGS_REPORT_RESP,
      this,
      this.__storeRatingRsp,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_MICRO_TERMINAL_REWARD,
      this,
      this.__microAppInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_HONOR_EQUIP,
      this,
      this._onRecvHonorEquipInfo,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_TIME_ZONE,
      this,
      this.__onReceTimeZone,
    );
    ServerDataManager.listen(
    ...
    ServerDataManager.listen(
      S2CProtocol.U_C_PET_ARTIFACT_LIST,
      this,
      this.__receivePetArtifactDataHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_FRAME_LIST,
      this,
      this.__frameListHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_EXTRAJOB_DETAIL,
      this,
      this.__onRecvExtraJobDetail,
    );
    ServerDataManager.listen(
      S2CProtocol.U_EXTRAJOB_EQUIP_LIST,
      this,
      this.__onRecvExtraJobEquipList,
    );
    ServerDataManager.listen(
      S2CProtocol.U_EXTRAJOB_LIST,
      this,
      this.__onRecvExtraJobList,
    );

    //用户绑定相关
    ServerDataManager.listen(
      S2CProtocol.U_C_ACCOUNT_BIND_RESP,
      this,
      this.__onRecvAccountBindResp,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_UPACCOUNT_REWARD_RESP,
      this,
      this.__onRecvUpAccountRewardResp,
    );

    ServerDataManager.listen(
      S2CProtocol.U_C_KF_ISREPLY_RESP,
      this,
      this._onRecvCustomerisReplyResp,
    );
  }
  ...
  private _onRecvCustomerisReplyResp(pkg: PackageIn) {
    let msg: CustomerIsReplyMsg = pkg.readBody(
      CustomerIsReplyMsg,
    ) as CustomerIsReplyMsg;
    this._customerReplyState = msg.isreply;
    NotificationManager.Instance.dispatchEvent(
      NotificationEvent.CUSTOMER_SERVICE_REPLY,
    );
  }
  ...
  private __onRecvExtraJobEquipList(pkg: PackageIn) {
    let msg: ExtraJobEquipMsg = pkg.readBody(
      ExtraJobEquipMsg,
    ) as ExtraJobEquipMsg;
    if (msg) {
      Logger.info("[PlayerManager]返回玩家魂器列表", msg);
      for (let i = 0; i < msg.equipList.length; i++) {
        const element: ExtraJobEquipItemMsg = msg.equipList[
          i
        ] as ExtraJobEquipItemMsg;
  ...
  private __onRecvExtraJobDetail(pkg: PackageIn) {
    ...
    if (msg) {
      ...
      this.dispatchEvent(RequestInfoEvent.QUERY_MASTERY_RESULT, [
        equipList,
        activeList,
      ]);
    }
  ...
  private __frameListHandler(pkg: PackageIn) {
    let msg: FrameInfoMsgList = pkg.readBody(
      FrameInfoMsgList,
    ) as FrameInfoMsgList;
      ...
      if (msg.op == 0) {
        ...
        for (let i: number = 0; i < msg.frames.length; i++) {
          ...
          if (item) {
            ...
            if (
              SharedManager.Instance.headIconClickDic[headFrameInfo.frameId]
            ) {
              headFrameInfo.clickNum =
                SharedManager.Instance.headIconClickDic[headFrameInfo.frameId];
            } else {
              headFrameInfo.clickNum = 0;
            }
            HeadIconModel.instance.allHeadFrameFrameIdList.push(
              headFrameInfo.frameId,
            );
            HeadIconModel.instance.allHeadFrameList.set(
              headFrameInfo.frameId,
              headFrameInfo,
            );
        ...
        for (let i: number = 0; i < msg.frames.length; i++) {
          ...
          if (item) {
            ...
            if (
              HeadIconModel.instance.allHeadFrameFrameIdList.indexOf(
                item.frameId,
              ) == -1
            ) {
              //新增的
  ...
  private _onRecvHonorEquipInfo(pkg: PackageIn) {
    ...
    if (msg) {
      ...
      NotificationManager.Instance.dispatchEvent(
        NotificationEvent.HONOR_EQUIP_LEVELUP,
      );
    }
  }
  ...
  private onRecvTodayProductCount(pkg: PackageIn) {
    ...
    NotificationManager.Instance.dispatchEvent(
      ShopEvent.PRODUCT_TODAY_UPDATE_COUNT,
    );
  }
  ...
  private onRecvWeekProductCount(pkg: PackageIn) {
    ...
    NotificationManager.Instance.dispatchEvent(
      ShopEvent.PRODUCT_WEEK_UPDATE_COUNT,
    );
  }
  ...
  private __sysTimeHandler(pkg: PackageIn) {
    ...
    let msg: SynchronizedTimeMsg = pkg.readBody(
      SynchronizedTimeMsg,
    ) as SynchronizedTimeMsg;
  ...
  private __playerEffectHandler(pkg: PackageIn) {
    //0x006E
    let msg: PropertyUpdatedMsg = pkg.readBody(
      PropertyUpdatedMsg,
    ) as PropertyUpdatedMsg;
    let index: number = msg.propertyType;
    let value: number = msg.value;
    PlayerEffectHelper.updatePlayerEffect(
      index,
      value,
      this._playerModel.playerEffect,
    );
  }
  ...
  private __recvPlayerSetting(pkg: PackageIn) {
    let playerMsg: PlayerSettingMsg = pkg.readBody(
      PlayerSettingMsg,
    ) as PlayerSettingMsg;
    switch (playerMsg.optType) {
      ...
      case 3: // 是否拒绝公会邀请（result: 0: 可以, 1: 拒绝）
        this._playerModel.playerInfo.refuseConsortiaInvite =
          playerMsg.result == 1;
        break;
      ...
      case 9: //
        ...
        break;
      case 10: //
        this._playerModel.playerInfo.isOpenSettingType10 =
          playerMsg.result == 1;
        break;
      case 11: //
  ...
  private __uRefusefriend(pkg: PackageIn) {
    let playerMsg: RefuseFriendRspMsg = pkg.readBody(
      RefuseFriendRspMsg,
    ) as RefuseFriendRspMsg;
  ...
  private __uPlayerEnterCopyNumHandler(pkg: PackageIn) {
    let msg: MultiCampaignEnterCountMsg = pkg.readBody(
      MultiCampaignEnterCountMsg,
    ) as MultiCampaignEnterCountMsg;
  ...
  private __uPlayerInfoHandler(pkg: PackageIn) {
    ...
    if (playerMsg.hasOwnProperty("lastAward")) {
      playerInfo.lastAward = DateFormatter.parse(
        playerMsg.lastAward,
        "YYYY-MM-DD hh:mm:ss",
      );
    }
    ...
    if (playerMsg.hasOwnProperty("consortiaId")) {
      if (playerInfo.consortiaID > 0 && playerMsg.consortiaId <= 0) {
        //退出或解散公会
        ...
        if (channel instanceof WanChannel) {
          ...
          channel.leaveChatRoom(
            NativeChannel.CONSORTIA_ROOM + playerInfo.consortiaID,
          );
        }
      }
        ...
        if (channel instanceof WanChannel) {
          ...
          if (NativeChannel.isVoiceLogin) {
            channel.joinChatRoom(
              NativeChannel.CONSORTIA_ROOM + playerMsg.consortiaId,
            );
          }
        }
      }
    ...
    if (playerMsg.hasOwnProperty("lastOutConsortia")) {
      playerInfo.lastOutConsortia =
        DateFormatter.parse(
          playerMsg.lastOutConsortia,
          "YYYY-MM-DD hh:mm:ss",
        ).getTime() / 1000;
    }
    ...
    if (playerMsg.hasOwnProperty("gpOrder")) {
      ...
      playerInfo.playerOrdeInfo.fightCapacityOrder =
        playerMsg.order.fightCapacityOrder;
      ...
      playerInfo.playerOrdeInfo.soulScoreOrder =
        playerMsg.order.soulScore_Order;
    }
    ...
    if (
      this.thane.preGrade > 0 &&
      this.thane.preGrade < 55 &&
      this.thane.grades >= 55
    ) {
    ...
    playerInfo.selfConsortiaSkillTypeDic =
      this.getConsortiaSkillTypeDic(playerMsg);
  ...
  private __transferResultHandler(pkg: PackageIn) {
    ...
    this.dispatchEvent(ServiceReceiveEvent.TRANSEFER_ARMY_SUCCESS, [
      true,
      null,
    ]); //[result:Boolean, data:Object]
  }
  ...
  private __playerListHandler(pkg: PackageIn) {
    let msg: RoomPlayerListMsg = pkg.readBody(
      RoomPlayerListMsg,
    ) as RoomPlayerListMsg;
  ...
  private __crossPlayerInfoHandler(pkg: PackageIn) {
    let msg: SimpleHeroInfoMsg = pkg.readBody(
      SimpleHeroInfoMsg,
  ...
  private __receivePetDataHandler(pkg: PackageIn) {
    ...
    if (msg.petmsg && msg.petmsg.petInfo && msg.petmsg.petInfo.length == 1) {
      ...
      petdata = PetData.createWithMsg(
        msg.petmsg.petInfo[0] as PetInfoMsg,
        petdata,
      );
      for (let i: number = 0; i < msg.item.length; i++) {
        let simpleItemInfoMsg: SimpleItemInfoMsg = msg.item[
          i
        ] as SimpleItemInfoMsg;
  ...
  private __receivePetArtifactDataHandler(pkg: PackageIn) {
    let msg: PetDetailMsgList = pkg.readBody(
      PetDetailMsgList,
    ) as PetDetailMsgList;
    if (msg) {
      let petList = [];
      for (let i: number = 0; i < msg.petList.length; i++) {
        ...
        if (
          detailMsg.petmsg &&
          detailMsg.petmsg.petInfo &&
          detailMsg.petmsg.petInfo.length == 1
        ) {
          petdata = new PetData();
          petdata.userId = detailMsg.petmsg.userId;
          petdata = PetData.createWithMsg(
            detailMsg.petmsg.petInfo[0] as PetInfoMsg,
            petdata,
          );
          for (let i: number = 0; i < detailMsg.item.length; i++) {
            let simpleItemInfoMsg: SimpleItemInfoMsg = detailMsg.item[
              i
            ] as SimpleItemInfoMsg;
            let goodsInfo: GoodsInfo = this.copyGoodsInfo(simpleItemInfoMsg);
            petdata.equipGoodsArr.push(goodsInfo);
  ...
  private __getSimpleAndSnsInfoHandler(pkg: PackageIn) {
    let msg: RelationPlayerMsg = pkg.readBody(
      RelationPlayerMsg,
    ) as RelationPlayerMsg;
    let orientation: number = msg.from;
    let pInfo: FriendItemCellInfo = new FriendItemCellInfo();
    SocketGameReader.readSimpleAndSnsInfo(pInfo, msg);
    if (
      orientation == RequestInfoRientation.MENU_INFO ||
      orientation == RequestInfoRientation.IM_INFO
    ) {
      //在好友面板点出好友菜单或打开聊天窗时需要更新好友信息
      let fInfo: FriendItemCellInfo = IMManager.Instance.getFriendInfo(
        pInfo.userId,
      );
      if (fInfo) {
        //如果存在好友信息则更新好友信息, 注意不要把pInfo直接赋值给fInfo了, 对属性单独赋值
  ...
  public moveBagToBag(
    ...
    endPos: number,
    count: number,
    isUninstal: boolean = false,
  ) {
    SocketSendManager.Instance.sendMoveBagToBag(
      beginBagType,
      beginObjectId,
      beginPos,
      endBagType,
   ...
   *
   */
  public sendRequestEquip(
    id: number,
    direct: number,
    needItem: boolean = false,
    needHero: boolean = false,
    needArmy: boolean = false,
    needPawn: boolean = false,
  ) {
  ...
  //
  private __transferCastleHandler(pkg: PackageIn) {
    //0x0069
    let msg: CastleReqMsg = pkg.readBody(CastleReqMsg) as CastleReqMsg;
    ...
    this.currentPlayerModel.mapNodeInfo.info =
      this.currentPlayerModel.mapNodeInfo.info;
  ...
  private __battleguardInfoHandler(pkg: PackageIn) {
    ...
    for (let info of msg.watchInfo) {
      let item: BattleGuardSocketInfo = thaneInfo.battleGuardInfo.getSocketInfo(
        info.gridType,
        info.gridPos - 1,
      );
      ...
      if (item.state == BattleGuardSocketInfo.CLOSE) {
        ...
        thaneInfo.battleGuardInfo.dispatchEvent(
          NotificationEvent.OPEN_BATTLEGUARD_ITEM,
          item,
        );
      }
    }
    ...
    this.currentPlayerModel.playerInfo.battleGuardInfo =
      thaneInfo.battleGuardInfo;
  }

  public sendAddBattleGem(
    type: number,
    pos: number,
    socketPos: number,
    goodsInfo: GoodsInfo,
    ...
    //判断是否有相同类型宝石
    let item: BattleGuardSocketInfo = this.thane.battleGuardInfo.getSocketInfo(
      type,
      pos,
    );
    if (!item) {
    ...
    if (type == 1) {
      ...
      if (goodsType != 100) {
        tipstr = LangManager.Instance.GetTranslation(
          "cell.mediator.playerbag.PlayerBagCellDropMediator.command02",
        );
      }
    } else {
  ...
  public getVocationName(
    ...
    if (step < 10) {
      vocationName += LangManager.Instance.GetTranslation(
        "yishi.manager.PlayerManager.VocationStep0" + step,
      );
    } else if (step == 10) {
      vocationName += LangManager.Instance.GetTranslation(
        "yishi.manager.PlayerManager.VocationStep" + step,
      );
    }
    vocationName += LangManager.Instance.GetTranslation(
      "yishi.manager.PlayerManager.VocationJob" + job + "Level" + level,
    );
    return vocationName;
  }
  //
  ...
  private onRecvToken(pkg: PackageIn) {
    ...
    if (msg.token) {
      ...
      let userId: string =
        this.currentPlayerModel.userInfo.mainSite +
        "_" +
        this.currentPlayerModel.playerInfo.userId;
  ...
  private __receiveYearNodeDataHandler(pkg: PackageIn) {
    let msg: QueryCollectCampaignNodeRspMsg = pkg.readBody(
      QueryCollectCampaignNodeRspMsg,
    ) as QueryCollectCampaignNodeRspMsg;
    let nodeIdsDic: Map<any, any> = new Map<any, any>();
    for (let i: number = 0; i < msg.collectCampaignNode.length; i++) {
      let item: CollectCampaignNodeMsg = msg.collectCampaignNode[
        i
      ] as CollectCampaignNodeMsg;
      ...
      for (let j: number = 0; j < spaceModel.mapNodesData.length; j++) {
        ...
        if (nodeInfo && SpaceNodeType.isYearNode(nodeInfo.info.types)) {
          if (!nodeIdsDic.get(nodeInfo.info.id)) {
            ...
            (nodeInfo as SpaceNode).sonType = nodeIdsDic.get(
              nodeInfo.info.id,
            ).sonType;
  ...
  private __storeRatingNotify(pkg: PackageIn) {
    ...
    let msg: StoreRatingsNotifyInfo = pkg.readBody(
      StoreRatingsNotifyInfo,
    ) as StoreRatingsNotifyInfo;
    this.scoreRatingCondition = msg.conditionType;
    this.isExistScoreRating = true;
    Logger.xjy(
      "__storeRatingNotify:",
      this.scoreRatingCondition,
      this.isExistScoreRating,
    );
    if (
      ...
      PlayerManager.Instance.scoreRatingCondition ==
        StoreRatingsType.FIRST_MYSTERIOUS_6_GEMS
    ) {
  ...
  private __storeRatingRsp(pkg: PackageIn) {
    let msg: StoreRatingsResp = pkg.readBody(
      StoreRatingsResp,
    ) as StoreRatingsResp;
    if (msg.result == 1) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation("storeRating.result"),
      );
    } else {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation("storeRating.fail"),
      );
    }
  }
  ...
  private __microAppInfoHandler(pkg: PackageIn) {
    let msg: MicroTerminalInfo = pkg.readBody(
      MicroTerminalInfo,
    ) as MicroTerminalInfo;
