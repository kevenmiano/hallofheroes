...
export default class NewbieSubNodeInfo {
  ...
  public clear() {
    ...
    if (this._actionParams) this._actionParams.length = 0;
    this._actionParams = null;
    if (this.conditions) this.conditions.length = 0;
    this.conditions = null;
    if (this.conditionParams) this.conditionParams.length = 0;
    this.conditionParams = null;
    if (this.conditionInverted) this.conditionInverted.length = 0;
    this.conditionInverted = null;
    if (this.skipConditions) this.skipConditions.length = 0;
    this.skipConditions = null;
    if (this.skipConditionParams) this.skipConditionParams.length = 0;
    this.skipConditionParams = null;
    if (this.skipConditionInverted) this.skipConditionInverted.length = 0;
    this.skipConditionInverted = null;
    if (this.backConditions) this.backConditions.length = 0;
    this.backConditions = null;
    if (this.backConditionParams) this.backConditionParams.length = 0;
    this.backConditionParams = null;
    if (this.backConditionInverted) this.backConditionInverted.length = 0;
    this.backConditionInverted = null;
    this.desc = null;
  }
}
