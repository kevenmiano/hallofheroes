...
export class BaseSnsInfo {
  ...
  public get sexName(): string {
    return this.snsModel.sexList[this.sex]
      ? this.snsModel.sexList[this.sex]["name"]
      : LangManager.Instance.GetTranslation(
          "friends.findfriend.FindResultItem.unknown",
        );
  }
  ...
  public get horoscopeName(): string {
    return this.snsModel.getHoroscopeObj(this.horoscope)
      ? this.snsModel.getHoroscopeObj(this.horoscope)["name"]
      : LangManager.Instance.GetTranslation(
          "friends.findfriend.FindResultItem.unknown",
        );
  }
  ...
  public get bloodName(): string {
    return this.snsModel.bloodTypeList[this.bloodType]
      ? this.snsModel.bloodTypeList[this.bloodType]["name"]
      : LangManager.Instance.GetTranslation(
          "friends.findfriend.FindResultItem.unknown",
        );
  }
  ...
  public get countryName(): string {
    return this.snsModel.getCountryObj(this.country)
      ? this.snsModel.getCountryObj(this.country)["name"]
      : LangManager.Instance.GetTranslation(
          "friends.findfriend.FindResultItem.unknown",
        );
  }
  ...
  public get provinceName(): string {
    return this.snsModel.getProvinceObj(this.province)
      ? this.snsModel.getProvinceObj(this.province)["name"]
      : "";
  }
  ...
  public get cityName(): string {
    return this.snsModel.getCityObj(this.city)
      ? this.snsModel.getCityObj(this.city)["name"]
      : "";
  }
