...
export class PlayerInfoWnd extends BaseWindow {
  ...
  private setJewelTip(thane: ThaneInfo) {
    ...
    let selflevel = langIns.GetTranslation(
      "public.level2",
      selfThane.jewelGrades,
    );
    let selfValStr =
      "+" + GoodsHelp.getJewelEffecyByGrade(selfThane.jewelGrades) + "%";

    let selfStr = langIns.GetTranslation("PlayerInfoWnd.Property.myProperty");

    selfStr +=
      `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.viewII.equip.JewelFrame.JewelNameTxt2")}[/size][/color][size=22]${selflevel}[/size]` +
      "<br>" +
      `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.viewII.equip.JewelFrame.JewelEffValueTxt1")}[/size][/color][size=22]${selfValStr}[/size]` +
      "<br>";

    let str =
      `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.viewII.equip.JewelFrame.JewelNameTxt2")}[/size][/color][size=22]${level}[/size]` +
      "<br>" +
      `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.viewII.equip.JewelFrame.JewelEffValueTxt1")}[/size][/color][size=22]${valStr}[/size]` +
      "<br>";
    FUIHelper.setTipData(
      this.btn_gem.view,
      EmWindow.PropertyCompareTips,
      [str, selfStr],
      new Laya.Point(-50, -130),
      undefined,
      undefined,
    );
  }
  ...
  private setHonorTip(thane: ThaneInfo) {
    ...
    let str =
      `[color=#ffc68f][size=22]${langIns.GetTranslation("honorEquip.str3") + ":" + "&nbsp;"}[/size][/color][size=22]${level}[/size]` +
      "<br>" +
      `[color=#ffc68f][size=22]${langIns.GetTranslation("honor.level") + "&nbsp;"}[/size][/color][size=22]${grade}[/size]` +
      "<br>";

    let selfLevel = ArmyManager.Instance.thane.honorEquipLevel;
    let selfgrade: string = "";
    let selfCfg: t_s_honorequipData = TempleteManager.Instance.geHonorCfgByType(
      1,
      ArmyManager.Instance.thane.honorEquipStage,
    );
    ...
    selfstr +=
      `[color=#ffc68f][size=22]${langIns.GetTranslation("honorEquip.str3") + ":" + "&nbsp;"}[/size][/color][size=22]${selfLevelStr}[/size]` +
      "<br>" +
      `[color=#ffc68f][size=22]${langIns.GetTranslation("honor.level") + "&nbsp;"}[/size][/color][size=22]${selfgrade}[/size]` +
      "<br>";
  ...
  private setRuneHoleTip(msg: any) {
    ...
    let selfstr = LangManager.Instance.GetTranslation(
      "PlayerInfoWnd.Property.myProperty",
    );
      ...
      if (count > 0) {
        for (const key in selfData) {
          if (Object.prototype.hasOwnProperty.call(selfData, key)) {
            ...
            selfstr +=
              `[color=#ffc68f][size=22]${key + "&nbsp;:&nbsp;"}[/size][/color][size=22]${element}[/size]` +
              "<br>";
          }
        }
      } else {
        selfstr += LangManager.Instance.GetTranslation(
  ...
  private getRuneHoleStr(msg: any): string {
    ...
    if (msg.hasOwnProperty("power")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip01") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.power}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("agility")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip02") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.agility}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("intellect")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip03") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.intellect}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("physique")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip04") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.physique}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("captain")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip05") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.captain}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("attack")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip13") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.attack}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("defence")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip14") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.defence}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("magicAttack")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip15") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.magicAttack}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("magicDefence")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip16") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.magicDefence}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("forceHit")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip10") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.forceHit}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("live")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip11") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.live}[/size]` +
        "<br>";
    }
    if (msg.hasOwnProperty("parry")) {
      resultStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.ThaneAttributeView.Tip19") + "&nbsp;:&nbsp;"}[/size][/color][size=22]${msg.parry}[/size]` +
        "<br>";
    }
    let str = "";
  ...
  private setTalentTip(thane: ThaneInfo) {
    ...
    let str =
      `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.viewII.talent.TalentView.TalentLevel") + ":"}[/size][/color][size=22]${level}[/size]` +
      "<br>";
    ...
    selfstr +=
      `[color=#ffc68f][size=22]${langIns.GetTranslation("armyII.viewII.talent.TalentView.TalentLevel") + ":"}[/size][/color][size=22]${selflevel}[/size]` +
      "<br>";
    FUIHelper.setTipData(
  ...
  private setTatooTip(holesData: TattooHole[]) {
    ...
    let selfresultStr = LangManager.Instance.GetTranslation(
      "PlayerInfoWnd.Property.myProperty",
    );
  ...
  private getHolesDataStr(holesData: TattooHole[]): string {
    ...
    if (addStrength > 0) {
      tipStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("tattoo.TattooPopFrame.propertyName1")}[/size][/color]` +
        "  +" +
        addStrength +
        "<br>";
    ...
    if (addAgility > 0) {
      tipStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("tattoo.TattooPopFrame.propertyName2")}[/size][/color]` +
        "  +" +
        addAgility +
        "<br>";
    ...
    if (addIntelligence > 0) {
      tipStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("tattoo.TattooPopFrame.propertyName3")}[/size][/color]` +
        "  +" +
        addIntelligence +
        "<br>";
    ...
    if (addPhysique > 0) {
      tipStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("tattoo.TattooPopFrame.propertyName4")}[/size][/color]` +
        "  +" +
        addPhysique +
        "<br>";
    ...
    if (addCaptain > 0) {
      tipStr +=
        `[color=#ffc68f][size=22]${langIns.GetTranslation("tattoo.TattooPopFrame.propertyName5")}[/size][/color]` +
        "  +" +
        addCaptain +
        "<br>";
    ...
    if (tipStr != "") {
      ...
      resultStr =
        title + "<br>" + langIns.GetTranslation("AppellPowerTip.noneProps");
    }
    return resultStr;
  }
  ...
  private setStarTip(starInfo: StarInfo[]) {
    ...
    let selfStarInfo = StarManager.Instance.getStarListByBagType(
      StarBagType.THANE,
    );
    if (selfStarInfo) {
  ...
  private getStarText(data: StarInfo[]): string {
    ...
    resultStr =
      `[color=#FFC68F][size=24]${LangManager.Instance.GetTranslation("yishi.view.tips.goods.StarPowTip.title")}[/size][/color]` +
      `&nbsp;&nbsp;[color=#FFECC6][size=24]${starPower}[/size][/color]`;
    ...
    for (let index = 0; index < count; index++) {
      ...
      if (starInfo) {
        ...
        if (starInfo.template.DefaultSkill.length > 0) {
          desc +=
            "[size=18]" + StarHelper.getStarBufferName(starInfo) + "[/size]";
        } else {
   ...
   *
   */
  public getImprintTotalCountByProperity(
    properity: number,
    value: TattooHoleInfoII[],
  ): number {
    let count: number = 0;
    if (!value) {
      return count;
    ...
    for (const info of value) {
      if (info.property == properity) {
        let curUpgrdeTemp: t_s_upgradetemplateData =
          TempleteManager.Instance.getTemplateByTypeAndLevel(
            info.level,
            UpgradeType.UPGRADE_TATTOO_NEWHOLE,
          );
        if (!curUpgrdeTemp) {
          continue;
        }
  ...
  setData(data: any) {
    if (data instanceof SortData) {
      ...
      var cloth: GoodsInfo =
        this._equipDic[2 + "_" + this._thane.id + "_" + BagType.HeroEquipment];
      var armsEquip: GoodsInfo =
        this._equipDic[0 + "_" + this._thane.id + "_" + BagType.HeroEquipment];
      var wingEquip: GoodsInfo =
        this._equipDic[8 + "_" + this._thane.id + "_" + BagType.HeroEquipment];
      var hairFashion: GoodsInfo =
        this._equipDic[9 + "_" + this._thane.id + "_" + BagType.HeroEquipment];
      var clothFashion: GoodsInfo =
        this._equipDic[10 + "_" + this._thane.id + "_" + BagType.HeroEquipment];
      var armsFashion: GoodsInfo =
        this._equipDic[11 + "_" + this._thane.id + "_" + BagType.HeroEquipment];
      this._thane.bodyEquipAvata = cloth ? cloth.templateInfo.Avata : "";
      this._thane.armsEquipAvata = armsEquip
        ? armsEquip.templateInfo.Avata
        : "";
      this._thane.wingAvata = wingEquip ? wingEquip.templateInfo.Avata : "";
      this._thane.hairFashionAvata = hairFashion
        ? hairFashion.templateInfo.Avata
        : "";
      this._thane.bodyFashionAvata = clothFashion
        ? clothFashion.templateInfo.Avata
        : "";
      this._thane.armsFashionAvata = armsFashion
        ? armsFashion.templateInfo.Avata
        : "";
      ...
      if (!this._isCross) {
        PlayerManager.Instance.sendRequestSimpleAndSnsInfo(
          data.userId,
          RequestInfoRientation.SHOW_INFO,
        );
        PlayerManager.Instance.sendRequestEquip(
          data.userId,
          RequestInfoRientation.SHOW_INFO,
          true,
          true,
  ...
  private onRecvMountInfo(info: SimpleMountInfo): void {
    ...
    if (info.mountTempId == 0) {
      ...
      //请求自己的坐骑
      var userId: number =
        PlayerManager.Instance.currentPlayerModel.playerInfo.userId; // ArmyManager.Instance.thane.userId;
  ...
  private addEvent() {
    ...
    this.fashionModel.addEventListener(
      FashionEvent.SWITCH_EQUIPVIEW,
      this.__panelHandler,
      this,
    ); //切换界面
    PlayerManager.Instance.addEventListener(
      RequestInfoEvent.QUERY_PETDATA_RESULT,
      this.onRecvPetData,
      this,
    );
    PlayerManager.Instance.addEventListener(
      RequestInfoEvent.BAG_EQUIPLOOK,
      this.__receiveEquipHandler,
      this,
    );
    PlayerManager.Instance.addEventListener(
      RequestInfoEvent.QUERY_MOUNT_RESULT,
      this.onRecvMountInfo,
      this,
    );
    PlayerManager.Instance.addEventListener(
      RequestInfoEvent.QUERY_MASTERY_RESULT,
      this.onRecvMasteryInfo,
      this,
    );
    (this.controler.data as SkillWndData).addEventListener(
      SkillWndData.UPDATE_RUNEHOLE_INFO,
      this.updateRuneHoleData,
      this,
    );
  }
  ...
  private onRecvPetData(petData: PetData): void {
    if (petData) {
      ...
      //查看自己的英灵
      let selfData =
        PlayerManager.Instance.currentPlayerModel.playerInfo.enterWarPet;
      if (selfData) {
        FrameCtrlManager.Instance.open(EmWindow.MyPetWnd, selfData);
      }
    } else {
      var str: string = LangManager.Instance.GetTranslation(
        "playerinfo.PlayerInfoFrameII.noWarPet",
      );
      MessageTipManager.Instance.show(str);
    }
  }
  ...
  private __receiveEquipHandler(msg: DetailRspMsg): void {
    ...
    let hole: TattooHole;
    for (const holeMsg of msg.tatooHoleInfo) {
      //TattooHoleMsg
      hole = new TattooHole();
    ...
    this.property.setFashionProperty(
      this._thane.devourGrade,
      msg.fashionProperty,
    );

    if (this._isRobot) {
      var robot: ThaneInfo = SpaceTemplateManager.Instance.getRobotInfo(
        this._thane.userId,
      );
    ...
    //     }
    // }
    if (msg.item.length > 0 || msg.star.length > 0) {
      //物品
      this._equipDic = new SimpleDictionary();
    }
    for (var i: number = 0; i < msg.item.length; i++) {
      ...
      goods.beginDate = DateFormatter.parse(
        itemMsg.beginDate,
        "YYYY-MM-DD hh:mm:ss",
      );
      ...
      this._equipDic[goods.pos + "_" + goods.objectId + "_" + goods.bagType] =
        goods;
    }
    ...
    if (this._equipDic) {
      ...
      var armsFashion: GoodsInfo =
        this._equipDic[11 + "_" + this._thane.id + "_" + BagType.HeroEquipment];
      this._thane.bodyEquipAvata =
        clothEquip && clothEquip.templateInfo
          ? clothEquip.templateInfo.Avata
          : "";
      this._thane.armsEquipAvata =
        armsEquip && armsEquip.templateInfo ? armsEquip.templateInfo.Avata : "";
      this._thane.wingAvata =
        wingEquip && wingEquip.templateInfo ? wingEquip.templateInfo.Avata : "";
      this._thane.hairFashionAvata =
        hairFashion && hairFashion.templateInfo
          ? hairFashion.templateInfo.Avata
          : "";
      this._thane.bodyFashionAvata =
        clothFashion && clothFashion.templateInfo
          ? clothFashion.templateInfo.Avata
          : "";
      this._thane.armsFashionAvata =
        armsFashion && armsFashion.templateInfo
          ? armsFashion.templateInfo.Avata
          : "";
    }
    ...
    for (i = 0; i < msg.powcardfight.length; i++) {
      var fightInfo: SimplePowCardFightInfoMsg = msg.powcardfight[
        i
      ] as SimplePowCardFightInfoMsg;
    ...
    msg.watch.forEach((info2) => {
      var item: BattleGuardSocketInfo =
        this._thane.battleGuardInfo.getSocketInfo(
          info2.gridType,
          info2.gridPos - 1,
        );
  ...
  private createEquip() {
    ...
    this.heraldry.visible = this.halidom.visible =
      ComponentSetting.WENZHANG_SHENGWU;
  }
  ...
  private updatePersonalInfo() {
    ...
    consortiaName = LangManager.Instance.GetTranslation(
      "sort.view.MemberTitleView.ConsortiaName",
    );
    consortiaName = this._thane.consortiaName
      ...
      : "";
    this.txt_name.text =
      LangManager.Instance.GetTranslation("public.level2", this._thane.grades) +
      "  " +
      nickName;
  ...
  private updateEquip() {
    ...
    for (let i = 0; i < this._equipList.length; i++) {
      ...
      this._equipViewList.add(
        equipGrid.item.pos +
          "_" +
          this._thane.id +
          "_" +
          equipGrid.item.bagType,
        equipGrid,
      );
    }
    ...
    this._honerViewList.add(
      this.honor1.item.pos +
        "_" +
        this._thane.id +
        "_" +
        this.honor1.item.bagType,
      this.honor1,
    );
    ...
    for (const key in dic) {
      if (dic.hasOwnProperty(key)) {
        ...
        let grid: PlayerEquipCell = this.getItemViewByPos(
          info.pos,
          BagType.Honer,
        ) as PlayerEquipCell;
        if (!grid) {
  ...
  public getItemViewByPos(
    pos: number,
    bagType: number = BagType.HeroEquipment,
  ): PlayerEquipCell {
    if (!this._thane) {
      return null;
    }
    ...
    if (bagType == BagType.HeroEquipment) {
      item = this._equipViewList[
        pos + "_" + this._thane.id + "_" + bagType
      ] as PlayerEquipCell;
    } else {
  ...
  private removeEvent() {
    ...
    this.fashionModel.removeEventListener(
      FashionEvent.SWITCH_EQUIPVIEW,
      this.__panelHandler,
      this,
    ); //切换界面
    ...
    (this.controler.data as SkillWndData).removeEventListener(
      SkillWndData.UPDATE_RUNEHOLE_INFO,
      this.updateRuneHoleData,
      this,
    );
