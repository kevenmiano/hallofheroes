 ...
 * 全民兑换
 */
export default class AllExchangeView extends FUI_AllExchangeView implements FunnyContent {
    ...
    initView() {
        ...
        this.txt0.text = LangManager.Instance.GetTranslation('allmainexchange.str12');
        this.txt1.text = LangManager.Instance.GetTranslation('allmainexchange.str15');
        this.txt2.text = LangManager.Instance.GetTranslation('map.campaign.view.ui.demon.ConsortiaDemonWoundView.activityTimeTip') + ':';
        //活动时间
        let endTime = DateFormatter.parse(this.model.end, "YYYY-MM-DD hh:mm:ss").getTime();
    ...
    private updateInfo(isInit: boolean = false): void {
        ...
        goods.count = GoodsManager.Instance.getGoodsNumByTempId(this.model.changeItem);
    ...
    private initEvent() {
        ...
        AllManExchangeManager.Instance.addEventListener(NotificationEvent.AllManExchangeUpdate, this.updateInfo, this);
    }
    ...
    private removeEvent() {
        ...
        AllManExchangeManager.Instance.removeEventListener(NotificationEvent.AllManExchangeUpdate, this.updateInfo, this);
    }
    ...
    onHelp() {
        ...
        let content: string = LangManager.Instance.GetTranslation("allmainexchange.str11");
