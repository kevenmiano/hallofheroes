 ...
 */
 export class MyPetWnd extends BaseWindow {
    ...
    private addEvent(){
        ...
        NotificationManager.Instance.addEventListener(NotificationEvent.UPDATE_LOOKINFO_SELECTIDEX,this.updateView,this);
    }

    private removeEvent(){
        Utils.clearGListHandle(this.goodsList);
        NotificationManager.Instance.removeEventListener(NotificationEvent.UPDATE_LOOKINFO_SELECTIDEX,this.updateView,this);
    }
    ...
    private updateView(index:number){
        ...
        this._petList = PlayerManager.Instance.currentPlayerModel.playerInfo.petList;
