...
export default class BloodSingle extends FUI_BloodSingle {
    ...
    private addEvent() {
        this._roleInfo.addEventListener(RoleEvent.BLOOD_CHANGE, this.updateBlood, this);
        this._roleInfo.addEventListener(RoleEvent.BLOOD_CHANGE_S, this.updateBlood, this);
    }
    ...
    private removeEvent() {
        this._roleInfo && this._roleInfo.removeEventListener(RoleEvent.BLOOD_CHANGE, this.updateBlood, this);
        this._roleInfo && this._roleInfo.removeEventListener(RoleEvent.BLOOD_CHANGE_S, this.updateBlood, this);
    }
