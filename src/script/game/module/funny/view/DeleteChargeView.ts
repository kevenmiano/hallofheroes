...
export default class DeleteChargeView extends FUI_DeleteChargeView implements FunnyContent {
    ...
    initView() {
        if (this._infoData) {
            ...
            this.timeValueTxt.text = LangManager.Instance.GetTranslation("funny.FunnyRightView.active.timeText", DateFormatter.transDate(this._infoData.startTime / 1000), DateFormatter.transDate(this._infoData.endTime / 1000));
            this.totalTxt.text = LangManager.Instance.GetTranslation("DeleteChargeView.totalTxt", this._infoData.finishNum);
    ...
    onHelp() {
        ...
        let content: string = LangManager.Instance.GetTranslation("DeleteChargeView.str");
    ...
    onJoin() {
        ...
        let content: string = LangManager.Instance.GetTranslation("managers.TreasureMapManager.proTxt1", this._infoData.finishNum);
    ...
    private setNoteTxt() {
        ...
        if (this._infoData.finishNum > this._chargeValue[4]) {
            this.noteTxt.text = LangManager.Instance.GetTranslation("DeleteChargeView.noteTxt5", value, this.getTotalValue());
        } else if (this._infoData.finishNum <= this._chargeValue[4] && this._infoData.finishNum > this._chargeValue[3]) {
            this.noteTxt.text = LangManager.Instance.GetTranslation("DeleteChargeView.noteTxt4", value, this.getTotalValue());
        } else if (this._infoData.finishNum <= this._chargeValue[3] && this._infoData.finishNum > this._chargeValue[2]) {
            this.noteTxt.text = LangManager.Instance.GetTranslation("DeleteChargeView.noteTxt3", value, this.getTotalValue());
        } else if (this._infoData.finishNum <= this._chargeValue[2] && this._infoData.finishNum > this._chargeValue[1]) {
            this.noteTxt.text = LangManager.Instance.GetTranslation("DeleteChargeView.noteTxt2", value, this.getTotalValue());
        } else if (this._infoData.finishNum <= this._chargeValue[1] && this._infoData.finishNum >= this._chargeValue[0]) {
            this.noteTxt.text = LangManager.Instance.GetTranslation("DeleteChargeView.noteTxt1", value, this.getTotalValue());
        }
    }
