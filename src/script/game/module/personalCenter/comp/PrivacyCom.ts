...
export default class PrivacyCom extends FUI_PrivacyCom {
    ...
    public initData(): void {
        ...
        settingData.Title = LangManager.Instance.GetTranslation("PrivacyCom.settingData.title1");
        settingData.Value = LangManager.Instance.GetTranslation("PrivacyCom.settingData.Value1");
        settingData.type = "android.permission.READ_PHONE_STATE";
        settingData.Progress = channel.checkPermission("android.permission.READ_PHONE_STATE");//SharedManager.Instance.authorizDic[AthorzieType.Phone];
        // this.listData.push(settingData);

        settingData = new SettingData();
        settingData.Title = LangManager.Instance.GetTranslation("PrivacyCom.settingData.title2");
        settingData.Value = LangManager.Instance.GetTranslation("PrivacyCom.settingData.Value2");
        settingData.type = "android.permission.READ_EXTERNAL_STORAGE";
        settingData.Progress = channel.checkPermission("android.permission.READ_EXTERNAL_STORAGE");//SharedManager.Instance.authorizDic[AthorzieType.Save];
        this.listData.push(settingData);

        settingData = new SettingData();
        settingData.Title = LangManager.Instance.GetTranslation("PrivacyCom.settingData.title3");
        settingData.Value = LangManager.Instance.GetTranslation("PrivacyCom.settingData.Value3");
        settingData.type = "android.permission.RECORD_AUDIO";
        settingData.Progress = channel.checkPermission("android.permission.RECORD_AUDIO");//SharedManager.Instance.authorizDic[AthorzieType.MicroPhone];
        this.listData.push(settingData);
    ...
    private addEvent(): void {
        ...
        NotificationManager.Instance.addEventListener(NativeEvent.PERMISSION_UPDATE, this.updateView, this);
    }
    ...
    public removeEvent(): void {
        ...
        NotificationManager.Instance.removeEventListener(NativeEvent.PERMISSION_UPDATE, this.updateView, this);
    }
