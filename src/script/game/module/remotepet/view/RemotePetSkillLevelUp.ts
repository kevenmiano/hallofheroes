...
export class RemotePetSkillLevelUp extends BaseWindow {
    ...
    private addEvent() {
        this.model.addEventListener(RemotePetEvent.SKILLEVELUP, this.updateView, this);
    }
    private removeEvent() {
        this.model.removeEventListener(RemotePetEvent.SKILLEVELUP, this.updateView, this);
    }
