  ...
  private initView() {
    if (this._info) {
      ...
      if (tempInfo) {
        ...
        this.resouceAddTxt.text = LangManager.Instance.GetTranslation(
      ...
      if (this._info.info.occupyLeagueName == "") {
        //占领的公会信息无
        this.occupyNameTxt.text = LangManager.Instance.GetTranslation(
      ...
      let endTime: number =
        PlayerManager.Instance.currentPlayerModel.stateEndTime; //截止时间
