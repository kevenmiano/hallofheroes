...
export default class PointUtils {
    ...
    * @return 转换后的坐标的点。
    */
    public static localToGlobal(target: any, point: Laya.Point, createNewPoint: boolean = false): Laya.Point {
     ...
     * @return 转换后的坐标的点。
     */
    public static globalToLocal(target: any, point: Laya.Point, createNewPoint: boolean = false): Laya.Point {
        //if (!_displayedInStage || !point) return point;
        if (createNewPoint) {
            point = new Laya.Point(point.x, point.y);
        }
