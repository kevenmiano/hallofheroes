  ...
  private initView() {
    if (this._info) {
      ...
      if (this._info.uncontestable) {
        ...
        this.personCountTxt.text = LangManager.Instance.GetTranslation(
          "maze.MazeFrame.Order",
        );
        this.statusTxt.text = BaseCastle.getCastleStateName(
          EmOuterCityWarCastlePeriodType.Peace,
        );
        this.statusTxt.color = BaseCastle.getCastleStateColor(
          EmOuterCityWarCastlePeriodType.Peace,
        );
      } else {
