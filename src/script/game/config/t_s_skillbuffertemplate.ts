...
export class t_s_skillbuffertemplateData extends t_s_baseConfigData {
  ...
  public getAddEffectArr(): any[] {
    if (!this._addEffectArr) {
      ...
      if (
        this._addEffectArr.length < 1 ||
        this._addEffectArr[0] == "" ||
        this._addEffectArr[0] == "undefined"
      ) {
  ...
  public getActionEffectArr(): any[] {
    if (!this._actionEffectArr) {
      ...
      if (
        this._actionEffectArr.length < 1 ||
        this._actionEffectArr[0] == "" ||
        this._actionEffectArr[0] == "undefined"
      ) {
  ...
  public getLastEffectArr(): any[] {
    if (!this._lastEffectArr) {
      ...
      if (
        this._lastEffectArr.length < 1 ||
        this._lastEffectArr[0] == "" ||
        this._lastEffectArr[0] == "undefined"
      ) {
