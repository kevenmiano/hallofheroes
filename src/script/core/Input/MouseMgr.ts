...
* @description *** 
*/
export default class MouseMgr extends GameEventDispatcher implements IManager {
     ...
     * @param mouseOut 鼠标移出
     */
    register(target: Laya.Sprite, args?: any, mouseDown?: Function, mouseUp?: Function, mouseWheel?: Function, mouseOver?: Function, mouseOut?: Function) {
