 ...
 * 
 */
export default class DragRuneIcon extends FUI_DragRuneIcon implements DragObject {
    ...
    public set runeInfo(value: RuneInfo) {
        this._runeInfo  = value;
        this.iconloader.url = IconFactory.getTecIconByIcon(this._runeInfo.templateInfo.Icon);
    }
