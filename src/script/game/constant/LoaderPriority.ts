...
export default class LoaderPriority {
    ...
    public static isMonopolizeLoader(info: LoaderInfo): boolean {
        return (info.priority == LoaderPriority.Priority_10) || (info.priority == LoaderPriority.Priority_9);
    }

    public static canRemoveList: Array<LoaderPriority> = [LoaderPriority.Priority_4, LoaderPriority.Priority_9];
    /**
     * 可以移除的 loader
     * @return 
     * 
