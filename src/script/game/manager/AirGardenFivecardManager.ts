...
export class AirGardenFivecardManager extends GameEventDispatcher {
    ...
    public setup() {
        ...
        ServerDataManager.listen(S2CProtocol.U_C_FIVE_CARD_POKER_INFO, this, this.infoHandler);
        ServerDataManager.listen(S2CProtocol.U_C_FIVE_CARD_SCORE_REWARD, this, this.scoreAwardHandler);
    }
    ...
    */
    ...
    private scoreAwardHandler(pkg: PackageIn) {
        ...
        let str = LangManager.Instance.GetTranslation("AirGardenGame.hint3", msg.score, msg.count);
