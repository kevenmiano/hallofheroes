...
/**
 * @author:pzlricky
 * @data: 2021-06-21 16:56
 * @description ***
 */
export default class KeyStroke implements KeyType {
  ...
  public getCodeSequence(): Array<number> {
    return [this.code];
  }
  ...
  public static VK_NUMPAD_MULTIPLY: KeyStroke = new KeyStroke(
    "Numpad_Multiply",
    106,
  ); // *
  ...
  public static VK_NUMPAD_SUBTRACT: KeyStroke = new KeyStroke(
    "Numpad_Subtract",
    109,
  ); // -
  public static VK_NUMPAD_DECIMAL: KeyStroke = new KeyStroke(
    "Numpad_Decimal",
    110,
  ); // .
  public static VK_NUMPAD_DIVIDE: KeyStroke = new KeyStroke(
    "Numpad_Divide",
    111,
  ); // /
