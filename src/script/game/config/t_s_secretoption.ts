  ...
  get optionName(): [string, string] {
    ...
    switch (this.Type) {
      case SecretEventOptType.Next:
        mainStr = LangManager.Instance.GetTranslation(
          "Pve.secretScene.goToNextlevel",
        );
        break;
      ...
      case SecretEventOptType.Tresure:
        let temp1 = ConfigMgr.Instance.getTemplateByID(
          ConfigType.t_s_secrettreasure,
          this.Param1,
        ) as t_s_secrettreasureData;
        let temp2 = ConfigMgr.Instance.getTemplateByID(
          ConfigType.t_s_secrettreasure,
          this.Param2,
        ) as t_s_secrettreasureData;
        let temp3 = ConfigMgr.Instance.getTemplateByID(
          ConfigType.t_s_secrettreasure,
          this.Param3,
        ) as t_s_secrettreasureData;
        ...
        if (this.Param2 == "" && this.Param3 == "") {
          mainStr = LangManager.Instance.GetTranslation(
            "Pve.secretScene.gain",
            temp1.TemplateNameLang,
            temp1.profileColor,
          );
          viceStr = temp1.DescriptionLang;
        } else if (this.Param2 != "" && this.Param3 != "") {
          mainStr = LangManager.Instance.GetTranslation(
            "Pve.secretScene.composite",
            temp1.TemplateNameLang,
            temp1.profileColor,
          );
          viceStr = LangManager.Instance.GetTranslation(
            "Pve.secretScene.consume",
            temp2.TemplateNameLang,
            temp3.TemplateNameLang,
          );
        } else {
          let handName = "";
          if (this.Param2) {
          ...
          mainStr = LangManager.Instance.GetTranslation(
            "Pve.secretScene.swap",
            temp1.TemplateNameLang,
            temp1.profileColor,
          );
          viceStr = LangManager.Instance.GetTranslation(
            "Pve.secretScene.handOver",
            handName,
          );
        }
        break;
