...
export default class FUI_OuterCityWarBuildSiteItem extends fgui.GComponent {
  ...
  public static createInstance(): FUI_OuterCityWarBuildSiteItem {
    return <FUI_OuterCityWarBuildSiteItem>(
      fgui.UIPackage.createObject("OuterCityWar", "OuterCityWarBuildSiteItem")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.txtPetTotalCapaity = <fgui.GTextField>(
      this.getChild("txtPetTotalCapaity")
    );
