...
import {
  default as MazeShopItem,
  default as ShopItem,
} from "./com/MazeShopItem";
...
export default class MazeShopWnd extends BaseWindow {
  ...
  private __refreshPage() {
    this.PageNumTxt.text =
      this._model.currentPage + "/" + this._model.totalPage;
  }
  ...
  private getName(): string {
    ...
    if (
      ...
      goodsTempInfo.MasterType == GoodsType.PROP
    ) {
