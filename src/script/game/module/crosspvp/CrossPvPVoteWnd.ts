...
export default class CrossPvPVoteWnd extends BaseWindow {
    ...
    private initView() {
        this.leftTimeTxt.text = LangManager.Instance.GetTranslation("CrossPvPSuccessWnd.leftTimeTxt", this.totalTimeCount);
    ...
    private confirmBtnHandler() {
        ...
        CampaignSocketOutManager.Instance.sendCrossCmapignKillOutSelect(1,this.playInfo.serviceName);
        this.hide();
    }
   ...
   private cancelBtnHandler() {
        Laya.timer.clear(this, this.updateLeftTimeTxt);
        CampaignSocketOutManager.Instance.sendCrossCmapignKillOutSelect(0, this.playInfo.serviceName);
        this.hide();
    }
