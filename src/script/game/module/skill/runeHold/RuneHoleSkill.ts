...
export class RuneHoleSkill extends FUI_RuneHoleSkill {
    ...
    public setInfo(info: RuneHoleInfo, isTemp = false) {
        ...
        this.skillName.color = GoodsSonType.getColorByProfile(skillInfo.templateInfo.Grades);
        this.skillDesc.text = skillInfo.templateInfo.SkillDescription;
        this.skillIcon.url = IconFactory.getCommonIconPath(skillInfo.templateInfo.Icons);
        ...
        let condition = isTemp ? info.getTempSkillCondition() : info.getSkillCondition();
