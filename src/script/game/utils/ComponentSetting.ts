...
export default class ComponentSetting {
     ...
     */
    public static SIMPLE_BITMAP_BUTTON_FILTER: string = "null,lightFilter,null,grayFilter";
    /**
     *确定和取消按钮的间距 
     */
    ...
    */
    ...
    public static CASTEL_BUILD_LEVELBG_PATH1: string = "res/game/castle/level1.png";//内城建筑等级底图1
    public static CASTEL_BUILD_LEVELBG_PATH2: string = "res/game/castle/level2.png";//内城建筑等级底图2拉伸的
    public static CASTEL_BUILD_MARKET_HALO: string = "res/game/castle/market_halo.png";//市场光圈
    public static CASTEL_BUILD_MARKET_CASH: string = "res/game/castle/market_cash.png";//市场金币
    /**
    ...
    */
    ...
    public static getUIConfigZIPPath(): string {
        if (ComponentSetting.ResloveConfigZipPathCall == null) {
            if (!DisplayLoader.isDebug) {
                return ComponentSetting.RESOURCE_PATH + "ui/" + ComponentSetting.LANGUAGE + "/xml/xml.png";
            }
    ...
    public static getSoundSourcePath(soundPathName: string): string {
        return ComponentSetting._SOUND_PREFIX + soundPathName.toLocaleLowerCase() + '.wav';
    }

    public static getSkillSoundSourcePath(soundPathName: string): string {
        return ComponentSetting._SOUND_PREFIX + "skilleffect/" + soundPathName.toLocaleLowerCase() + '.wav';
    }
    ...
    public static getSoundMusicPath(musicPathName: string): string {
        return ComponentSetting._SOUND_PREFIX + musicPathName.toLocaleLowerCase() + '.mp3';
    }
    ...
    public static get LanguagePath(): string {
        if (DisplayLoader.isDebug)
            ...
            return ComponentSetting.RESOURCE_PATH + "res/config/" + ComponentSetting.LANGUAGE + "/" + "language.json";
    }
    /**
     * 脏字符文件地址
     */
    public static get ZhanPath(): string {
        if (Utils.isWxMiniGame() && ComponentSetting.IOS_VERSION) {
            ...
            return ComponentSetting.TEMPLATE_PATH + "zip_dirty.txt" + "?v=" + new Date().getTime();
        }
        return "";
    }
    /**
    ...
    public static get AgentZhanPath(): string {
        if (Utils.isWxMiniGame() && ComponentSetting.IOS_VERSION) {
            ...
            return ComponentSetting.TEMPLATE_PATH + "proxy_dirty.txt" + "?v=" + new Date().getTime();
        }
        return "";
    }
    /**
    ...
    public static get templatePath(): string {
        return ComponentSetting.TEMPLATE_PATH + "tempinfos.xml" + "?v=" + new Date().getTime();
    }
    ...
    public static getUILanguage(langName: string) {
        return this.RESOURCE_PATH + this.XML_PREFIX + "language/" + langName + ".xml";
    }
    ...
    public static get newGuildHelpPath(): string {
        if (DisplayLoader.isDebug) {
            ...
            return ComponentSetting.RESOURCE_PATH + "ui/" + ComponentSetting.LANGUAGE + "/" + "newguildhelp.xml";
        }
    }
    /**
     * 对应模块的代码文件
    ...
    public static getBattleMapPath(mapAssetId: number): string {
        return ComponentSetting.RESOURCE_PATH + "sceneima/" + mapAssetId + "/map" + mapAssetId + ".swf";
    }
    ...
    public static setColor(frame: number): string {
        let colorArray: Array<string> = ["#00d8ff", "#ffffff", "#bae800", "#fff600", "#ff0004", "#4dbbee", "#ff0b2d", "#64cc27", "#ffffff"];
        return colorArray[frame - 1];
    }

    public static setFarmItemColor(frame: number): string {
        let colorArray: Array<string> = ["#ffffff", "#59cd41", "#32a2f8", "#a838f7", "#eb9504", "#ce0f0f"];
        return colorArray[frame - 1];
    }
