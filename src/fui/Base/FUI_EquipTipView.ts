...
export default class FUI_EquipTipView extends fgui.GComponent {
	...
	public static createInstance():FUI_EquipTipView {
		return <FUI_EquipTipView>(fgui.UIPackage.createObject("Base", "EquipTipView"));
	}
	...
	protected onConstruct():void {
		...
		this.equipTipsContent = <FUI_EquipTipsContent>(this.getChild("equipTipsContent"));
		this.txt_time = <fgui.GTextField>(this.getChild("txt_time"));
		this.txt_fashionIdentity = <fgui.GRichTextField>(this.getChild("txt_fashionIdentity"));
		this.img_star = <fgui.GImage>(this.getChild("img_star"));
		this.group_star = <fgui.GGroup>(this.getChild("group_star"));
		this.txt_fashionProfile = <fgui.GRichTextField>(this.getChild("txt_fashionProfile"));
