...
export class PathManager {
    ...
    public static solveHeroAvatarPath(path: string, sex: number): string {
        return this.resourcePath + "equip" + path.toLocaleLowerCase() + "/" + sex + "/" + sex + ".json";
    }

    public static solveWingAvatarPath(name: string, job: number, sex: number): string {
        return this.resourcePath + "equip" + name.toLocaleLowerCase() + "/" + job + "_" + sex + "/" + job + "_" + sex + ".json";
    }
    ...
    public static solveShowHeroAvatarPath(type: string, method: string, direction: string, path: string, sex: number): string {
        let fileName: string = sex + ".json";
        if (!method)
            return this.resourcePath + type.toLocaleLowerCase() + path.toLocaleLowerCase() + "/" + fileName.toLocaleLowerCase();//文件名0.swf代表女avatar,文件名1.swf代表男avatar
        else
            return this.resourcePath + type.toLocaleLowerCase() + path.toLocaleLowerCase() + "/" + method.toLocaleLowerCase() + "/" + direction.toLocaleLowerCase() + "/" + fileName.toLocaleLowerCase();//文件名0.swf代表女avatar,文件名1.swf代表男avatar
    }
    public static get solveEffectConfig(): string {
        return this.resourcePath + "commandEffectConfig.xml" + "?v=" + new Date().getTime();
    }
    ...
    public static get AgentZhanPath(): string {
        return this._info.TEMPLATE_PATH + "proxy_dirty.txt" + "?v=" + new Date().getTime();
    }

    public static solveRolePath(name: string, suff: string = ""): string {
        return this.resourcePath + "swf/" + name.toLocaleLowerCase() + "/" + name.toLocaleLowerCase() + "/" + name.toLocaleLowerCase() + ".json";
    }
    ...
    public static solveSkillSoundResPath(name: string, transition: boolean = false, toLowerCase: boolean = false): string {
        let jsonName = name
        let folderName = ""
        if (transition) {
        ...
        return this.toLowerCase(this.resourcePath + "skilleffect/" + folderName) + "/Sound/";
    }

    public static solveSkillResPath(name: string, transition: boolean = true, toLowerCase: boolean = false): string {
        let jsonName = name
        let folderName = ""
        if (transition) {
            folderName = StringHelper.replaceStr(name, ".", "_")
        ...
        // Logger.log("solveSkillResPath", this.resourcePath + "skilleffect/" + folderName + "/" + jsonName + ".json")
        return this.toLowerCase(this.resourcePath + "skilleffect/" + folderName.toLocaleLowerCase() + "/" + jsonName.toLocaleLowerCase() + ".json");
    }

    public static solveSkillPublicResPath(jsonName?: string, transition: boolean = true): string {
    ...
    public static solveResistSheldResPath(jsonName?: string, transition: boolean = true): string {
    ...
    public static solveRoleDefaultPath(job: number, partStr: string, sex: number, suff: string = ""): string {
        let jobStr: string;
        switch (job) {
        ...
        return this.toLowerCase(this.resourcePath + "equip/" + jobStr + "_default_" + partStr + suff + "/" + sex + "/" + sex + ".json");
    }
    ...
    public static getBattleMapPath(mapAssetId: number): string {
        ...
        return this.resourcePath + "sceneima/" + mapAssetId + "/map" + mapAssetId + "/" + mapAssetId + ext;
    }
    ...
    public static solveEffectPath(id: string, type: string): string {
        return this.toLowerCase(this.resourcePath + "swf/" + id + "/" + type + id + ".json");
    }
    public static getOuterCityMapsData(name: number): string {
        let ext = ".dat";
        return this.toLowerCase(this.resourcePath + "maps/" + name + "/" + name + ext);
    }
    ...
    public static getOuterCityNoteData(name: number): string {
        return this.toLowerCase(this.resourcePath + "maps/" + name + "/" + name + ".rd");
    }
    public static getOuterCityNotePaths(name: number): string {
        return this.toLowerCase(this.resourcePath + "maps/" + name + "/" + name + ".path");
    }
    public static getMapBackPaths(name: string | number): string {
        return this.toLowerCase(this.resourcePath + "mapmaterial/land/" + name + "/");
    }
    public static solveMapPhysicsBySonType(sonType: number): string {
        return this.toLowerCase(this.resourcePath + "mapmaterial/build/" + sonType + "/" + sonType + ".json");
    }
    public static solveMapPhysicsBySwf(swf: string, type: number): string {
        return this.toLowerCase(this.resourcePath + "mapmaterial/build/" + swf + "/" + type + ".json");
    }
    ...
    public static solveSelectCampaignPath(chapterID: number, areaID?: number): string {
        if (!areaID) {
            return PathManager.resourcePath + "swf/singlecampaign1/" + chapterID + "/map/" + chapterID + ".jpg";
        } else {
            return PathManager.resourcePath + "swf/singlecampaign1/" + chapterID + "/" + areaID + ".jpg";
        }
    }
    ...
    public static avatarResourcePath(name: string, sex: number): string {
        return this.resourcePath + "swf/avatar" + name + "/" + sex + "/" + sex + ".json";
    }
    public static wingAvatarResourcePath(name: string, job: number, sex: number): string {
        return this.resourcePath + "swf/avatar" + name + "/" + job + "_" + sex + "/" + job + "_" + sex + ".json";
    }
    /**
     ...
     * 
     */
    public static getAvatarResourcePath(key: string, sex: number, positionType: number, position: string, job: number, avatarType: number, fileType: string = ".json"): string {
        let url: string = "";
        if (job == 100)
            return this.resourcePath + key;
        if (positionType == 1) {//普通
            if (position == AvatarPosition.MOUNT) {//坐骑
                url = this.resourcePath + "swf/avatar" + key + "/" + 2 + "/" + 2 + fileType;
            }
            else if (position == AvatarPosition.WING) {//翅膀
                url = this.resourcePath + "swf/avatar" + key + "/" + job + "_" + sex + "/" + job + "_" + sex + fileType;
            }
            else if (position == AvatarPosition.PET) {//英灵
                url = this.resourcePath + "swf/avatar" + key + "/" + 2 + "/" + 2 + fileType;
            }
            else if (avatarType == 1) {//玩家
                url = this.resourcePath + "swf/avatar" + key + "/" + sex + "/" + sex + fileType;
            }
            else if (avatarType == 2) {//NPC
                url = this.resourcePath + "swf/npc/" + key + "/" + key + fileType;
            }
            else if (avatarType == 3) {//紫晶矿车
                if (position == AvatarPosition.BODY) {
                    url = this.resourcePath + "swf/avatar/mineral_body/" + key + "/" + key + fileType;
                } else if (position == AvatarPosition.HAIR_UP) {
                    url = this.resourcePath + "swf/avatar/mineral_hair/" + key + "/" + key + fileType;
                }
            }
        }
        else if (positionType == 2) {//时装
            url = this.resourcePath + "swf/avatar" + key + "/" + job + "_" + sex + "/" + job + "_" + sex + fileType;
        }
        else {
    ...
    public static get templatePath(): string {
        ...
        return this._info.TEMPLATE_PATH + "tempinfos.xml" + "?v=" + new Date().getTime();
    }
    public static get timeStoryPath(): string {
        return this._info.TEMPLATE_PATH + "gametimes.xml" + "?v=" + new Date().getTime();
    }
    public static get versionPath(): string {
        return this._info.TEMPLATE_PATH + "version.xml" + "?v=" + new Date().getTime();
    }

    public static get backAvatarList(): string {
        return this._info.TEMPLATE_PATH + "avata.xml" + "?v=" + new Date().getTime();
    }

    public static get backResourceList(): string {
        return this._info.TEMPLATE_PATH + "resource.xml" + "?v=" + new Date().getTime();
    }
    ...
    public static get challengPath(): string {
        return this._info.TEMPLATE_PATH + "challengeorder.json" + "?v=" + new Date().getTime()
    }

    public static get crossOrderPath(): string {
        return this._info.TEMPLATE_PATH + "cross/crossscore.json" + "?v=" + new Date().getTime();
    }

    // unuse
    public static get singlePassOrderPath(): string {
        return this._info.TEMPLATE_PATH + "singlepass.json" + "?v=" + new Date().getTime();
    }

    public static get gemMazeOrderPath(): string {
        return this._info.TEMPLATE_PATH + "gemmaze.json" + "?v=" + new Date().getTime();
    }

    public static getMazeOrderPath(index: number): string {
        if (index == 0)
            return this._info.TEMPLATE_PATH + "tower_unzip.xml" + "?v=" + new Date().getTime();
        else if (index == 1)
            return this._info.TEMPLATE_PATH + "tower2_unzip.xml" + "?v=" + new Date().getTime()
        return ""
    }
    ...
    public static get snsTempPath(): string {
        return this._info.TEMPLATE_PATH + "sns_temp.xml" + "?v=" + new Date().getTime();
    }
    ...
    public static getCarnivalPath(theme: string, imgStr: string, fileType: string = ".png"): string {
        return this.resourcePath + "images/carnival/" + theme + "/" + imgStr + fileType;
    }

    public static getCarnivalFolderPath(theme: string, folder: string, imgStr: string, fileType: string = ".png"): string {
        return this.resourcePath + "images/carnival/" + theme + "/" + folder + "/" + imgStr + fileType;
    }
    ...
    public static getVehicleSkillPath(actionId: string): string {
        return this.resourcePath + "vehicle/skill/" + actionId + "/" + actionId + ".json";
    }
    ...
    public static getAppellImgPath2(templateId: number, index: number = 0): string {
    ...
    public static getFateBattlePath(id: number): string {
        return this.resourcePath + "equip/fatehalo_attack/" + id + "/" + id + ".json";
    }
    /************ pet end*****************************************/
    ...
    public static getRemotePetOrderPath(): string {
        return this._info.TEMPLATE_PATH + "remotepet.json" + "?v=" + new Date().getTime();
    }
    ...
    public static getMountPath(avatarPath: string): string {
        return PathManager.resourcePath + "equip_show" + avatarPath.toLocaleLowerCase() + "/2/2.json";
    }

    //坐骑单张图
    public static getSMountPath(avatarPath: string): string {
        return PathManager.resourcePath + "equip_show" + avatarPath.toLocaleLowerCase() + "_s" + "/2/2.json";
    }
    ...
    public static solveMapPngBySonType(sonType: number): string {
        return this.toLowerCase(this.resourcePath + "mapmaterial/build/" + sonType + "/" + sonType + "_small.png");
    }

    public static getMineItemPngBySonType(sonType: number): string {
        return this.toLowerCase(this.resourcePath + "mapmaterial/build/" + sonType + "/" + sonType + "_mine.png");
    }
    ...
    public static getSecretSelectBgPath(imgPath: string): string {
        return this.toLowerCase(this.resourcePath + "images/secret/" + imgPath+ ".png");
    }
}