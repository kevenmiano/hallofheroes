...
export default class BufferContainer extends Laya.Sprite {
    ...
    private addEvent() {
        if (this._info) {
            ...
            this._info.addEventListener(RoleEvent.REFRESH_BUFFER_TURN, this.__reFreshBufferTurn, this);
        }
    }
    ...
    private removeEvent() {
        if (this._info) {
            ...
            this._info.removeEventListener(RoleEvent.REFRESH_BUFFER_TURN, this.__reFreshBufferTurn, this);
        }
    }
