...
export default class FUI_PetEquipTipView extends fgui.GComponent {
	...
	public static createInstance():FUI_PetEquipTipView {
		return <FUI_PetEquipTipView>(fgui.UIPackage.createObject("Base", "PetEquipTipView"));
	}
	...
	protected onConstruct():void {
		...
		this.txt_master_attr_val = <fgui.GTextField>(this.getChild("txt_master_attr_val"));
		...
		this.txt_sonattr_up_tip = <fgui.GTextField>(this.getChild("txt_sonattr_up_tip"));
		...
		this.txt_suit_active_cond = <fgui.GTextField>(this.getChild("txt_suit_active_cond"));
		this.txt_suit_desc = <fgui.GRichTextField>(this.getChild("txt_suit_desc"));
		this.txt_suit_active_cond2 = <fgui.GTextField>(this.getChild("txt_suit_active_cond2"));
		this.txt_suit_active_cond_val = <fgui.GTextField>(this.getChild("txt_suit_active_cond_val"));
