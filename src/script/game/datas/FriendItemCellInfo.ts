...
export default class FriendItemCellInfo extends ThaneInfo
{
    ...
    {
        let msgList:Array<BaseIMInfo> = IMManager.Instance.model.unreadMsgDic[this.userId];
    ...
    commit()
    {
        ...
        {
            FriendManager.getInstance().dispatchEvent(FriendUpdateEvent.FRIEND_UPDATE, null);
        }
        FriendManager.getInstance().dispatchEvent(FriendUpdateEvent.FRIEND_UPDATE, null);
        super.commit();
    }
