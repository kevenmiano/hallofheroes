...
export default class SortModel extends GameEventDispatcher {
    ...
    public set currentShowList(value: Array<SortData>) {
        ...
        this.totalPage = Math.ceil(this._currentShowList.length / SortModel.PAGE_NUM);
    ...
    public getHonourName(honour: number): string {
        var tempList: Array<t_s_upgradetemplateData> = TempleteManager.Instance.getTemplatesByType(UpgradeType.UPGRADE_TYPE_HONER);
        tempList = ArrayUtils.sortOn(tempList, ["Data"], [ArrayConstant.DESCENDING]);
        var honourName: string = "";
        for (var i: number = 0; i < tempList.length; i++) {
            var temp: t_s_upgradetemplateData = tempList[i] as t_s_upgradetemplateData;
            if (honour >= temp.Data) {
    ...
    public initWidthConfig() {
        ...
        this._widthConfig["C" + SortModel.PET_POWER] = "150,150,200,200,140,140,140";
    }
    //配置列名
    public initLanguageConfig() {
        this._languageConfig[SortModel.SELF_LEVEL] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        ...
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.empirical")];
        this._languageConfig[SortModel.SELF_POW] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ap")];
        this._languageConfig[SortModel.CONSORTIA_LEVEL] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ConsortiaName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.level"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.buildValue")];
        this._languageConfig[SortModel.CONSORTIA_POW] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ConsortiaName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.level"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ap")];
        this._languageConfig[SortModel.SELF_HONOUR] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.honourName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.honour")];
        this._languageConfig[SortModel.SELF_CHARMS] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.charms")];
        this._languageConfig[SortModel.SELF_SOULSCORE] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.soulScore")];
        this._languageConfig[SortModel.PET_POWER] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        ...
        //跨服
        this._languageConfig["C" + SortModel.SELF_LEVEL] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.level"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.serverName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.empirical")];
        this._languageConfig["C" + SortModel.SELF_POW] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.serverName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ap")];
        this._languageConfig["C" + SortModel.CONSORTIA_LEVEL] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ConsortiaName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.level"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.serverName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.buildValue")];
        this._languageConfig["C" + SortModel.CONSORTIA_POW] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ConsortiaName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.level"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.serverName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ap")];
        this._languageConfig["C" + SortModel.SELF_HONOUR] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.honourName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.serverName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.honour")];
        this._languageConfig["C" + SortModel.SELF_CHARMS] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.serverName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.charms")];
        this._languageConfig["C" + SortModel.SELF_SOULSCORE] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.name"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.Job"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.serverName"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.soulScore")];
        this._languageConfig["C" + SortModel.PET_POWER] = [LangManager.Instance.GetTranslation("sort.view.MemberTitleView.ranking"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.petname"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.property"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.master"),
        LangManager.Instance.GetTranslation("sort.view.MemberTitleView.petgrade"),
