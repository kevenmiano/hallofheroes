...
export default class FUI_PetChallengeRankItem extends fgui.GButton {
  ...
  public static createInstance(): FUI_PetChallengeRankItem {
    return <FUI_PetChallengeRankItem>(
      fgui.UIPackage.createObject("PetChallenge", "PetChallengeRankItem")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.txtTotalFightPower = <fgui.GTextField>(
      this.getChild("txtTotalFightPower")
    );
