...
export default class DisplayItemsWnd extends BaseWindow {
    ...
    OnHideWind() {
        super.OnHideWind();
        if (PlayerManager.Instance.isScoreRatingApp && PlayerManager.Instance.isExistScoreRating && PlayerManager.Instance.scoreRatingCondition == StoreRatingsType.FIRST_MAZE_100_LEVEL) {
