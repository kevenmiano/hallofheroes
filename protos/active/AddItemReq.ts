...
//   protoc               v3.21.12
// source: active/AddItemReq.proto
...
export const AddItemReq: MessageFns<AddItemReq> = {
  encode(message: AddItemReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddItemReq {
  ...
  create<I extends Exact<DeepPartial<AddItemReq>, I>>(base?: I): AddItemReq {
    return AddItemReq.fromPartial(base ?? ({} as any));
  },
