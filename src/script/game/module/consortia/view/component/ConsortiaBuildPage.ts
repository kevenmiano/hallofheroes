...
export class ConsortiaBuildPage extends FUI_ConsortiaBuildPage
{
    ...
    private initView()
    {
        if(this.consortiaInfo.altarLevel > 0)
        {
            ...
            this.altarNum.setVar("level", this.consortiaInfo.altarLevel.toString()).flushVars();
        }
        else
        {
        ...
        if(this.consortiaInfo.shopLevel > 0)
        {
            ...
            this.shopNum.setVar("level", this.consortiaInfo.shopLevel.toString()).flushVars();
        }
        else
        {
        ...
        if(this.consortiaInfo.storeLevel > 0)
        {
            ...
            this.storeNum.setVar("level", this.consortiaInfo.storeLevel.toString()).flushVars();
        }
        else
        {
        ...
        if(this.consortiaInfo.schoolLevel > 0)
        {
            ...
            this.skillNum.setVar("level", this.consortiaInfo.schoolLevel.toString()).flushVars();
        }
        else
        {
    ...
    private addEvent()
    {
        ...
        this._model.addEventListener(ConsortiaEvent.UPDA_CONSORTIA_INFO, this.initView, this);
    }
    ...
    {
        FrameCtrlManager.Instance.open(EmWindow.ConsortiaStorageWnd, { returnToWin: EmWindow.Consortia, returnToWinFrameData: 2 }, null, EmWindow.Consortia)
    }

    private onAltarBtnClick()
    {
        FrameCtrlManager.Instance.open(EmWindow.ConsortiaAltarWnd, { returnToWin: EmWindow.Consortia, returnToWinFrameData: 2 }, null, EmWindow.Consortia)
    }

    private onSkillBtnClick()
    {
        FrameCtrlManager.Instance.open(EmWindow.ConsortiaSkillTower, { returnToWin: EmWindow.Consortia, returnToWinFrameData: 2 }, null, EmWindow.Consortia)
    }
    ...
    private onShopBtnClick() {
        ...
        FrameCtrlManager.Instance.open(EmWindow.ShopWnd, { page: 1, returnToWin: EmWindow.Consortia, returnToWinFrameData: 2 }, null, EmWindow.Consortia);
    }
    ...
    private removeEvent()
    {
        ...
        this._model.removeEventListener(ConsortiaEvent.UPDA_CONSORTIA_INFO, this.initView, this);
    }
