...
export class EvaluationWnd extends BaseWindow
{
    ...
    private initView()
    {
        ...
        this.content = LTextInput.create(this, "", 18, "#000000", this.contentmask.width, this.contentmask.height, this.contentmask.x, this.contentmask.y, 5);
        this.content.text = "";
    }
    ...
    private onBtnSubmitClick(e:Laya.Event)
    {
        if(this.star.selectedIndex < 5)
        {
            ...
            PlayerManager.Instance.ratingStoreReport(this.star.selectedIndex, comment)
        }
        else
        {
