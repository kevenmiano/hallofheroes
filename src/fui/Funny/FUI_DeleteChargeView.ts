...
export default class FUI_DeleteChargeView extends fgui.GComponent {
	...
	public static createInstance():FUI_DeleteChargeView {
		return <FUI_DeleteChargeView>(fgui.UIPackage.createObject("Funny", "DeleteChargeView"));
	}
	...
	protected onConstruct():void {
		...
		this.totalBackValueTxt = <fgui.GRichTextField>(this.getChild("totalBackValueTxt"));
	}
}