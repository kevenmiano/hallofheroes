...
export default class MineralShopWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.setCenter();
        this.addEvent();
        let titleText = LangManager.Instance.GetTranslation("view.subshop.MineralShopFrame.title");
        this.frame.getChild('title').text = titleText;
        this.txt_tips.text = LangManager.Instance.GetTranslation("view.subshop.MineralShopFrame.describe");
    ...
    private addEvent() {
        ...
        this.playerInfo.addEventListener(PlayerEvent.PLAYER_INFO_UPDATE, this.__updateHandler, this);
    }
    private removeEvent() {
        // this.list && this.list.itemRenderer.recover();
        Utils.clearGListHandle(this.list);
        this.playerInfo.removeEventListener(PlayerEvent.PLAYER_INFO_UPDATE, this.__updateHandler, this);
    }
