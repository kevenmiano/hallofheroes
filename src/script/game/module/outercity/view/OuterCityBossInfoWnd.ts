...
export default class OuterCityBossInfoWnd extends BaseWindow{
    ...
    private initEvent() {
        this.bossList.itemRenderer = Laya.Handler.create(this, this.renderListItem, null, false);
        NotificationManager.Instance.addEventListener(OuterCityEvent.CLOSE_OUTERCITY_OUTERCITYBOSS_WND,this.hide,this);
        NotificationManager.Instance.addEventListener(OuterCityEvent.OUTER_CITY_GET_BOSSINFO,this.refreshView,this);
    }

    private removeEvent() {
        Utils.clearGListHandle(this.bossList);
        NotificationManager.Instance.removeEventListener(OuterCityEvent.CLOSE_OUTERCITY_OUTERCITYBOSS_WND,this.hide,this);
        NotificationManager.Instance.removeEventListener(OuterCityEvent.OUTER_CITY_GET_BOSSINFO,this.refreshView,this);
    }
