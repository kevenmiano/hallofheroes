...
export class RuneHoldRuneItem2 extends FUI_RuneHoldRuneItem2 {
    ...
    private setIcon(good: GoodsInfo) {
        ...
        this.runeIcon.url = IconFactory.getGoodsIconByTID(good.templateInfo.TemplateId);
        this.runeIcon.visible = true;
        this.levelTxt.text = LangManager.Instance.GetTranslation("public.level3", good.strengthenGrade);
    }
