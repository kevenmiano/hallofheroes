...
export default class SevenGoalsWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.descTxt1.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.descTxt1");
        this.descTxt2.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.descTxt2");
        this.descTxt3.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.descTxt3");
        this.limitTxt.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.limitTxt");
        this.progressValue.min = 0;
        this.sevenGoalsModel.currentSelectedDay = this.sevenGoalsModel.sevenCurrentDay;
    ...
    initEvent() {
        this.boxList.itemRenderer = Laya.Handler.create(this, this.renderBoxList, null, false);
        this.dayList.itemRenderer = Laya.Handler.create(this, this.renderDayList, null, false);
        this.tabList.itemRenderer = Laya.Handler.create(this, this.renderTabList, null, false);
        Utils.setDrawCallOptimize(this.taskList);
        this.taskList.itemRenderer = Laya.Handler.create(this, this.renderTaskList, null, false);
        this.taskList.setVirtual();
        this.dayList.on(fairygui.Events.CLICK_ITEM, this, this.__onDaySelectHandler);
        this.tabList.on(fairygui.Events.CLICK_ITEM, this, this.__onTabSelectHandler);
        NotificationManager.Instance.addEventListener(NotificationEvent.SEVEN_GOALS_TASK_UPDATE, this.updateView, this);
        NotificationManager.Instance.addEventListener(NotificationEvent.SEVEN_GOALS_TASKGET_UPDATE, this.updateView, this);
        NotificationManager.Instance.addEventListener(NotificationEvent.SEVEN_GOALS_REWARDSITE_UPDATE, this.updateBoxView, this);
        NotificationManager.Instance.addEventListener(NotificationEvent.SEVEN_GOALS_GIFTSITE_UPDATE, this.updateGiftView, this);
        NotificationManager.Instance.addEventListener(NotificationEvent.SEVEN_GOALS_REWARD_LOOK_UPDATE, this.updateRewardLook, this);
    ...
    removeEvent() {
        NotificationManager.Instance.removeEventListener(NotificationEvent.SEVEN_GOALS_TASK_UPDATE, this.updateView, this);
        NotificationManager.Instance.removeEventListener(NotificationEvent.SEVEN_GOALS_TASKGET_UPDATE, this.updateView, this);
        NotificationManager.Instance.removeEventListener(NotificationEvent.SEVEN_GOALS_REWARDSITE_UPDATE, this.updateBoxView, this);
        NotificationManager.Instance.removeEventListener(NotificationEvent.SEVEN_GOALS_GIFTSITE_UPDATE, this.updateGiftView, this);
        NotificationManager.Instance.removeEventListener(NotificationEvent.SEVEN_GOALS_REWARD_LOOK_UPDATE, this.updateRewardLook, this);
        this.dayList.off(fairygui.Events.CLICK_ITEM, this, this.__onDaySelectHandler);
    ...
    __onDaySelectHandler() {
        ...
        if (this.sevenGoalsModel.checkBagHasBuy(this.sevenGoalsModel.currentSelectedDay))//已经购买了
        {
    ...
    __onTabSelectHandler() {
        ...
        if (tabValue == 2) {
            ...
            let sevenGiftBagInfo: SevenGiftBagInfo = this.sevenGoalsModel.sevenGiftBagArr[dayValue];
    ...
    refreshView(dayIndex: number = 0, tabIndex: number = 0) {
        ...
        this.progressValue.value = ProgressHelp.getCurrentValue(this.sevenGoalsModel.starNum, this._maxIntegralValue, this._integralValueArr);
        ...
        if (tabIndex == 2) {//选中特惠礼包tab
            this.type.selectedIndex = 1;
            let sevenGiftBagInfo: SevenGiftBagInfo = this.sevenGoalsModel.sevenGiftBagArr[dayIndex];
            this.sevenGoalsBag.info = sevenGiftBagInfo;
        } else {
            this.type.selectedIndex = 0;
    ...
    private updateRewardLook() {
        ...
        if (currentProgress > this.sevenGoalsModel.sevenTreasureArr.length) {
            this.progressTxt.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.progressTxt1", this.sevenGoalsModel.sevenTreasureArr.length, this.sevenGoalsModel.sevenTreasureArr.length);
            this.descTxt3.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.descTxt4");
        }
        else {
            this.progressTxt.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.progressTxt2", currentProgress, this.sevenGoalsModel.sevenTreasureArr.length);
            this.descTxt3.text = LangManager.Instance.GetTranslation("SevenGoalsWnd.descTxt3");
        }
        ...
        if (lookInfo) {
            ...
            } else if (lookInfo.templateInfo.SonType == GoodsSonType.SONTYPE_MOUNT_CARD) {//坐骑卡
                this.isDiamond.selectedIndex = 1;
                let mountTemplate: t_s_mounttemplateData = TempleteManager.Instance.getMountTemplateById(lookInfo.templateInfo.Property1);
                if (mountTemplate) {
                    this.createAnimation(mountTemplate);
                }
            } else if (lookInfo.templateInfo.SonType == GoodsSonType.FASHION_WEAPON
    ...
    private updateGiftView() {
        let sevenGiftBagInfo: SevenGiftBagInfo = this.sevenGoalsModel.sevenGiftBagArr[this.dayList.selectedIndex];
        this.sevenGoalsBag.info = sevenGiftBagInfo;
        if (this.sevenGoalsModel.checkBagHasBuy(this.sevenGoalsModel.currentSelectedDay))//已经购买了
        {
            this.todayHasBuyCtr.selectedIndex = 1;
    ...
    private createAnimation(mountTemplate: t_s_mounttemplateData) {
        ...
        ResMgr.Instance.loadRes(avatarPath, (res) => {
            if (this.destroyed) {
                return;
            }
            ...
            AnimationManager.Instance.createAnimation(_preUrl, "", undefined, "", AnimationManager.MapPhysicsFormatLen);
