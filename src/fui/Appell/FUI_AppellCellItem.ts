...
export default class FUI_AppellCellItem extends fgui.GButton {
	...
	public static createInstance():FUI_AppellCellItem {
		return <FUI_AppellCellItem>(fgui.UIPackage.createObject("Appell", "AppellCellItem"));
	}
	...
	protected onConstruct():void {
		...
		this.appellDetailLeft = <FUI_AppellProItem>(this.getChild("appellDetailLeft"));
		this.appellDetailRight = <FUI_AppellProItem>(this.getChild("appellDetailRight"));
