...
export class RoleShowViewIII extends Laya.Sprite implements IEnterFrame {
    ...
    private createRightView() {
        ...
        if (this.needExchange) {
            this._bossView.bossBufferContainer1 = new BossBufferContainer(this._bossView, 2,this._boss2);
            this._bossView.bossBufferContainer2 = new BossBufferContainer(this._bossView, 1,this._boss1);
            this._bossView.setParent(this.view.getContentPane());
            this._bossView.setInfo(this._boss2, this._boss1);
            this._bossView.setTotalHp(this.battleModel.armyInfoRight.getBossesTotalHpByInfo(this._boss2), this.battleModel.armyInfoRight.getBossesTotalHpByInfo(this._boss1));
            this._bossView.setCurrentHp(this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss2), this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss1));
        }
        else {
            this._bossView.bossBufferContainer1 = new BossBufferContainer(this._bossView, 1,this._boss1);
            this._bossView.bossBufferContainer2 = new BossBufferContainer(this._bossView, 2,this._boss2);
            this._bossView.setParent(this.view.getContentPane());
            this._bossView.setInfo(this._boss1, this._boss2);
            this._bossView.setTotalHp(this.battleModel.armyInfoRight.getBossesTotalHpByInfo(this._boss1), this.battleModel.armyInfoRight.getBossesTotalHpByInfo(this._boss2));
            this._bossView.setCurrentHp(this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss1), this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss2));
        }
    }
    ...
    enterFrame() {
        ...
        if (this.view.bottomBar && this.view.bottomBar.selfBloodView) {
            this.view.bottomBar.selfBloodView.updateHeroHp(precent, leftBlood, maxBoold);
        }
        var bossHp1: number;
        var bossHp2: number;
        if (this.needExchange) {
            bossHp1 = this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss2);
            bossHp2 = this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss1);
        } else {
            bossHp1 = this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss1);
            bossHp2 = this.battleModel.armyInfoRight.getBossesLeftHpByInfo(this._boss2);
        }
    ...
    public get bossBufferContainer1(): BossBufferContainer {
        if (this._bossView)
            return this._bossView.bossBufferContainer1;
        return null;
    }

    public get bossBufferContainer2(): BossBufferContainer {
        if (this._bossView)
            return this._bossView.bossBufferContainer2;
        return null;
    }
    ...
    public dispose() {
        ...
        if (this._bossView) this._bossView.dispose(); this._bossView = null;
    }
}