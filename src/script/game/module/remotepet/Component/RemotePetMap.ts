...
export class RemotePetMap extends FUI_RemotePetMap {
    ...
    protected onConstruct(): void {
        ...
        this.fgoodsList.itemRenderer = Laya.Handler.create(this, this.onGoodsRenderer, null, false);
    }
    ...
    public setTurnInfo(v: RemotePetTurnItemInfo) {
        this.curTurnInfo = v;
        this.curLevelLab.setVar("level", this.curTurnInfo.tempInfo.IndexID + "").flushVars();
    ...
    private updateMap(index: number) {
        ...
        if (endIndex > remotePetTurnList.length) endIndex = remotePetTurnList.length;
    ...
    private onRewardTap() {
        ...
        FrameCtrlManager.Instance.open(EmWindow.DisplayItems, { itemInfos: _goodsList, title: LangManager.Instance.GetTranslation("remotepet.goodsTxt") })
    }
