...
export class CopyNodeDataHelper {
    ...
    public static cloneWildLandData(wildInfo: WildLand): WildLand {
        ...
        if (pInfo.types == OutCityNodeTypeConstant.TYPE_MINE) {//金矿节点
        ...
        if (wildInfo.ownSysArmy) {
            CopyNodeDataHelper.cloneHeroInfo(sysArmy.baseHero, wildInfo.ownSysArmy.baseHero);
    ...
    private static cloneHeroInfo(thane: ThaneInfo, pkgInfo: ThaneInfo): ThaneInfo {
        thane.beginChanges();
        ...
        thane.baseProperty.baseIntellectPoint = pkgInfo.baseProperty.baseIntellectPoint;
        thane.baseProperty.baseCaptainPoint = pkgInfo.baseProperty.baseCaptainPoint;
        thane.baseProperty.basePhysiquePoint = pkgInfo.baseProperty.basePhysiquePoint;
        //自由加点
        ...
        thane.baseProperty.addIntellectPoint = pkgInfo.baseProperty.addIntellectPoint;
        ...
        thane.attackProrerty.baseMagicAttack = pkgInfo.attackProrerty.baseMagicAttack;
        thane.attackProrerty.baseMagicDefence = pkgInfo.attackProrerty.baseMagicDefence;
        ...
        thane.attackProrerty.totalPhyDefence = pkgInfo.attackProrerty.totalPhyDefence;
        thane.attackProrerty.totalMagicAttack = pkgInfo.attackProrerty.totalMagicAttack;
        thane.attackProrerty.totalMagicDefence = pkgInfo.attackProrerty.totalMagicDefence;
