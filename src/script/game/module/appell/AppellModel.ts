...
export class AppellPowerInfo {
  ...
  public PowerName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip01",
  );
  public AgilityName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip02",
  );
  public IntellectName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip03",
  );
  public PhysiqueName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip04",
  );
  public CaptainName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip05",
  );
  public AttackName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip06",
  );
  public DefenceName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip07",
  );
  public MagicAttackName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip08",
  );
  public MagicDefenceName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip09",
  );
  public ForceHitName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip10",
  );
  public PenetrateName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip011",
  ); // 穿透
  public ParryName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip19",
  ); //格挡
  public LiveName: string = LangManager.Instance.GetTranslation(
    "armyII.ThaneAttributeView.Tip11",
  ); //生命
  public ConatName: string = LangManager.Instance.GetTranslation(
  ...
  public getAppellPowerInfo(list: t_s_appellData[] = null): AppellPowerInfo {
    ...
    list.forEach((ele: t_s_appellData) => {
      for (let index = 0; index < ele.Skills.length; index++) {
        ...
        let skillPropTmp = ConfigMgr.Instance.getTemplateByID(
