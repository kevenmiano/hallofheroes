...
export default class FreedomTeamSocketOutManager {
  ...
  public static sendApplyInvite(targetId: number, apply: boolean) {
    ...
    msg.param1 = targetId;
    msg.param7 = apply;
    FreedomTeamSocketOutManager.sendProtoBuffer(
      C2SProtocol.C_APPLY_INVITE_TEAM,
      msg,
    );
  }
  ...
  public static sendKickMember(targetId: number) {
    ...
    msg.param1 = targetId;
    FreedomTeamSocketOutManager.sendProtoBuffer(
      C2SProtocol.C_KICK_TEAM_MEMBER,
      msg,
    );
  }
  ...
  public static sendAFK() {
    FreedomTeamSocketOutManager.sendProtoBuffer(
      C2SProtocol.C_LEAVE_TEAM_FOR_NOW,
      null,
    );
  }
   ...
   *
   */
  public static sendEditTeamFightPos(
    isGet: boolean = true,
    list: Array<any> = null,
  ) {
    var msgList = [];
    ...
    FreedomTeamSocketOutManager.sendProtoBuffer(
      C2SProtocol.C_EDIT_TEAM_FIGHT_POS,
      msg,
    );
  }
