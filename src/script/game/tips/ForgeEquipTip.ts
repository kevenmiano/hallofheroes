...
export class ForgeEquipTip extends BaseTips {
    ...
    private initView() {
        ...
        this.btnLock.title = LangManager.Instance.GetTranslation(this.isLocked ? "public.unLock" : "public.lock")
        this.btnEquip.title = LangManager.Instance.GetTranslation(this.isEquiped ? "public.unEquip" : "public.putIn");
