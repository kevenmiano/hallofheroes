...
export class SkillData
{
    ...
    public get skillTemplate() {
        if (!this._skillTemplate || this._skillTemplate.TemplateId!=this.skillId) {
            this._skillTemplate = ConfigMgr.Instance.getTemplateByID( ConfigType.t_s_skilltemplate, this.skillId);
        }
