...
//   protoc               v3.21.12
// source: battle/CrossWarFieldUpdateMsg.proto
...
export interface CrossWarFieldUpdateMsg {
  userId: number;
  geste: number;
  type: number;
  item: number[];
...
function createBaseCrossWarFieldUpdateMsg(): CrossWarFieldUpdateMsg {
  return {
    userId: 0,
    geste: 0,
    type: 0,
...
export const CrossWarFieldUpdateMsg: MessageFns<CrossWarFieldUpdateMsg> = {
  encode(message: CrossWarFieldUpdateMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== 0) {
    ...
    if (message.crossScore !== 0) {
      writer.uint32(80).int32(message.crossScore);
    }
    if (message.serverId !== 0) {
      writer.uint32(88).int32(message.serverId);
    }
    if (message.serverName !== "") {
      writer.uint32(98).string(message.serverName);
    }
    if (message.port !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CrossWarFieldUpdateMsg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCrossWarFieldUpdateMsg();
  ...
  fromJSON(object: any): CrossWarFieldUpdateMsg {
    return {
  ...
  toJSON(message: CrossWarFieldUpdateMsg): unknown {
    const obj: any = {};
    if (message.userId !== 0) {
  ...
  create<I extends Exact<DeepPartial<CrossWarFieldUpdateMsg>, I>>(base?: I): CrossWarFieldUpdateMsg {
    return CrossWarFieldUpdateMsg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CrossWarFieldUpdateMsg>, I>>(object: I): CrossWarFieldUpdateMsg {
    const message = createBaseCrossWarFieldUpdateMsg();
