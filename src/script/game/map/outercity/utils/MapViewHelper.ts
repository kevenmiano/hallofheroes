...
export class MapViewHelper {
  ...
  public static mapMoveCheck(p: Point): Point {
    ...
    if (p.x > MapViewHelper.startX) {
      ...
      p.x <
      StageReferance.stageWidth - MapViewHelper.getMapTemplate.Width
    ) {
    ...
    if (p.y > MapViewHelper.startY) {
      ...
      p.y <
      StageReferance.stageHeight - MapViewHelper.getMapTemplate.Height
    ) {
  ...
  public static checkTargetPoint(p: Point): Point {
    ...
    if (
      p.y + StageReferance.stageHeight >
      MapViewHelper.getMapTemplate.Height
    ) {
