...
export default class FUI_DegreeActivityView extends fgui.GComponent {
  ...
  public static createInstance(): FUI_DegreeActivityView {
    return <FUI_DegreeActivityView>(
      fgui.UIPackage.createObject("Welfare", "DegreeActivityView")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.todayActivityTitle = <fgui.GTextField>(
      this.getChild("todayActivityTitle")
    );
    ...
    this.weekAcitivtyTitle = <fgui.GRichTextField>(
      this.getChild("weekAcitivtyTitle")
    );
