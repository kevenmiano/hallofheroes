...
import { HeroMovieClipRefType, SideType } from "../../../../constant/BattleDefine";
import { OuterCityEvent, SecretEvent } from "../../../../constant/event/NotificationEvent";
...
export class CampaignSingleBgWalkLayer extends CampaignWalkLayer {
    ...
    protected addEvent() {
        ...
        this._model.addEventListener(OuterCityEvent.ADD_GARRISON, this.__addBaseArmyHandler2, this);
        this._model.addEventListener(OuterCityEvent.REMOVE_ARMY, this.__removeBaseArmyHandler2, this);
        this._model.addEventListener(OuterCityEvent.UPDATE_SELF, this.__updateSelfHandler2, this);
        ...
        NotificationManager.Instance.on(SecretEvent.REMOVE_NPC, this.__removeNpc, this)
    }

    protected removeEvent() {
        this.removeRegisterList();
        this._model.removeEventListener(OuterCityEvent.ADD_GARRISON, this.__addBaseArmyHandler2, this);
        this._model.removeEventListener(OuterCityEvent.REMOVE_ARMY, this.__removeBaseArmyHandler2, this);
        this._model.removeEventListener(OuterCityEvent.UPDATE_SELF, this.__updateSelfHandler2, this);
        ...
        NotificationManager.Instance.off(SecretEvent.REMOVE_NPC, this.__removeNpc, this)
    }
    ...
    private __addNpc(data: GameLoadNeedData) {
        ...
        let armyView = new ShowAvatarBattle(HeroMovieClipRefType.SINGLEBG_CAMPAIGN_SCENE, false)
