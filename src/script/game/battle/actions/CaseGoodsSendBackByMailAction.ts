...
export class CaseGoodsSendBackByMailAction extends MapBaseAction
{
    ...
    private get msg():string
    {
        ...
        return LangManager.Instance.GetTranslation("yishi.actions.consortia.CaseGoodsSendBackByMailAction.sendBack") +
            (currentDate.getMonth() + 1) + LangManager.Instance.GetTranslation("public.month") +
            currentDate.getDate() + LangManager.Instance.GetTranslation("public.daily") + "—" +
            (targetDate.getMonth() + 1) + LangManager.Instance.GetTranslation("public.month") +
            targetDate.getDate() + LangManager.Instance.GetTranslation("public.daily");
    }
