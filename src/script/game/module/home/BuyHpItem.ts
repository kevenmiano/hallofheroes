...
export default class BuyHpItem extends FUI_BuyHpItem {
    ...
    private refreshView() {
        ...
        try {
            ...
            this.txt_own.text = LangManager.Instance.GetTranslation("BuyHpItem.txtOwn.text") + GoodsManager.Instance.getGoodsNumByTempId(this._vData.ItemId);
        } catch (error) {
    ...
    private confirmHandler() {
        ...
        if (this.payMoney(this._vData) < this._vData.price) {
            if (this._vData.PayType == ShopGoodsInfo.PAY_BY_POINT) {
                ...
                MessageTipManager.Instance.show(LangManager.Instance.GetTranslation("shop.view.frame.BuyFrameI.CashGiftLack"));
                // RechargeAlertMannager.Instance.show();
            }
    ...
    private payMoney(value: ShopGoodsInfo): number {
        if (value.PayType == ShopGoodsInfo.PAY_BY_POINT)
            ...
            return PlayerManager.Instance.currentPlayerModel.playerInfo.giftToken + PlayerManager.Instance.currentPlayerModel.playerInfo.point;
            ...
            return PlayerManager.Instance.currentPlayerModel.playerInfo.consortiaOffer;
