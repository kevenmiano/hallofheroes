...
export default class CasernWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.frame.getChild('title').text = LangManager.Instance.GetTranslation("CasernWnd.titleTxt");
        this.n8.text = LangManager.Instance.GetTranslation("CasernWnd.needResourceTxt");
        this.n11.text = LangManager.Instance.GetTranslation("CasernWnd.needTimeTxt");
        this.pawnlist.setVirtual();
        this.pawnlist.itemRenderer = Laya.Handler.create(this, this.renderItem, null, false);
        ...
        let state = PlayerManager.Instance.currentPlayerModel.playerInfo.autoRecruit;
    ...
    private addEvent() {
        ...
        ArmyManager.Instance.army.addEventListener(ArmyEvent.ARMY_INFO_CHANGE, this.__pawnChangeHandler, this);
    ...
    private removeEvent() {
        ...
        this.pawnlist.itemRenderer.recover();
        ...
        ArmyManager.Instance.army.removeEventListener(ArmyEvent.ARMY_INFO_CHANGE, this.__pawnChangeHandler, this);
    ...
    private onAutoHelp() {
        let title: string = LangManager.Instance.GetTranslation("buildings.casern.view.casern.autoHelpTitle");
        let content: string = LangManager.Instance.GetTranslation("buildings.casern.view.casern.autoHelp");
    ...
    private refreshView() {
        ...
        this.pawnLevelTxt.text = LangManager.Instance.GetTranslation("CasernWnd.pawnLevelTxt", this._data.templeteInfo.BuildingGrade);
        if (nextTemp) {
            this.needGoldTxt.text = this._data.getNextNeedResource(nextTemp)['GoldConsume'].toString();
            ...
            this.maxLevelTxt.text = LangManager.Instance.GetTranslation("buildings.BaseBuildFrame.maxGrade");
