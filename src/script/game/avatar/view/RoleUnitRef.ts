...
export class RoleUnitRef extends Laya.Sprite {
    ...
    protected addEvent() {
        NotificationManager.Instance.addEventListener(RoleUnitRef.LOAD_RES_COMPLETE, this.__loadResComplete, this);
    }

    protected removeEvent() {
        NotificationManager.Instance.removeEventListener(RoleUnitRef.LOAD_RES_COMPLETE, this.__loadResComplete, this);
    }
    ...
    public set data(val: any) {
        ...
        if (this.externalTriggerLoad) {
            ...
            this._data = val;
            ResRefCountManager.loadRes(this._data.urlPath, (res) => {
                this.loadResComplete();
