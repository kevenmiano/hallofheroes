...
*/
export default class GeniusItem extends FUI_GeniusItem implements ITipedDisplay{
    ...
    private refreshView() {
        ...
        this.level.text = LangManager.Instance.GetTranslation("public.level3", this._itemdata.grade);
