...
import {
    ...
    CampaignMapEvent,
    ChatEvent,
    NotificationEvent, PvpWarFightEvent, SLGSocketEvent,
...
export default class CampaignSocketManger {
    ...
    public setup(isProxy: boolean = false) {
        ...
        if (isProxy) {
            ...
            SocketDataProxyManager.Instance.model.addEventListener(SocketDataProxyEventEvent.READ_SOCKET_DATA_OVEW, this.__readOverHandler, this);
            SocketDataProxyManager.Instance.readSocketDataByType(SceneType.CAMPAIGN_MAP_SCENE);
        }
        else {
            this.removeSocketEvent(SocketDataProxyManager.Instance.model);
            this.addSocketEvent(ServerDataManager.Instance);
        }
        NotificationManager.Instance.on(CampaignEvent.CAMPAIGN_OVER, this.__campaignOverHandler, this);
    }
    ...
    private __readOverHandler(data: string) {
        ...
        this.removeSocketEvent(SocketDataProxyManager.Instance.model);
        this.addSocketEvent(ServerDataManager.Instance);
        SocketDataProxyManager.Instance.model.removeEventListener(SocketDataProxyEventEvent.READ_SOCKET_DATA_OVEW, this.__readOverHandler, this);
    }
    ...
    private __campaignOverHandler(data: any) {
        ...
        this.removeSocketEvent(ServerDataManager.Instance);
        this.removeSocketEvent(SocketDataProxyManager.Instance.model);
        NotificationManager.Instance.removeEventListener(CampaignEvent.CAMPAIGN_OVER, this.__campaignOverHandler, this);
    }

    private addSocketEvent(dispatch: GameEventDispatcher) {
        Logger.info("addSocketEvent", dispatch);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_NODE, this.__campaignDataHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_FOG, this.__campaignFogHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_LEFT_WEARY, this.__hookTimeHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_NODE_ADD, this.__campaignNodeAddHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_NPC_MOVE, this.__npcMoveHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_NODE_UPDATE, this.__updateCampaignNodeHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_ARMY_UPDATE, this.__updateCampaignArmyHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_REPORT, this.__campaignResultHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_FINISH, this.__campaignFinishInfoHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_ARMY_UPDATE, this.__campaingArmyInfoHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_LOGIN_IN, this.__campaignLoginInHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_LOGIN_OUT, this.__campaingLoginOutHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_EXIT, this.__exitCampaignSceneHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMERA_MOVE, this.__campaignSceneMoveHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_NODE_SUCCESS, this.__attackNodeHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_FOG_UPDATE, this.__updateFogHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_BOSS_ARMY_LIST, this.__campaignBossArmyListHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPAIGN_BOSS_ARMY_INVITE, this.__campaignBossArmyInviteHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_ESCORT_NPC_FOLLOW, this.__followNpcHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_SEND_STANDPOS, this.__standPosHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_SYNC_BOSS_HP, this.__syncBossHpHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_PLAYER_DIE_STATE, this.__playerDieStateHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_MULTI_HPSYNC, this.__multiHpsyncHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_ARMY_POS_UPDATE, this.__updateArmyPosHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_ARMYPOS_BROAD, this.__armyPosBroadHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_ALTARNPC_MOVE, this.__altarNpcMoveHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_PLAYER_HANGUPSTATE, this.__playerHangupstateHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_NODE_HP, this.__nodeHpHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CAMPIAGN_OPEN_MV, this.__campiagnOpenMv, this);
        dispatch.addEventListener(S2CProtocol.U_BATTLE_REPORT, this.__battleInfoResultHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_NPC_LOCK, this.__lockNpcHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CROSS_ARMY_UPDATE, this.__crossArmyUpdateHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_NODEPOS_REFERSH, this.__nodePosRefershHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_BROADBUFFER, this.__broadBufferHandler, this);
        dispatch.addEventListener(SLGSocketEvent.U_PLAY_MOVIE, this.__playMovieHandler, this);

        NotificationManager.Instance.on(NotificationEvent.BATTLE_RESULT, this.__battleResultHandler, this);
        NotificationManager.Instance.on(NotificationEvent.UPDTAE_ARMY, this.__updateArmyHandler, this);
        NotificationManager.Instance.on(NotificationEvent.ROOM_KILL_OUT, this.__roomKillOutHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_WARFIELD_INFO, this.__warfieldInfoHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_WARREPORT, this.__warreportHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_ORDERREQUEST, this.__orderrequestHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_TIME_JUDGE, this.__timeJudgeHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_GUILDWAR_SCORE, this.__guildWarScoreHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_GUILDWAR_BUFFER, this.__guildWarBufferHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_GUILDWAR_OPEN_LEFTTIME, this.__guildWarOpenLeftTimeHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_GUILDWAR_JOIN_PLAYER_COUNT, this.__guildWarJoinPlayerCount, this);
        dispatch.addEventListener(S2CProtocol.U_C_GUILDWAR_WOUND, this.__gvgWoundListHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_TOWER_DIED, this.__towerDiedHandler, this);
        dispatch.addEventListener(S2CProtocol.U_HERO_TRIAL_IFNO, this.__trailPropInfoHandler, this);
        NotificationManager.Instance.on(ChatEvent.UPDATE_CHAT_VIEW, this.__playerChatHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_SYNC_MINE_TRAMCAR, this.__mineralHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CONSORTIA_BOSS_SYNC_HP, this.__consortiaBossHpHandler, this);
        dispatch.addEventListener(S2CProtocol.U_C_CONSORTIA_BOSS_STATE, this.__consortiaBossStateUpdateHandler, this);
    }

    private removeSocketEvent(dispatch: GameEventDispatcher) {
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_NODE, this.__campaignDataHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_FOG, this.__campaignFogHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_LEFT_WEARY, this.__hookTimeHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_NODE_ADD, this.__campaignNodeAddHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_NPC_MOVE, this.__npcMoveHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_NODE_UPDATE, this.__updateCampaignNodeHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_ARMY_UPDATE, this.__updateCampaignArmyHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_REPORT, this.__campaignResultHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_FINISH, this.__campaignFinishInfoHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_ARMY_UPDATE, this.__campaingArmyInfoHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_LOGIN_IN, this.__campaignLoginInHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_LOGIN_OUT, this.__campaingLoginOutHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_EXIT, this.__exitCampaignSceneHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMERA_MOVE, this.__campaignSceneMoveHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_NODE_SUCCESS, this.__attackNodeHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_FOG_UPDATE, this.__updateFogHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_BOSS_ARMY_LIST, this.__campaignBossArmyListHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPAIGN_BOSS_ARMY_INVITE, this.__campaignBossArmyInviteHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_ESCORT_NPC_FOLLOW, this.__followNpcHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_SEND_STANDPOS, this.__standPosHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_SYNC_BOSS_HP, this.__syncBossHpHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_PLAYER_DIE_STATE, this.__playerDieStateHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_MULTI_HPSYNC, this.__multiHpsyncHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_ARMY_POS_UPDATE, this.__updateArmyPosHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_ARMYPOS_BROAD, this.__armyPosBroadHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_ALTARNPC_MOVE, this.__altarNpcMoveHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_PLAYER_HANGUPSTATE, this.__playerHangupstateHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_NODE_HP, this.__nodeHpHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CAMPIAGN_OPEN_MV, this.__campiagnOpenMv, this);
        dispatch.removeEventListener(S2CProtocol.U_BATTLE_REPORT, this.__battleInfoResultHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_NPC_LOCK, this.__lockNpcHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CROSS_ARMY_UPDATE, this.__crossArmyUpdateHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_NODEPOS_REFERSH, this.__nodePosRefershHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_BROADBUFFER, this.__broadBufferHandler, this);
        dispatch.removeEventListener(SLGSocketEvent.U_PLAY_MOVIE, this.__playMovieHandler, this);

        NotificationManager.Instance.off(NotificationEvent.BATTLE_RESULT, this.__battleResultHandler, this);
        NotificationManager.Instance.off(NotificationEvent.UPDTAE_ARMY, this.__updateArmyHandler, this);
        NotificationManager.Instance.off(NotificationEvent.ROOM_KILL_OUT, this.__roomKillOutHandler, this);

        dispatch.removeEventListener(S2CProtocol.U_C_WARFIELD_INFO, this.__warfieldInfoHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_WARREPORT, this.__warreportHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_ORDERREQUEST, this.__orderrequestHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_TIME_JUDGE, this.__timeJudgeHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_GUILDWAR_SCORE, this.__guildWarScoreHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_GUILDWAR_BUFFER, this.__guildWarBufferHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_GUILDWAR_OPEN_LEFTTIME, this.__guildWarOpenLeftTimeHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_GUILDWAR_JOIN_PLAYER_COUNT, this.__guildWarJoinPlayerCount, this);
        dispatch.removeEventListener(S2CProtocol.U_C_GUILDWAR_WOUND, this.__gvgWoundListHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_TOWER_DIED, this.__towerDiedHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_HERO_TRIAL_IFNO, this.__trailPropInfoHandler, this);
        NotificationManager.Instance.off(ChatEvent.UPDATE_CHAT_VIEW, this.__playerChatHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_SYNC_MINE_TRAMCAR, this.__mineralHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CONSORTIA_BOSS_SYNC_HP, this.__consortiaBossHpHandler, this);
        dispatch.removeEventListener(S2CProtocol.U_C_CONSORTIA_BOSS_STATE, this.__consortiaBossStateUpdateHandler, this);
    }
     ...
     * 4.部队信息（获取房间成员与战役部队）
     */
    private __campaignDataHandler(pkg: PackageIn) {//节点数据
    ...
    private readNodeInfo($node: CampaignNodeMsg, isAdd: boolean = false): CampaignNode {
    ...
    private __updateFogHandler(pkg: PackageIn) {
        let col: number = Math.ceil(this.mapModel.mapTempInfo.Width / CampaignSocketManger.fogViewUnitWidth);
    ...
    private __attackNodeHandler(pkg: PackageIn) {
        ...
        Logger.xjy("[CampaignSocketManger __attackNodeHandler]下一个攻击点nodeId==", msg.nodeId);
        msg = null;
        pkg = null;
    }
    ...
    private __campaignSceneMoveHandler(pkg: PackageIn) {
        ...
        SocketSceneBufferManager.Instance.addPkgToBuffer(pkg, msg.scene, this.addQueue.bind(this));
        msg = null;
    }
    ...
    private __towerDiedHandler(pkg: PackageIn) {//地下迷宫死亡,引导复活
        SocketSceneBufferManager.Instance.addPkgToBuffer(pkg, SceneType.CAMPAIGN_MAP_SCENE, this.riverTower.bind(this));
    }
    ...
    private riverTower(pkg: PackageIn) {
        ...
        NotificationManager.Instance.dispatchEvent(CampaignMapEvent.MAZE_DIE, parseInt(msg.msg));
    }
    ...
    private updatePlayerArmyInfo(msg: CrossArmyMsg) {
        ...
        let army: CampaignArmy = this.mapModel.getBaseArmyByArmyId(msg.armyId, serverName);
        if (!army) {
            isSysArmy = true;
        ...
        if (isSysArmy) {
            NotificationManager.Instance.dispatchEvent(CampaignEvent.SYS_ARMY_UPDATE, army);
        }
    ...
    private __campaignLoginInHandler(pkg: PackageIn) {
        ...
        let armyInfo: CampaignArmy = this.mapModel.getBaseArmyByUserId(msg.playerId, msg.serverName);
        if (armyInfo) {
            armyInfo.online = true;
        }
        NotificationManager.Instance.dispatchEvent(NotificationEvent.UPDATE_TEAM_ONLINE_STATUS);
        msg = null;
    }
    ...
    private __campaingLoginOutHandler(pkg: PackageIn) {
        let msg = pkg.readBody(CampaignLoginMsg) as CampaignLoginMsg;
        let army: CampaignArmy = this.mapModel.getBaseArmyByUserId(msg.playerId, msg.serverName);
        if (army) {
            army.online = false;
        }
        NotificationManager.Instance.dispatchEvent(NotificationEvent.UPDATE_TEAM_ONLINE_STATUS);
    ...
    private __campaingArmyInfoHandler(pkg: PackageIn) {
        ...
        if (msg.simpleHeroInfo) {
            ...
            ThaneInfoHelper.readHeroInfo(army.baseHero, msg.simpleHeroInfo as SimpleHeroInfoMsg);
        }

        for (let k: number = 0; k < msg.armyPawn.length; k++) {
            SocketGameReader.readArmyPawnInfo(army, msg.armyPawn[k] as ArmyPawnInfoMsg);
        }
    ...
    private __npcMoveHandler(pkg: PackageIn) {
        ...
        if (node && SceneManager.Instance.currentType != SceneType.CAMPAIGN_MAP_SCENE) {//如果不在副本场景, 直接更新节点坐标信息（如在副本进入战斗中收到此协议）
            node.curPosX = msg.curPosX;
            node.curPosY = msg.curPosY;
        }
        if (node && node.info.types == PosType.BOMBER_MAN) {
            SocketSceneBufferManager.Instance.addPkgToBuffer(pkg, SceneType.CAMPAIGN_MAP_SCENE, this.npcMove.bind(this));
        }
        else {
    ...
    private __updateCampaignNodeHandler(pkg: PackageIn) {
        ...
        if (node) {
            ...
            if(node.info.types == CampaignNodeType.WORLD_BOSS_NOT_PASS && this.mapModel.campaignTemplate.Types == 1){
                if(node.info.state == NodeState.DESTROYED){
                    NotificationManager.Instance.dispatchEvent(WorldBossEvent.UPDATE_WORLDBOSS_NODE_STATE);
                }
            }
    ...
    private __exitCampaignSceneHandler(pkg: PackageIn) {
        ...
        if (msg.result > 0) {
            ...
            if (this.isSelf(userId, msg.serverName)) {
                ...
                NotificationManager.Instance.dispatchEvent(NotificationEvent.CROSS_ADD_GOONBTN);//跨副本自己退出
                this.exitBack();
            }
            else {
                if (this.mapModel) {
                    this.mapModel.removeBaseArmyByArmyId(armyId, msg.serverName);
                    if (this.roomInfo) this.roomInfo.removePlayerByUserId(userId, msg.serverName);
                }
                if (this.roomInfo) {
    ...
    private isSelf(userId: number, serverName: string): boolean {
        if (this.mapModel && this.mapModel.isCross) {
            return (userId == this.selfPlayerInfo.userId && serverName == this.selfPlayerInfo.serviceName);
        }
        else {
    ...
    private __campaignBossArmyInviteHandler(pkg: PackageIn) {
        ...
        this.mapModel.inviteAttackBoos(msg.nickName, boss, msg.leftFightTime, new Laya.Point(msg.posX, msg.posY));
        msg = null;
        pkg = null;
    }
    ...
    private __playerChatHandler(evtData) {
        ...
        var aInfo: CampaignArmy = this.mapModel.getUserArmyByUserId(chatData.uid, chatData.serverName);
    ...
    private __standPosHandler(pkg: PackageIn) {
        ...
        let army: CampaignArmy = this.mapModel.getBaseArmyByArmyId(msg.id, msg.serverName);
    ...
    private __syncBossHpHandler(pkg: PackageIn) {
        ...
        Logger.xjy("[CampaignSocketManger]__syncBossHpHandler", msg.curHp, msg.totalHp)
        ...
        this.worldBossModel.selfWoundInfo.nickName = PlayerManager.Instance.currentPlayerModel.playerInfo.nickName;
        this.worldBossModel.selfWoundInfo.job = PlayerManager.Instance.currentPlayerModel.playerInfo.job;
        ...
        for (let i: number = 0; i < msg.woundInfo.length; i++) {
            ...
            let wound: WoundInfo = this.worldBossModel.getWoundInfoByNickname(temp.nickName);
            if (!wound) {
    ...
    private __playerDieStateHandler(pkg: PackageIn) {
        ...
        for (const key in msg.playerState) {
            let pInfo: WorldBossPlayerStateMsg = msg.playerState[key] as WorldBossPlayerStateMsg;
            let bNode: CampaignArmy = this.mapModel.getBaseArmyByArmyId(pInfo.armyId, pInfo.serverName);
            if (bNode) {
    ...
    private __multiHpsyncHandler(pkg: PackageIn) {
        ...
        for (const key in msg.playerHp) {
            let pMsg: MultiPlayerHpSyncMsg = msg.playerHp[key] as MultiPlayerHpSyncMsg;
    ...
    private __playerHangupstateHandler(pkg: PackageIn) {
        let msg = pkg.readBody(PlayerHangupStateListMsg) as PlayerHangupStateListMsg;
    ...
    private __updateArmyHandler(data: any) {
        ...
        let aInfo: CampaignArmy = this.roomInfo.getPlayerByUserId(bArmy.userId, bArmy.baseHero.serviceName);
    ...
    private __broadBufferHandler(pkg: PackageIn) {
        ...
        for (const key in msg.armyBuffer) {
            ...
            let aInfo: CampaignArmy = this.mapModel.getBaseArmyByUserId(aBuffer.userId);
    ...
    private __altarNpcMoveHandler(pkg: PackageIn) {
        SocketSceneBufferManager.Instance.addPkgToBuffer(pkg, SceneType.CAMPAIGN_MAP_SCENE, this.moveNpc.bind(this));
    }
    ...
    private moveNpc(pkg: PackageIn) {
        ...
        let msgList = pkg.readBody(CampaignNpcMoveListMsg) as CampaignNpcMoveListMsg;
        for (const key in msgList.campaignNpcMove) {
            let msg: CampaignNpcMoveMsg = msgList.campaignNpcMove[key] as CampaignNpcMoveMsg;
            let node: CampaignNode = this.mapModel.getMapNodesById(msg.nodeId);
            if (node && node.info && node.nodeView) {
                node.uid = msg.uuId;
                let sysTime: Date = PlayerManager.Instance.currentPlayerModel.sysCurtime;
                let showTime: Date = DateFormatter.parse(msg.showTime, "YYYY-MM-DD hh:mm:ss");
                ...
                if (msg.centerX > 0 && msg.centerY > 0) {
                    paths = CampaignManager.Instance.controller.findPath.find(new Laya.Point(msg.startX, msg.startY), new Laya.Point(msg.centerX, msg.centerY));
                    paths = paths.concat(CampaignManager.Instance.controller.findPath.find(new Laya.Point(msg.centerX, msg.centerY - 1), new Laya.Point(msg.endX, msg.endY)));
                }
                else {
                    paths = CampaignManager.Instance.controller.findPath.find(new Laya.Point(msg.startX, msg.startY), new Laya.Point(msg.endX, msg.endY));
                }
    ...
    private __nodePosRefershHandler(pkg: PackageIn) {
        let msg = pkg.readBody(CampaignNodePosRefershListMsg) as CampaignNodePosRefershListMsg;
        for (const key in msg.node) {
            let item: CampaignNodePosRefershMsg = msg.node[key] as CampaignNodePosRefershMsg;
    ...
    private __consortiaBossHpHandler(pkg: PackageIn) {
        let msg: WorldBossInfoMsg = pkg.readBody(WorldBossInfoMsg) as WorldBossInfoMsg;
        if (!WorldBossHelper.checkConsortiaBoss(this.mapModel.mapId)) return;
        Logger.xjy("CampaignSocketManger consortiaBossHpHandler curHp==", msg.curHp);
        Logger.xjy("CampaignSocketManger consortiaBossHpHandler totalHp==", msg.totalHp);
    ...
    private __consortiaBossStateUpdateHandler(pkg: PackageIn) {
        let msg: ConsortiaBossStateMsg = pkg.readBody(ConsortiaBossStateMsg) as ConsortiaBossStateMsg;
        let bossInfo: ConsortiaBossInfo = ConsortiaManager.Instance.model.bossInfo;
        bossInfo.taskProcessArr = [msg.missionAProcess, msg.missionBProcess, msg.missionCProcess];
        bossInfo.taskSkillIdProcessArr = [msg.missionASkillId, msg.missionBSkillId, msg.missionCSkillId];
        for (let i: number = 0; i < msg.playerList.length; i++) {
            let bossPlayerMsg: ConsortiaBossPlayerMsg = msg.playerList[i] as ConsortiaBossPlayerMsg;
            var bossUserInfo: ConsortiaBossUserInfo = bossInfo.getBossUserInfoByUserId(bossPlayerMsg.userid);
            if (!bossUserInfo) {
        ...
        NotificationManager.Instance.dispatchEvent(NotificationEvent.CONSORTIA_BOSS_STATE_UPDATE);
    }
    ...
    private __battleInfoResultHandler(pkg: PackageIn) {
        ...
        if (goods.length > 0 && this.mapModel) {
            ...
            info.signId = _signId;
            info.names = LangManager.Instance.GetTranslation("battle.handler.BattleResultHandler.name");
    ...
    private __warreportHandler(pkg: PackageIn) {
        ...
        SocketSceneBufferManager.Instance.addPkgToBuffer(pkg, rtnScene, this.__warReportCall.bind(this));
    }
    ...
    private __orderrequestHandler(pkg: PackageIn) {
        ...
        NotificationManager.Instance.dispatchEvent(PvpWarFightEvent.PVP_WAR_FIGHT_ORDER_REPORT, { list: arr, report: null });
    }
    ...
    private __guildWarScoreHandler(pkg: PackageIn) {
        let msg: GuildWarInfoListMsg = pkg.readBody(GuildWarInfoListMsg) as GuildWarInfoListMsg;
        for (let i = 0, len = msg.guildWarInfos.length; i < len; i++) {
            const info: GuildWarInfoMsg = msg.guildWarInfos[i] as GuildWarInfoMsg;
            if (info.consortiaId == PlayerManager.Instance.currentPlayerModel.playerInfo.consortiaID) {
    ...
    private __guildWarBufferHandler(pkg: PackageIn) {
        let msg: GuildBufferListMsg = pkg.readBody(GuildBufferListMsg) as GuildBufferListMsg;
        for (let i = 0, len = msg.buffers.length; i < len; i++) {
            const gmsg: GuildBufferMsg = msg.buffers[i] as GuildBufferMsg;
            let g: GvgWarBufferInfo = this.gvgModel.getGvgBufferByTemplateId(gmsg.templateId);
    ...
    private __guildWarOpenLeftTimeHandler(pkg: PackageIn) {
        SocketSceneBufferManager.Instance.addPkgToBuffer(pkg, SceneType.CAMPAIGN_MAP_SCENE, this.guildWarOpenLeftTime.bind(this));
    }
    ...
    private __gvgWoundListHandler(pkg: PackageIn) {
        ...
        info.list = ArrayUtils.sortOn(info.list, "contribution", ArrayConstant.DESCENDING | ArrayConstant.NUMERIC);
    ...
    private __warReportCall(pkg: PackageIn) {
        ...
        NotificationManager.Instance.dispatchEvent(PvpWarFightEvent.PVP_WAR_FIGHT_ORDER_REPORT, { list: arr, report: report });
    }
