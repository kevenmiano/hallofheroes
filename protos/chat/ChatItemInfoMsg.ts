...
//   protoc               v3.21.12
// source: chat/ChatItemInfoMsg.proto
...
export interface ChatItemInfoMsg {
  id: number;
  templateId: number;
  pos: number;
  exist: boolean;
...
function createBaseChatItemInfoMsg(): ChatItemInfoMsg {
  return {
    id: 0,
    templateId: 0,
    pos: 0,
...
export const ChatItemInfoMsg: MessageFns<ChatItemInfoMsg> = {
  encode(message: ChatItemInfoMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
    ...
    if (message.randomSkill1 !== 0) {
      writer.uint32(168).int32(message.randomSkill1);
    }
    if (message.randomSkill2 !== 0) {
      writer.uint32(176).int32(message.randomSkill2);
    }
    if (message.randomSkill3 !== 0) {
      writer.uint32(184).int32(message.randomSkill3);
    }
    if (message.randomSkill4 !== 0) {
      writer.uint32(192).int32(message.randomSkill4);
    }
    if (message.randomSkill5 !== 0) {
      writer.uint32(200).int32(message.randomSkill5);
    }
    if (message.isNew !== false) {
      writer.uint32(208).bool(message.isNew);
    }
    if (message.userId !== 0) {
      writer.uint32(216).int32(message.userId);
    }
    if (message.itemName !== "") {
      writer.uint32(226).string(message.itemName);
    }
    if (message.join4 !== 0) {
      writer.uint32(232).int32(message.join4);
    }
    if (message.property1 !== "") {
      writer.uint32(242).string(message.property1);
    }
    if (message.appraisalSkill !== 0) {
      writer.uint32(248).int32(message.appraisalSkill);
    }
    if (message.mouldGrade !== 0) {
      writer.uint32(256).int32(message.mouldGrade);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ChatItemInfoMsg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseChatItemInfoMsg();
  ...
  fromJSON(object: any): ChatItemInfoMsg {
    return {
  ...
  toJSON(message: ChatItemInfoMsg): unknown {
    const obj: any = {};
    if (message.id !== 0) {
  ...
  create<I extends Exact<DeepPartial<ChatItemInfoMsg>, I>>(base?: I): ChatItemInfoMsg {
    return ChatItemInfoMsg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ChatItemInfoMsg>, I>>(object: I): ChatItemInfoMsg {
    const message = createBaseChatItemInfoMsg();
