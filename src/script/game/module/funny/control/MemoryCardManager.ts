...
export class MemoryCardManager extends GameEventDispatcher {
  ...
  public static get Instance(): MemoryCardManager {
    if (!MemoryCardManager._instance)
      MemoryCardManager._instance = new MemoryCardManager();
  ...
  private initEvent() {
    ServerDataManager.listen(
      S2CProtocol.U_C_NEW_MEMORY_CARD_STATE,
      this,
      this.__memoryCardOpenState,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_NEW_MEMORY_CARD_DATA,
      this,
      this.__memoryCardData,
    );
  }
