...
export default class FUI_AccountCom extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.txt_dragonCrystal = <fgui.GTextField>(this.getChild("txt_dragonCrystal"));
		this.tipItem4 = <FUI_BaseTipItem>(this.getChild("tipItem4"));
		this.txt_petGrowthStone = <fgui.GTextField>(this.getChild("txt_petGrowthStone"));
		this.tipItem5 = <FUI_BaseTipItem>(this.getChild("tipItem5"));
		this.petGrowthStone_buy = <FUI_CommonBtn>(this.getChild("petGrowthStone_buy"));
		this.txt_petCoeStone = <fgui.GTextField>(this.getChild("txt_petCoeStone"));
		this.tipItem6 = <FUI_BaseTipItem>(this.getChild("tipItem6"));
		this.txt_petEquipStrengStone = <fgui.GTextField>(this.getChild("txt_petEquipStrengStone"));
		...
		this.txt_dragonCrystal2 = <fgui.GTextField>(this.getChild("txt_dragonCrystal2"));
		this.tipItem14 = <FUI_BaseTipItem>(this.getChild("tipItem14"));
		this.txt_consortiajianse = <fgui.GTextField>(this.getChild("txt_consortiajianse"));
