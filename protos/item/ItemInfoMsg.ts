...
function createBaseItemInfoMsg(): ItemInfoMsg {
  return {
    id: 0,
    templateId: 0,
    pos: 0,
...
export const ItemInfoMsg: MessageFns<ItemInfoMsg> = {
  encode(message: ItemInfoMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
    ...
    if (message.property1 !== "") {
      writer.uint32(234).string(message.property1);
    }
    if (message.strength !== 0) {
      writer.uint32(240).int32(message.strength);
    }
    if (message.tenacity !== 0) {
      writer.uint32(248).int32(message.tenacity);
    }
    if (message.appraisalSkill !== 0) {
      writer.uint32(256).int32(message.appraisalSkill);
    }
    if (message.isLocked !== false) {
      writer.uint32(264).bool(message.isLocked);
    }
    if (message.gp !== 0) {
      writer.uint32(272).int32(message.gp);
    }
    if (message.star !== 0) {
      writer.uint32(280).int32(message.star);
    }
    if (message.masterAttr !== "") {
      writer.uint32(290).string(message.masterAttr);
    }
    if (message.sonAttr !== "") {
      writer.uint32(298).string(message.sonAttr);
    }
    if (message.suitId !== 0) {
      writer.uint32(304).int32(message.suitId);
    }
    if (message.mouldGrade !== 0) {
      writer.uint32(312).int32(message.mouldGrade);
    }
    if (message.blessValue !== 0) {
      writer.uint32(320).int32(message.blessValue);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ItemInfoMsg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseItemInfoMsg();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 40: {
          ...
          message.blessValue = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ItemInfoMsg {
    return {
      ...
      blessValue: isSet(object.blessValue) ? globalThis.Number(object.blessValue) : 0,
    };
  },

  toJSON(message: ItemInfoMsg): unknown {
    const obj: any = {};
    if (message.id !== 0) {
    ...
    if (message.blessValue !== 0) {
      obj.blessValue = Math.round(message.blessValue);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ItemInfoMsg>, I>>(base?: I): ItemInfoMsg {
    return ItemInfoMsg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ItemInfoMsg>, I>>(object: I): ItemInfoMsg {
    const message = createBaseItemInfoMsg();
    ...
    message.blessValue = object.blessValue ?? 0;
    return message;
  },
};
