...
export class SingWarSocketSendManager {
  ...
  public static enterWarfield(mapId: number) {
    ...
    var msg: com.road.yishi.proto.worldmap.WorldBossMsg =
      //@ts-expect-error: External dependencies
      new com.road.yishi.proto.worldmap.WorldBossMsg();
    msg.param1 = mapId;
  ...
  public static sendRequestPvpRemainNumber(campaignId: number) {
    ...
    SingWarSocketSendManager._enterTime = new Date().getTime();
    //@ts-expect-error: External dependencies
    var msg: com.road.yishi.proto.campaign.CampaignReqMsg =
      //@ts-expect-error: External dependencies
      new com.road.yishi.proto.campaign.CampaignReqMsg();
   ...
   *
   */
  public static sendStartCampaignScene(
    campaignId: number = 0,
    capicity: number = 0,
    ...
    var msg: com.road.yishi.proto.campaign.CampaignReqMsg =
      //@ts-expect-error: External dependencies
      new com.road.yishi.proto.campaign.CampaignReqMsg();
    if (capicity == 1) msg.paraInt1 = capicity;
