...
export class ResourceManager {
  ...
  private addEvent() {
    ServerDataManager.listen(
      S2CProtocol.U_C_CASTLE_UPDATE,
      this,
      this.__resourceUpgrade,
    );
  }
