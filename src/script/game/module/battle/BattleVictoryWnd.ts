...
export default class BattleVictoryWnd extends BaseWindow {
    ...
    public OnShowWind() {
        ...
        if(this.battleModel.battleType == BattleType.OUTYARD_BATLE){
            ...
            this.outyardTxt.text = LangManager.Instance.GetTranslation("BattleVictoryWnd.outyardTxt",this.data[2]);
        }else{
    ...
    private initPetIcon() {
        ...
        this.petIcon.icon = IconFactory.getPetHeadSmallIcon(this.playerInfo.enterWarPet.templateId);
    }
