...
export default class GemMazeRankWnd extends BaseWindow {
  ...
  initLanguage() {
    this.frame.getChild("title").text = LangManager.Instance.GetTranslation(
      "gemMaze.GemMazeSortFrame.title",
    );
    this.txt1.text = LangManager.Instance.GetTranslation(
      "MazeFrameWnd.MyOrderTxt",
    );
    this.txt2.text = LangManager.Instance.GetTranslation(
      "ConsortiaRankWnd.n16Txt",
    );
    this.txt3.text =
      LangManager.Instance.GetTranslation("fish.FishFrame.scoreText") + ": ";
    this.RankTxt.text = LangManager.Instance.GetTranslation(
      "fish.FishSort.Titls",
    );
    this.UserNameTxt.text =
      LangManager.Instance.GetTranslation("fish.FishSort.Name");
    this.txt_lv.text = LangManager.Instance.GetTranslation(
      "gemMaze.GemMazeSort.Level",
    );
    this.txt_point.text = LangManager.Instance.GetTranslation(
      "gemMaze.GemMazeSort.Score",
    );
    this.txt_reward.text = LangManager.Instance.GetTranslation(
      "gemMaze.GemMazeSort.Appell",
    );
  }
  ...
  OnShowWind() {
    ...
    if (model.gemMazeInfo.sort < 1) {
      this.txt_rank.text = LangManager.Instance.GetTranslation(
