...
export default class CustomerServiceModel extends FrameDataBase {
  ...
  public getMessage(): ServiceReplyInfo {
    if (this.receiveMessageList.length) {
      this._currentReplyInfo =
        this.receiveMessageList.pop() as ServiceReplyInfo;
      return this._currentReplyInfo;
    }
    return null;
  }
    ...
    this.problemList.push(
      {
        ...
        name: LangManager.Instance.GetTranslation(
          "customerservice.CustomerServiceModel.content06",
        ),
      },
      {
        id: 7,
        name: LangManager.Instance.GetTranslation(
          "customerservice.CustomerServiceModel.content08",
        ),
      },
      {
        id: 10,
        name: LangManager.Instance.GetTranslation(
          "customerservice.CustomerServiceModel.content11",
        ),
      },
    );
  }
