...
export default class FirstPayWnd extends BaseWindow {
  ...
  private setDayBtnRedStatus() {
    this.firstDayBtn.view.getChild("redDot").visible =
      this.firstPayModel["state1"] == FirstPayModel.CAN_GET ? true : false;
    this.secondDayBtn.view.getChild("redDot").visible =
      this.firstPayModel["state2"] == FirstPayModel.CAN_GET ? true : false;
    this.thirdDayBtn.view.getChild("redDot").visible =
      this.firstPayModel["state3"] == FirstPayModel.CAN_GET ? true : false;
  }
  ...
  private addEvent() {
    ...
    this.firstDayRewardList.itemRenderer = Laya.Handler.create(
      this,
    ...
    this.secondDayRewardList.itemRenderer = Laya.Handler.create(
      this,
    ...
    this.thirdDayRewardList.itemRenderer = Laya.Handler.create(
      this,
      this.renderListItem3,
      null,
      false,
    );
  }
  ...
  private setDefaultSelectedItem() {
    if (
      this.openServerDay >= 1 ||
      this.firstPayModel.state1 == FirstPayModel.CAN_GET ||
      this.firstPayModel.state1 == FirstPayModel.HAS_GETED
    ) {
    ...
    if (
      this.openServerDay >= 2 ||
      this.firstPayModel.state2 == FirstPayModel.CAN_GET ||
      this.firstPayModel.state2 == FirstPayModel.HAS_GETED
    ) {
    ...
    if (
      this.openServerDay >= 3 ||
      this.firstPayModel.state3 == FirstPayModel.CAN_GET ||
      this.firstPayModel.state3 == FirstPayModel.HAS_GETED
    ) {
  ...
  private refreshView(
    day: number,
    rewardArray: Array<GoodsInfo>,
    rewardList: fgui.GList,
  ) {
    let time: number = day;
    let job = ThaneInfoHelper.getJob(
