(function (exports, Laya) {
    ...
    var g_tmpVertices = Utils.newFloatArray(1 * 1024);
            ...
            for (let i = 0, n = drawOrder.length; i < n; i++) {
                ...
                if (attachment instanceof RegionAttachment) {
                    ...
                    if (renderable.numFloats > renderable.vertices.length) {
                        renderable.vertices = this.vertices = g_tmpVertices = Utils.newFloatArray(renderable.numFloats);
                    }
                    ...
                    if (clipper.isClipping()) {
                        ...
                        if (this.vertexEffect != null) {
                            ...
                            for (let v = 2, u = 0, n = renderable.numFloats; v < n; v += vertexSize, u += 2) {
                                ...
                                v == 2 && colors.push(verts[v], verts[v + 1], verts[v + 2], verts[v + 3]);
    ...
    class SpineSkeleton extends Laya.Sprite {
        ...
        bindBone (boneName, component, basePos) {
            this._bone = this.getBoneByName(boneName);
            if (this._bone && component instanceof Laya.Sprite) {
                if (component.parent != this) {
                    this.addChild(component);
                }
                this._basePos = basePos || { x: 0, y: 0 };
        ...
        _update () {
            ...
            let delta = Laya.timer.delta * 0.001 * this._playbackRate;
            let trackEntry = this.state.getCurrent(this.trackIndex);
            ...
            if (this._component && this._bone) {
                this._component.x = this._bone.x + this._basePos.x;
                this._component.y = -this._bone.y + this._basePos.y;
            }
        }
        getAnimNum () {
