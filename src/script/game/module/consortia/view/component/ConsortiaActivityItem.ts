...
export class ConsortiaActivityItem extends FUI_ConsortiaActivityItem {
    ...
    protected onConstruct() {
        super.onConstruct();
        this.operatingBtn.title = LangManager.Instance.GetTranslation("ConsortiaActivityItem.operatingBtn");
        this.gotoTxtBtn.title = LangManager.Instance.GetTranslation("ConsortiaActivityPage.gotoTxtBtn");
        this.initEvent();
        this.initView();
    }
    ...
    public refreshView(value: ConsortiaActivityInfo) {
        if (value != null) {
            ...
            switch (this._data.id) {
                case 0:
                    this.activityIcon.icon = fgui.UIPackage.getItemURL("Consortia", "asset.consortiaSkillIcon");
                    this.activityName.text = LangManager.Instance.GetTranslation("ConsortiaActivityItem.activityName1");
                    this.setEffect(false);
                    break;
                case 1:
                    this.activityIcon.icon = fgui.UIPackage.getItemURL("Consortia", "asset.SecretTerritoryIcon");
                    this.activityName.text = LangManager.Instance.GetTranslation("ConsortiaActivityItem.activityName2");
                    this.setEffect(this.treeState == ConsortiaSecretInfo.GIVE_POWER_STATE);
                    break;
                case 2:
                    this.activityIcon.icon = fgui.UIPackage.getItemURL("Consortia", "Btn_Eve_Outland");
                    this.activityName.text = LangManager.Instance.GetTranslation("ConsortiaActivityItem.activityName3");
                    ...
                    this.timeText.text = LangManager.Instance.GetTranslation("ConsortiaBossWnd.openTime", openDayStr);
                    this.timeText.visible = true;
                    break;
                case 3:
                    this.activityIcon.icon = fgui.UIPackage.getItemURL("Consortia", "asset.consortiaboss");
                    this.activityName.text = LangManager.Instance.GetTranslation("ConsortiaBossWnd.title");
                    ...
                    if (openTimeArr) {
                        ...
                        this.timeText.text = LangManager.Instance.GetTranslation("ConsortiaBossWnd.openTime", openStr);
                        this.timeText.visible = true;
                    }
                    this.setEffect(ConsortiaManager.Instance.model.bossInfo.state == 1 || ConsortiaManager.Instance.model.bossInfo.state == 2);
                    break;
                case 4:
                    this.activityIcon.icon = fgui.UIPackage.getItemURL("Consortia", "asset.consorTreasure");
                    this.activityName.text = LangManager.Instance.GetTranslation("ConsortiaTreasure.title");
                    break;
                case 5:
                    this.activityIcon.icon = fgui.UIPackage.getItemURL("Consortia", "asset.consortiaDevilIcon");
                    this.activityName.text = LangManager.Instance.GetTranslation("ConsortiaActivityItem.activityName4");
                    this.setEffect(this.demonState == 1);
                    break;
                case 6:
                    this.activityIcon.icon = fgui.UIPackage.getItemURL("Consortia", "asset.consortiaMineIcon");
                    this.activityName.text = LangManager.Instance.GetTranslation("ConsortiaActivityItem.activityName5");
                    this.setEffect(false);
                    break;
            }
            this.initData();
