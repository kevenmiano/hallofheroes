...
export class LayaClassUtils {
    ...
    static register() {
        ...
        Laya.ClassUtils.regClass('CampaignOverTransaction', CampaignOverTransaction);
        ...
        Laya.ClassUtils.regClass("VipMountActivityTipView", VipMountActivityTipView);
        ...
        Laya.ClassUtils.regClass("PawnCharacteristicsTipView", PawnCharacteristicsTipView);
        ...
        Laya.ClassUtils.regClass("SinglepassHasBugleYipsView", SinglepassHasBugleYipsView);
    ...
    private static registerConfigClass() {
        ...
        Laya.ClassUtils.regClass("t_s_skillbuffertemplate", t_s_skillbuffertemplate);//技能buff
        Laya.ClassUtils.regClass("t_s_skillpropertytemplate", t_s_skillpropertytemplate);//技能属性
        ...
        Laya.ClassUtils.regClass("t_s_talenteffecttemplate", t_s_talenteffecttemplate);//天赋
        ...
        Laya.ClassUtils.regClass("t_s_vehiclebufftemplate", t_s_vehiclebufftemplate);//载具buff
        Laya.ClassUtils.regClass("t_s_vehicleobjecttemplate", t_s_vehicleobjecttemplate);//载具
        Laya.ClassUtils.regClass("t_s_vehicleskilltemplate", t_s_vehicleskilltemplate);//载具技能
        Laya.ClassUtils.regClass("t_s_vipprerogativetemplate", t_s_vipprerogativetemplate);//VIP
        ...
        Laya.ClassUtils.regClass('t_s_powcardsuitetemplate', t_s_powcardsuitetemplate);
        ...
        Laya.ClassUtils.regClass("t_s_carnivaldailychallenge", t_s_carnivaldailychallenge); //嘉年华 每日挑战
        Laya.ClassUtils.regClass("t_s_carnivalluckdraw", t_s_carnivalluckdraw); //嘉年华 每日挑战
        Laya.ClassUtils.regClass("t_s_carnivalpointexchange", t_s_carnivalpointexchange); //嘉年华 每日挑战
        ...
        Laya.ClassUtils.regClass("t_s_petartifactproperty", t_s_petartifactproperty);//   
        Laya.ClassUtils.regClass("t_s_castlebattlebuilding", t_s_castlebattlebuilding);//        
        Laya.ClassUtils.regClass("t_s_castlebattlebuildingskill", t_s_castlebattlebuildingskill);//  
        Laya.ClassUtils.regClass("t_s_extrajob", t_s_extrajob);//  
        Laya.ClassUtils.regClass("t_s_extrajobequip", t_s_extrajobequip);//  
        Laya.ClassUtils.regClass("t_s_extrajobequipstrengthen", t_s_extrajobequipstrengthen);//  
        ...
        Laya.ClassUtils.regClass("t_s_consortiataskreward", t_s_consortiataskreward);//  
