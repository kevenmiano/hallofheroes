...
export default class NewbieUtils {
   ...
   *
   */
  public static execFunc(
    func: Function,
    args: Array<any> = null,
    callback: Function = null,
    callArgs: Array<any> = null,
  ): boolean {
    ...
    if (args) {
      ...
      switch (len) {
        case 0:
          bo = hasCallback
            ? Boolean(func(callback, callArgs))
            : Boolean(func());
          break;
        case 1:
          bo = hasCallback
            ? Boolean(func(callback, callArgs, args[0]))
            : Boolean(func(args[0]));
          break;
        case 2:
          bo = hasCallback
            ? Boolean(func(callback, callArgs, args[0], args[1]))
            : Boolean(func(args[0], args[1]));
          break;
        case 3:
          bo = hasCallback
            ? Boolean(func(callback, callArgs, args[0], args[1], args[2]))
            : Boolean(func(args[0], args[1], args[2]));
          break;
        case 4:
          bo = hasCallback
            ? Boolean(
                func(callback, callArgs, args[0], args[1], args[2], args[3]),
              )
            : Boolean(func(args[0], args[1], args[2], args[3]));
          break;
        case 5:
          bo = hasCallback
            ? Boolean(
            ...
            : Boolean(func(args[0], args[1], args[2], args[3], args[4]));
          break;
        case 6:
          bo = hasCallback
            ? Boolean(
