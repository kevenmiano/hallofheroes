...
export default class NewbieConditionType {
    ...
    public static c7: string = "NewbieBaseConditionMediator|checkCampaignNodeState";  //检查副本节点是否处于某状态
    ...
    public static c10: string = "NewbieBaseConditionMediator|checkCampaignNodeView";  //检查副本节点视图是否存在
    public static c11: string = "NewbieBaseConditionMediator|checkGoodsNum";  //检查物品数量
    public static c12: string = "NewbieBaseConditionMediator|checkTaskHasCompleted";  //检查是否完成过此任务
    public static c13: string = "NewbieBaseConditionMediator|checkPlayerBagItemIsExistData";  //检查背包格子是否存在物品
    public static c14: string = "NewbieBaseConditionMediator|checkEquipBagItemIsExistData";  //检查装备格子是否存在物品
    public static c15: string = "NewbieBaseConditionMediator|checkHavePawn";  //检查是否拥有某类士兵
    public static c17: string = "NewbieBaseConditionMediator|checkInCastleOrSpace";  //检查是否在内城或天空之城
    public static c18: string = "NewbieBaseConditionMediator|checkRolesNumInBattle";  //检查战斗中角色数量
    public static c20: string = "NewbieBaseConditionMediator|checkCampaignNodeAvatarState";  //检查副本节点avatar状态
    ...
    public static c23: string = "NewbieBaseConditionMediator|getTransferOuterCityActionIsFinish";  //判断外城人物传送动画是否完成
    public static c24: string = "NewbieBaseConditionMediator|checkNewbieNodeFinish";  //检查是否已经结束新手节点
