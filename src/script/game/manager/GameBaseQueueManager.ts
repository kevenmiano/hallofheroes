 ...
 * @author yuanzhan.yu
 */
export class GameBaseQueueManager extends GameEventDispatcher implements IEnterFrame
{
    ...
    {
        let mssage:string = "GameBaseQueueManager : " + this._actionsQueue.getMessage();
