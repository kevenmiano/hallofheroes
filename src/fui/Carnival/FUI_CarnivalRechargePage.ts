...
export default class FUI_CarnivalRechargePage extends fgui.GComponent {
	...
	public static createInstance():FUI_CarnivalRechargePage {
		return <FUI_CarnivalRechargePage>(fgui.UIPackage.createObject("Carnival", "CarnivalRechargePage"));
	}

	protected onConstruct():void {
		this.lang = this.getController("lang");
		this.Img_CarnivalRecharge_Bg = <fgui.GLoader>(this.getChild("Img_CarnivalRecharge_Bg"));
		this.Img_Txt_Carnival_Recharge = <fgui.GLoader>(this.getChild("Img_Txt_Carnival_Recharge"));
		this.carnival_recharge = <FUI_CarnivalInfoItem>(this.getChild("carnival_recharge"));
		this._luckTime = <fgui.GTextField>(this.getChild("_luckTime"));
		this.Img_CarnivalRecharge_Frame = <fgui.GLoader>(this.getChild("Img_CarnivalRecharge_Frame"));
