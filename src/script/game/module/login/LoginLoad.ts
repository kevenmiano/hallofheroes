...
export default class LoginLoad {
     ...
     * @param point 显示位置
     */
    public static onLoadSpine(target: any, skeletonURL: string, scale: number = 0.2, point: Laya.Point = new Laya.Point(10, 730)) {
        //创建一个Skeleton对象
        var skeleton = null;
        if (!this.skeletons.has(skeletonURL)) {
            ...
            skeleton.load(skeletonURL, Laya.Handler.create(this, () => {
