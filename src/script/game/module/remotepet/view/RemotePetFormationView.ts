...
export class RemotePetFormationView extends FUI_RemotePetFormationView {
    ...
    private initView() {
        ...
        for (let i = 0; i < this.formationItemsView.length; i++) {
            ...
            this.formationItemsView[i].onClick(this, this.onClickItemView, [this.formationItemsView[i]]);
        }
    }

    private addEvent(): void {
        this.model.addEventListener(RemotePetEvent.COMMIT, this.commitHandler, this);
        this.model.addEventListener(RemotePetEvent.PET_CHANGE, this.petChangeHandler, this);
    }

    private removeEvent(): void {
        this.model.removeEventListener(RemotePetEvent.COMMIT, this.commitHandler, this);
