...
export class TransSceneEffectContext {
  ...
  private createEffect(): ITransSceneEffect {
    ...
    switch (type) {
      ...
      case 2:
        ...
        break;
      case 3:
        effect = new TransSceneEffect2_1(
          this._cells,
          this._row,
          this._col,
          this._cellSize,
        ...
        break;
      case 4:
        effect = new TransSceneEffect2_2(
          this._cells,
          this._row,
          this._col,
          this._cellSize,
        ...
        break;
      case 5:
        effect = new TransSceneEffect2_3(
          this._cells,
          this._row,
          this._col,
          this._cellSize,
        ...
        break;
      case 6:
        effect = new TransSceneEffect2_4(
          this._cells,
          this._row,
          this._col,
          this._cellSize,
        ...
        break;
      case 7:
        effect = new TransSceneEffect2_5(
          this._cells,
          this._row,
          this._col,
          this._cellSize,
        ...
        break;
      case 8:
        effect = new TransSceneEffect2_6(
          this._cells,
          this._row,
          this._col,
          this._cellSize,
        ...
        break;
      case 9:
        effect = new TransSceneEffect2_7(
          this._cells,
          this._row,
          this._col,
          this._cellSize,
  ...
  public clean() {
    ...
    if (this._cellsContainer) {
      ...
      ObjectUtils.disposeAllChildren(
        this._cellsContainer as DisplayObjectContainer,
      );
