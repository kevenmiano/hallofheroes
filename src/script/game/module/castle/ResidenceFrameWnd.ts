 ...
 * 民居
 */
export default class ResidenceFrameWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.frame.getChild('title').text = LangManager.Instance.GetTranslation("ResidenceFrameWnd.title");
        this.n3Txt.text = LangManager.Instance.GetTranslation("ResidenceFrameWnd.title");
        this.n4Txt.text = LangManager.Instance.GetTranslation("ResidenceFrameWnd.n4Txt");
        this.n5Txt.text = LangManager.Instance.GetTranslation("CasernWnd.needResourceTxt");
        this.n6Txt.text = LangManager.Instance.GetTranslation("CasernWnd.needTimeTxt");
