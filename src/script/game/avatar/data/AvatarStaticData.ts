...
export class AvatarStaticData {
  ...
  constructor() {
    //stand
    this.dic[
      AvatarActions.ACTION_STOP +
        "_" +
        AvatarDirections.DIRECTION_DOWN +
        "_" +
        AvatarPartInfo.HAIR_UP
    ] = 1;
    this.dic[
      AvatarActions.ACTION_STOP +
        "_" +
    ...
    this.dic[
      AvatarActions.ACTION_STOP +
        ...
        AvatarDirections.DIRECTION_DOWN +
        "_" +
        AvatarPartInfo.MOUNT
    ] = 7;

    this.dic[
      AvatarActions.ACTION_STOP +
        "_" +
        AvatarDirections.DIRECTION_RIGHT_DOWN +
        "_" +
        AvatarPartInfo.ARMS
    ] = 1;
    this.dic[
    ...
    this.dic[
      AvatarActions.ACTION_STOP +
        "_" +
        AvatarDirections.DIRECTION_RIGHT +
        "_" +
        AvatarPartInfo.ARMS
    ] = 1;
    this.dic[
    ...
    this.dic[
      AvatarActions.ACTION_STOP +
        ...
        AvatarDirections.DIRECTION_DOWN +
        "_" +
        AvatarPartInfo.HAIR_DOWN_MOUNT
    ] = 4;
    this.dic[
      AvatarActions.ACTION_STOP +
        "_" +
    ...
    this.dic[
      AvatarActions.ACTION_WALK +
        "_" +
        AvatarDirections.DIRECTION_RIGHT_UP +
        "_" +
        AvatarPartInfo.ARMS
    ] = 1;
    this.dic[
  ...
  public static getBaseNumByType(
    actionType: string,
    action: string,
    isMounting: boolean = false,
    isStandMount: boolean = false,
    job: number = 0,
    sex: number = 2,
  ): any[] {
    if (!isMounting) {
      if (actionType == AvatarActionType.WALK) {
        ...
        switch (action) {
          case AvatarPosition.BODY:
            return AvatarStaticData.BODY_STAND;
          case AvatarPosition.ARMY:
            return AvatarStaticData.ARMY_STAND;
          case AvatarPosition.HAIR_UP:
            return AvatarStaticData.HAIR_UP_STAND;
          case AvatarPosition.HAIR_DOWN:
            return AvatarStaticData.HAIR_DOWN_STAND;
          case AvatarPosition.CLOAK:
            return AvatarStaticData.CLOAK_STAND;
          case AvatarPosition.WING:
            return AvatarStaticData.WING_STAND;
          case AvatarPosition.PET:
            return AvatarStaticData.PET_STAND;
        }
      }
    } else {
      if (actionType == AvatarActionType.WALK) {
        switch (action) {
          case AvatarPosition.BODY:
            return AvatarStaticData.BODY_WALK_MOUNT;
          case AvatarPosition.ARMY:
            return AvatarStaticData.ARMY_WALK_MOUNT;
          case AvatarPosition.HAIR_UP:
            return AvatarStaticData.HAIR_UP_WALK_MOUNT;
          case AvatarPosition.HAIR_DOWN:
            return AvatarStaticData.HAIR_DOWN_WALK_MOUNT;
          case AvatarPosition.CLOAK:
            return AvatarStaticData.CLOAK_WALK_MOUNT;
          case AvatarPosition.WING:
            return AvatarStaticData.WING_WALK_MOUNT;
          case AvatarPosition.MOUNT:
            return AvatarStaticData.MOUNT_WALK_MOUNT;
          case AvatarPosition.PET:
            return AvatarStaticData.PET_WALK_MOUNT;
        }
      } else if (actionType == AvatarActionType.STAND) {
        switch (action) {
          case AvatarPosition.BODY:
            return isStandMount
              ? AvatarStaticData.BODY_STAND_MOUNT_STANDPOS
              : AvatarStaticData.BODY_STAND_MOUNT;
          case AvatarPosition.ARMY:
            return isStandMount
              ? AvatarStaticData.ARMY_STAND_MOUNT_STANDPOS
              : AvatarStaticData.ARMY_STAND_MOUNT;
          case AvatarPosition.HAIR_UP:
            return AvatarStaticData.HAIR_UP_STAND_MOUNT;
          case AvatarPosition.HAIR_DOWN:
            return AvatarStaticData.HAIR_DOWN_STAND_MOUNT;
          case AvatarPosition.CLOAK:
            return AvatarStaticData.CLOAK_STAND_MOUNT;
          case AvatarPosition.WING:
            return AvatarStaticData.WING_STAND_MOUNT;
          case AvatarPosition.MOUNT:
            return AvatarStaticData.MOUNT_STAND_MOUNT;
          case AvatarPosition.PET:
            return AvatarStaticData.PET_STAND_MOUNT;
        }
      }
    }
    return [];
   ...
   *
   */
  public static getSetOffsetArray(
    actionType: string,
    action: string,
    isMounting: boolean,
    directionDataList: any[],
  ): any[] {
    let result: any[] = AvatarStaticData.getBaseNumByType(
      actionType,
      action,
      isMounting,
    );
