 ...
 * 仓库
 */
export default class DepotWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.frame.getChild('title').text = LangManager.Instance.GetTranslation("DepotWnd.title");
        this.n3Txt.text = LangManager.Instance.GetTranslation("DepotWnd.title");
        this.n4Txt.text = LangManager.Instance.GetTranslation("DepotWnd.n4Txt");
