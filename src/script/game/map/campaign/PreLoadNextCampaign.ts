...
export class PreLoadNextCampaign {
	...
	constructor(mapInfo: MapInfo) {
		...
		ServerDataManager.listen(S2CProtocol.U_C_CAMPAIGN_SYSTEM_ARMY, this, this.__allSystemArmyHandler);
	}
	...
	private __allSystemArmyHandler(pkg: PackageIn) {
		ServerDataManager.cancel(S2CProtocol.U_C_CAMPAIGN_SYSTEM_ARMY, this, this.__allSystemArmyHandler);
		...
		var mapBattleGround = TempleteManager.Instance.getMapTemplateById(this._mapId).BattleGround;
