...
export default class OuterCityResourceInfoWnd extends BaseWindow{
    ...
    private initEvent() {
        this.resourceList.itemRenderer = Laya.Handler.create(this, this.renderListItem, null, false);
        BuildingManager.Instance.addEventListener(BuildingEvent.U_SECURITY_INFO_UPDATE,this.dataUpdateHandler,this);
        NotificationManager.Instance.addEventListener(OuterCityEvent.CLOSE_OUTERCITY_RESOURCE_WND,this.hide,this);
    }

    private removeEvent() {
        Utils.clearGListHandle(this.resourceList);
        BuildingManager.Instance.removeEventListener(BuildingEvent.U_SECURITY_INFO_UPDATE,this.dataUpdateHandler,this);
        NotificationManager.Instance.removeEventListener(OuterCityEvent.CLOSE_OUTERCITY_RESOURCE_WND,this.hide,this);
    }
