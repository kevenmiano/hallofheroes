...
export default class ShortCutSetWnd extends BaseWindow {
    ...
    private initView(){
        ...
        if(this.params.type == 0){
            this.frame.title.text = LangManager.Instance.GetTranslation('shortCut.str1');
        ...
        {
            this.frame.title.text = LangManager.Instance.GetTranslation('shortCut.str2');
    ...
    onReset(){
        ...
        if(this.params.type == 0){
            SocketSendManager.Instance.reqPlayerSetting(OptType.ShortCut_InTeam,0,this.defaultStr);
        }else
        {
            SocketSendManager.Instance.reqPlayerSetting(OptType.ShortCut_AllTeam,0,this.defaultStr);
        }
        this.refreshList();
    }
    ...
    onSave(){
        ...
        if(this.params.type == 0){
            SocketSendManager.Instance.reqPlayerSetting(OptType.ShortCut_InTeam,0,str);
        }else
        {
            SocketSendManager.Instance.reqPlayerSetting(OptType.ShortCut_AllTeam,0,str);
        }
        this.hide();
    }
