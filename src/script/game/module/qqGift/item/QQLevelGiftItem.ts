...
export class QQLevelGiftItem extends FUI_QQLevelGiftItem {
    ...
    private refreshView() {
        this.txtTitle.text = LangManager.Instance.GetTranslation("QQ.Hall.Gift.levelTitle",this._info.Grade);
        this.btn_receive.title = LangManager.Instance.GetTranslation("GrowthFundItem.getTxt");
        this.btn_gray.title = LangManager.Instance.GetTranslation("GrowthFundItem.getTxt");
