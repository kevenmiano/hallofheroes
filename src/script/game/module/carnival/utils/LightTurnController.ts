...
export class LightTurnController implements IEnterFrame {
    ...
    public constructor($itemList: Array<CarnivalRechargeItem>, $initSpace: number, $needRun: number, $avSpeed: number, target: any, $callBack: Function, $stopLgihtTimes: number = 0) {
    ...
    public enterFrame() {
        ...
        if (this._runingPassTime >= this._needRun && this._currIdx == this._stopTargetIdx) {
    ...
    public start(stopTargetIdx: number, callParms: Array<any> = null) {
        ...
        TweenMax.to(this, delay, { tweenSpeed: this._avSpeed, ease: Quint.easeInOut });
    ...
    private stop(needCall = true) {
        ...
        if (needCall && this._callBack != null) this._callBack.apply(this._target, this._callParms);
        this._stopRun = 0;
        this._runTime = 0;
        this._ft = 0;
    }
    ...
    public initIdx(value: number) {
        ...
        this._currIdx = value;
        this._lastIdx = value;
        if (this._itemList[this._currIdx]) this._itemList[this._currIdx].isLight = true;
    }
