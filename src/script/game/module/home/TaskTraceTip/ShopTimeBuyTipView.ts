...
export class ShopTimeBuyTipView extends TaskTraceTipWnd {
	...
	initView() {
		...
		this.setContentIcon(FUIHelper.getItemURL("Base", "asset.taskTraceTips.ShopIcon"))
		this.setBtnTitle(LangManager.Instance.GetTranslation("tasktracetip.view.ShopTimeBuyTipView.btnTxt"));
	}
