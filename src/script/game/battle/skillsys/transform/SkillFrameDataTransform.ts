...
export class SkillFrameDataTransform {
  ...
  public static transformStringToFrameData(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    if (frameData.ActionType > -1) {
      SkillFrameDataTransform["createFrameData" + frameData.ActionType](
        frameData,
        element,
      );
    }
   ...
   *
   */
  private static createFrameData0(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    ...
    frameData.moveForwardData.dustGap = Number(
      paraArr.length > 5 ? paraArr[5] : 0,
    );
  }
  /**
   * 攻击动作.
   ...
   *
   */
  private static createFrameData1(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData2(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData3(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
    ...
    frameData.effectData.backDistance = Number(
      paraArr.length > 4 ? paraArr[4] : 0,
    );
    frameData.effectData.delayBleed = Number(
      paraArr.length > 5 ? paraArr[5] : 0,
    );
  }
  /**
   ...
   *
   */
  private static createFrameData4(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   * @param frameData
   **/
  private static createFrameData5(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    //			frameData.effectData = new EffectFrameData();
   ...
   * @param paraArr
   */
  private static createFrameData6(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData7(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData11(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData12(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
    ...
    frameData.shootData.dannyFrame = Number(
      paraArr.length > 5 ? paraArr[5] : 0,
    );
  }
  /**
   ...
   *
   */
  private static createFrameData21(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData22(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData23(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
    ...
    frameData.displacementForward.appearEffect =
      paraArr.length > 5 ? paraArr[5] : "";
  }
   ...
   *
   */
  private static createFrameData24(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
    ...
    frameData.displacementBack.appearEffect =
      paraArr.length > 2 ? paraArr[2] : "";
  }
  /**
   * 隐藏.
   * @param frameData
   ...
   *
   */
  private static createFrameData25(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
   ...
   *
   */
  private static createFrameData99(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {}
   ...
   *
   */
  private static createFrameData100(
    frameData: SkillFrameData,
    element: t_s_actionData,
  ) {
    let paraArr: string[] = element.Para;
    ...
    frameData.moveBackData.dustGap = Number(
      paraArr.length > 3 ? paraArr[3] : 0,
    );
  }
}
