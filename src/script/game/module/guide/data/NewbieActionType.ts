...
export default class NewbieActionType {
  ...
  public static a44: string =
    "NewbieSpecialActionMediator|weaponIntensifyGuild"; //强化武器指引
  public static a45: string = "NewbieBaseActionMediator|moveNPCByTween"; //移动NPC（非寻路）
  public static a46: string =
    "NewbieBaseActionMediator|sendEnterCollectionBattle"; //触发采集战斗
  ...
  public static a51: string =
    "NewbieSpecialActionMediator|showOutCityBattleMovie"; //设置外城城堡站状态
  public static a52: string =
    "NewbieBaseActionMediator|sendOuterCityBattleAndQueue"; //请求外城城堡战斗
