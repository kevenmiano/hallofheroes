...
export default class HeadIconCtr extends FrameCtrlBase {
    ...
    protected addEventListener() {
        ...
        ServerDataManager.listen(S2CProtocol.U_C_CHANGE_FRAME, this, this.__frameChangeHandler);
    }

    protected delEventListener() {
        super.delEventListener();
        ServerDataManager.cancel(S2CProtocol.U_C_CHANGE_FRAME, this, this.__frameChangeHandler);
    }
