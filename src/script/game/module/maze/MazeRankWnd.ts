...
export default class MazeRankWnd extends BaseWindow {
  ...
  public OnInitWind() {
    ...
    this.RankTxt.text = LangManager.Instance.GetTranslation(
      "colosseum.view.HeroRankFrame.rank",
    );
    this.UserNameTxt.text = LangManager.Instance.GetTranslation(
      "colosseum.view.HeroRankFrame.nickName",
    );
    this.PassLayerNumTxt.text = LangManager.Instance.GetTranslation(
      "MazeRankWnd.PassLayerNumTxt",
    );
  ...
  private addEvent() {
    ...
    this.RankTablist.on(
      Laya.Event.CLICK,
      this,
      this.__onRankTabClick.bind(this),
    );
    this.RankTablist.itemRenderer = Laya.Handler.create(
      this,
      this._onRankTabRender,
      null,
      false,
    );
  }
  ...
  private initTabList() {
    this.rankTabData = [];
    this.createTabData(
      EmMazeType.GroundMaze,
      LangManager.Instance.GetTranslation("MazeFrameWnd.BtnGroupName0"),
      "Tab_Dia2Y_Nor",
      "Tab_Dia2Y_Sel",
      this.rankTabData,
    );
    this.createTabData(
      EmMazeType.AbyssMaze,
      LangManager.Instance.GetTranslation("MazeFrameWnd.BtnGroupName1"),
      "Tab_Dia2Y_Nor",
      "Tab_Dia2Y_Sel",
      this.rankTabData,
    );
