...
export default class FUI_RoomPlayerItem extends fgui.GComponent {
	...
	public static createInstance():FUI_RoomPlayerItem {
		return <FUI_RoomPlayerItem>(fgui.UIPackage.createObject("BaseRoom", "RoomPlayerItem"));
	}
	...
	protected onConstruct():void {
		...
		this.txtPlayerNameShadow = <fgui.GTextField>(this.getChild("txtPlayerNameShadow"));
		this.txtPlayerName = <fgui.GTextField>(this.getChild("txtPlayerName"));
		this.txtGuildNameShadow = <fgui.GTextField>(this.getChild("txtGuildNameShadow"));
