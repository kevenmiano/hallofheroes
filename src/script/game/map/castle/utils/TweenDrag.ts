...
export class TweenDrag {
  ...
  private __mouseMove(event: Event) {
    ...
    let dis = this.mouseDownPoint.distance(
      this._target.stage.mouseX,
      this._target.stage.mouseY,
    );
  ...
  private setForcVectorMaxValue() {
    this.forceVector.x =
      this.forceVector.x > this._maxForce ? this._maxForce : this.forceVector.x;
    this.forceVector.x =
      this.forceVector.x < -this._maxForce
        ? -this._maxForce
        : this.forceVector.x;
    this.forceVector.y =
      this.forceVector.y > this._maxForce ? this._maxForce : this.forceVector.y;
    this.forceVector.y =
      this.forceVector.y < -this._maxForce
        ? -this._maxForce
        : this.forceVector.y;
  }
