 ...
 * 嘉年华--特惠礼包
 */
export default class CarnivalDiscountPage
  extends FUI_CarnivalDiscountPage
  implements CarnivalBasePage
{
  ...
  private initData() {
    ...
    this.carnival_recharge.txt_title.text =
      LangManager.Instance.GetTranslation("carnival.today");
    ...
    this._tempList = TempleteManager.Instance.getCarnivalByType(
