...
export class ArmySocketOutManager {
     ...
     * 
     */
    public static sendChangeHeroInfo(heroId: number) {//0x1390
     ...
     * 
     */
    public static sendRecruitPawn(templateId: number, count: number) {//0x1423
     ...
     * 
     */
    public static sendDismissPawn(tempId: number, count: number) {//0x1425
        var msg: ArmyPawnInfoMsg = new ArmyPawnInfoMsg();
     ...
     * 
     */
    public static sendEditArmyPawn(pos1: number, tempId1: number, count1: number) {//0x1424
        var msg: ArmyPawnInfoMsg = new ArmyPawnInfoMsg();
        msg.sites = pos1;
     ...
     * 
     */
    public static sendEditArmyPos(userId: number, heroPos: number, pawnPos: number) {//0x2054
     ...
     * 
     */
    public static sendUpgradePawn(tempId: number) {//0x1426
        var msg: ArmyPawnInfoMsg = new ArmyPawnInfoMsg();
        msg.tempateId = tempId;
     ...
     * @param  payType  
    */
    public static sendPawnChange(oldId: number, newId: number, payType: number, useBind: boolean = true) {//0x1426
     ...
     */
    public static sendStudyRune(runeId: number, runeItemPos: number, runeItemCount: number = 1) {
     ...
     */
    public static sendAddSkillpoint(tempId: number, type: number = 0, useBind: boolean = true,subType:number=0) {//0x1441
     ...
     */
    public static sendWashSkillPoint(payType: number, type: number = 0, useBind: boolean = true) {//0x1440
     ...
     * 
     */
    public static sendAddTalentpoint(tempId: number) {//0x1441
        var msg: HeroAddPointReqMsg = new HeroAddPointReqMsg();
        msg.skillTempId = tempId;
        SocketManager.Instance.send(C2SProtocol.C_HERO_SKILL_UPGRADE, msg);
    }
     ...
     * 设置快捷键 
     */
    public static sendSetFastKey(fastKey: string) {//0x142F
