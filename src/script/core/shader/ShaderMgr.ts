...
export default class ShaderMgr {
   ...
   */
  public ambiLight(
    nodetext: Laya.Sprite,
    valueForAlpa: number = 0.5,
    x: number = 0,
    y: number = 0,
  ) {}
   ...
   */
  public dissolveTarget(
    target: Laya.Image | Laya.Sprite,
   ...
   * @param totalTime 消散时间
   */
  public MosaicDissolveTarget(
    target: Laya.Image | Laya.Sprite,
    totalTime: number = 3.5,
  ) {
