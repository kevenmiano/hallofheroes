...
export default class ReinforceWavePane extends FUI_ReinforceWavePane {
	...
	onConstruct() {
		super.onConstruct();
		this.forceText.text = LangManager.Instance.GetTranslation("battle.view.reinforce.ReinforceWavePane.tf.text");
		this.list.itemRenderer = Laya.Handler.create(this, this.renderReinforeListItem, null, false);
	}
