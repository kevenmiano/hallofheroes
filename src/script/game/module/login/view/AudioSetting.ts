...
export class AudioSetting extends FUI_AudioSetting {
    ...
    private addEvent() {
        ...
        this.effectProgress.on(fairygui.Events.STATE_CHANGED, this, this.onSoundPro);
    }
    ...
    private offEvent() {
        ...
        this.musicProgress && this.musicProgress.off(fairygui.Events.STATE_CHANGED, this, this.onMusicPro);
        this.effectProgress && this.effectProgress.off(fairygui.Events.STATE_CHANGED, this, this.onSoundPro);
    }
