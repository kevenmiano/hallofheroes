...
export default class FUI_RemotePetSkillLevelUpItem extends fgui.GComponent {
  ...
  public static createInstance(): FUI_RemotePetSkillLevelUpItem {
    return <FUI_RemotePetSkillLevelUpItem>(
      fgui.UIPackage.createObject("RemotePet", "RemotePetSkillLevelUpItem")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this._getSkillCountTipTxt = <fgui.GTextField>(
      this.getChild("_getSkillCountTipTxt")
    );
  }
}
