...
export class ComposeGoodsInfo extends GameEventDispatcher {
    ...
    public get template(): t_s_composeData {
        return ConfigMgr.Instance.getTemplateByID(ConfigType.t_s_compose, this.templateId);
    }
    public get itemTemplate(): t_s_itemtemplateData {
        return ConfigMgr.Instance.getTemplateByID(ConfigType.t_s_itemtemplate, this.template.NewMaterial);
    }
    ...
    public set ownCount2(value: number) {
        ...
        this._canMakeCount2 = this.template.Count2 > 0 ? this._ownCount2 / this.template.Count2 : this._ownCount2;
    }
    ...
    public set ownCount3(value: number) {
        ...
        this._canMakeCount3 = this.template.Count3 > 0 ? this._ownCount3 / this.template.Count3 : this._ownCount3;
    }
    ...
    public set ownCount4(value: number) {
        ...
        this._canMakeCount4 = this.template.Count4 > 0 ? this._ownCount4 / this.template.Count4 : this._ownCount4;
    }
