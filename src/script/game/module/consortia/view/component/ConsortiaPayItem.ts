...
export default class ConsortiaPayItem extends FUI_ConsortiaPayItem implements ITipedDisplay{
    ...
    public set info(value: ConsortiaPrayInfo) {
        ...
        if (this._info) {
            ...
            this.goodsIcon.url = IconFactory.getGoodsIconByTID(value.goodsInfo.templateId);
            let res = CommonConstant.QUALITY_RES[value.goodsInfo.templateInfo.Profile - 1];
