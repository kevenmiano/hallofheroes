...
export function HttpRequest(host, uri, params, method = 'post', responseType: string = "text", errorFunc: Function = null, headers?: any[]) {
...
export function HttpFetch(host, uri, params, method = 'POST', responseType: string = "text", errorFunc: Function = null) {
    let url = `${host}${uri}`;
