...
export default class GameSetCom extends FUI_GameSetCom {
  ...
  private onFrame(): void {
    ...
    Laya.stage.frameRate = this.btn_frame.selected
  ...
  public removeEvent(): void {
    ...
    for (let i = 0; i < this.list.numChildren; i++) {
      let btn_switch: fairygui.GButton = this.list
        .getChildAt(i)
        .asCom.getChild("btn_switch").asButton;
