...
export default class FUI_RoomListMemberItem extends fgui.GComponent {
	...
	public static URL:string = "ui://6qd4tcidbposi3l";

	public static createInstance():FUI_RoomListMemberItem {
		return <FUI_RoomListMemberItem>(fgui.UIPackage.createObject("RoomList", "RoomListMemberItem"));
	}
