...
import { BattleType, FaceType, InheritRoleType } from "../../../constant/BattleDefine";
...
export class PetRoleView extends BaseRoleView {
    ...
    public load() {
        ...
        this._rolePart.data = HeroLoadDataFactory.create(this.petInfo.heroRoleInfo.heroInfo, HeroLoadDataFactory.PART_PET_FOLLOW);
    ...
    protected delayInitView() {
        ...
        if (this.petInfo.petName != null) {
            ...
            if (this.petInfo.quality > 0) {
                this._heroNameTxt.setFrame(this.petInfo.quality, eFilterFrameText.PetQuality);
            }
        } else {
