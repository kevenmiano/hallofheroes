...
export class RemotePetSkillsView extends FUI_RemotePetSkillsView {
  ...
  protected onConstruct(): void {
    super.onConstruct();
    this._skillItemView = [
      this.s1 as RemotePetSkillItemView,
      this.s2 as RemotePetSkillItemView,
      this.s3 as RemotePetSkillItemView,
    ];
    let index = 0;
  ...
  private __mouseClickHandler(skillItem: RemotePetSkillItemView) {
    ...
    NotificationManager.Instance.addEventListener(
      PetChallengeEvent.CHALLENGE_SKILL_CHANGE,
      this.selectSkill,
      this,
    );
  }

  private selectSkill(data: {
    petData: PetData;
    skillTemp: t_s_skilltemplateData;
  }) {
