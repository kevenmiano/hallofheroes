...
export default class QQDawankWnd extends BaseWindow {
    ...
    private addEvent() {
        ...
        this._model.addEventListener(QQ_HALL_EVENT.GARDE_CHANGE, this.refreshView, this);
        this._model.addEventListener(QQ_HALL_EVENT.TAB_CHANGE, this.onTabChange, this);

    }

    private offEvent() {
        // this.txtBtn.offClick(this, this.helpBtnClick);
        this._model.removeEventListener(QQ_HALL_EVENT.GARDE_CHANGE, this.refreshView, this);
        this._model.removeEventListener(QQ_HALL_EVENT.TAB_CHANGE, this.onTabChange, this);

        if (this.dateTablist) {
            // this.dateTablist.itemRenderer.recover();
            Utils.clearGListHandle(this.dateTablist);
            this.dateTablist.off(fairygui.Events.CLICK_ITEM, this, this.__onTitleSelect);
        }
    }
    ...
    private initTabList() {
        this.dateTablist.itemRenderer = Laya.Handler.create(this, this.renderTitleListItem, null, false);
    ...
    initDataList() {
        this.datalist1.itemRenderer = Laya.Handler.create(this, this.renderDataListItem1, null, false);
        this.datalist2.itemRenderer = Laya.Handler.create(this, this.renderDataListItem2, null, false);
    }
    ...
    private initText() {
        this.txtBtn.text = LangManager.Instance.GetTranslation("QQ.Hall.Dawanka.tips1");
        this.txtActiving.text = LangManager.Instance.GetTranslation("QQ.Hall.Dawanka.activing");
    }


    private refreshView() {
        this.txtLevel.text = LangManager.Instance.GetTranslation("QQ.Hall.Dawanka.myLevel", this._model.getGradeNameByGrade(this._model.getPlayerGarde()));
        this.txtValue.text = LangManager.Instance.GetTranslation("QQ.Hall.Dawanka.myValue", this._model.getPlayerDawankaValue());
