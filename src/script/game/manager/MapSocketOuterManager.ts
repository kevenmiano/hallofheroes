...
export class MapSocketOuterManager {
     ...
     *
     */
    public static sendAlertState(id: number, state: boolean) {//0x2004
     ...
     *
     */
    public static sendCampaignArrive(armyId: number, nodeId: number, reject: boolean = true, protocolId: number = 0) {
     ...
     *
     */
    public static sendSelectCampaignArmy(type: number, id: number, armyId: number = -1) {
     ...
     *
     */
    public static sendCampaignArmyMove(armyId: number, paths: any[], mapId: number, type:PlayerVisualFollow) {
