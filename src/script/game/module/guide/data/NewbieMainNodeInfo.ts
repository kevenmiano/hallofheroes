...
export class NewbieMainNodeInfo {
    ...
    constructor($mainNodeId: number, $sort: number, $manualTrigger:boolean, $nodeCfgArr: Object[]) {
    ...
    public parseSubNodeInfo(cfg: Object) {
        ...
        nodeInfo.conditionParams = this.resolveConditionParams(cfg["conditionParams"]);
        nodeInfo.conditionInverted = cfg["conditionInverted"] ? cfg["conditionInverted"].split(",") : [];
        nodeInfo.conditionSymbol = Number(cfg["conditionSymbol"]);
        nodeInfo.skipConditions = this.resolveConditions(cfg["skipConditions"]);
        nodeInfo.skipConditionParams = this.resolveConditionParams(cfg["skipConditionParams"]);
        nodeInfo.skipConditionInverted = cfg["skipConditionInverted"] ? cfg["skipConditionInverted"].split(",") : [];
        ...
        nodeInfo.backConditionParams = this.resolveConditionParams(cfg["backConditionParams"]);
        nodeInfo.backConditionInverted = cfg["backConditionInverted"] ? cfg["backConditionInverted"].split(",") : [];
