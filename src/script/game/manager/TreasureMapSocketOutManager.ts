...
export class TreasureMapSocketOutManager {
     ...
     * 
     */
    public static sendRefreshTreasureMap(quickly: boolean = false, useBind: boolean = false) {
        var msg: PlayerTreasureMsg = new PlayerTreasureMsg();
    ...
    public static sendReinforceTreasureMap(userId: number) {
        ...
        msg.param1 = userId;
        SocketManager.Instance.send(C2SProtocol.C_TREASUREMAP_BATTLE_REINFORCE, msg);
    }
}