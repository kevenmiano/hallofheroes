...
export default class FUI_PetPKSkillItemListView extends fgui.GComponent {
	...
	public static createInstance():FUI_PetPKSkillItemListView {
		return <FUI_PetPKSkillItemListView>(fgui.UIPackage.createObject("Battle", "PetPKSkillItemListView"));
	}
	...
	protected onConstruct():void {
		...
		this.txtOwnRoleInfoList = <fgui.GTextField>(this.getChild("txtOwnRoleInfoList"));
		this.wifi = <fgui.GComponent>(this.getChild("wifi"));
		this.itemSkill1_1 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill1_1"));
		this.itemSkill1_2 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill1_2"));
		this.itemSkill1_3 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill1_3"));
		this.itemSkill1_4 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill1_4"));
		this.itemSkill1_5 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill1_5"));
		this.itemSkill1_6 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill1_6"));
		this.itemSkill2_1 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill2_1"));
		this.itemSkill2_2 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill2_2"));
		this.itemSkill2_3 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill2_3"));
		this.itemSkill2_4 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill2_4"));
		this.itemSkill2_5 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill2_5"));
		this.itemSkill2_6 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill2_6"));
		this.itemSkill3_1 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill3_1"));
		this.itemSkill3_2 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill3_2"));
		this.itemSkill3_3 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill3_3"));
		this.itemSkill3_4 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill3_4"));
		this.itemSkill3_5 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill3_5"));
		this.itemSkill3_6 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill3_6"));
	}
}