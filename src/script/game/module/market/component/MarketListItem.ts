...
export default class MarketListItem extends FUI_MarketListItem {
    ...
    protected onConstruct(): void {
        ...
        (this.diamondTip as BaseTipItem).setInfo(TemplateIDConstant.TEMP_ID_DIAMOND);
    }
    ...
    public updateView() {
        ...
        this.countLab.text = LangManager.Instance.GetTranslation("market.online.count", this._data.total, this._data.purchaseTotal);
        ...
        this.goodsLab.color = GoodsSonType.getColorByProfile(this._cacheGoods.templateInfo.Profile);
