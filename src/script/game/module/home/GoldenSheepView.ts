...
export default class GoldenSheepView extends BaseFguiCom {
    ...
    constructor(target: fgui.GComponent, target2: fgui.Controller, target3: fgui.GLoader, target4: fgui.GTextField,parent:fairygui.GComponent) {
        super(target);
    ...
    private offEvent() {
        ...
        this._model.removeEventListener(GoldenSheepEvent.STATE_UPDATE, this.__stateUpdateHandler, this);
    }

    private addEvent() {
        this.picIcon.onClick(this, this.__btnClickHandler);
        this._model.addEventListener(GoldenSheepEvent.STATE_UPDATE, this.__stateUpdateHandler, this);
    }
