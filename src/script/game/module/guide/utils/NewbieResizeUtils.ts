...
export default class NewbieResizeUtils {
  ...
  private static __timerUpdateHandler() {
    ...
    for (NewbieResizeUtils._tempDisObj01 in NewbieResizeUtils._autoRemoveList) {
      count++;
      NewbieResizeUtils._tempDisObj02 =
        NewbieResizeUtils._autoRemoveList[NewbieResizeUtils._tempDisObj01];
      if (
        NewbieResizeUtils._tempDisObj01 &&
        NewbieResizeUtils._tempDisObj01.stage &&
        NewbieResizeUtils._tempDisObj02 &&
        NewbieResizeUtils._tempDisObj02.stage
      ) {
        NewbieResizeUtils._tempP.x = NewbieResizeUtils._tempDisObj02.x;
        NewbieResizeUtils._tempP.y = NewbieResizeUtils._tempDisObj02.y;
        NewbieResizeUtils._tempP =
          NewbieResizeUtils._tempDisObj02.parent.localToGlobal(
            NewbieResizeUtils._tempP,
          );
        NewbieResizeUtils._tempP =
          NewbieResizeUtils._tempDisObj01.parent.globalToLocal(
            NewbieResizeUtils._tempP,
          );
        NewbieResizeUtils._tempOffsetPoint =
          NewbieResizeUtils._offsetList[NewbieResizeUtils._tempDisObj01];
        if (NewbieResizeUtils._tempOffsetPoint) {
          NewbieResizeUtils._tempDisObj01.x =
            NewbieResizeUtils._tempP.x + NewbieResizeUtils._tempOffsetPoint.x;
          NewbieResizeUtils._tempDisObj01.y =
            NewbieResizeUtils._tempP.y + NewbieResizeUtils._tempOffsetPoint.y;
        } else {
        ...
        NewbieResizeUtils._autoRemoveList[NewbieResizeUtils._tempDisObj01] =
          null;
        delete NewbieResizeUtils._autoRemoveList[
          NewbieResizeUtils._tempDisObj01
        ];
    ...
    for (NewbieResizeUtils._tempDisObj01 in NewbieResizeUtils._manualRemoveList) {
      count++;
      NewbieResizeUtils._tempDisObj02 =
        NewbieResizeUtils._manualRemoveList[NewbieResizeUtils._tempDisObj01];
      if (
        NewbieResizeUtils._tempDisObj01 &&
        NewbieResizeUtils._tempDisObj01.stage &&
        NewbieResizeUtils._tempDisObj02 &&
