 ...
 * @ver 1.0
 */
export class BottleIntergalBoxView
  extends FUI_BottleIntergalBoxView
  implements ITipedDisplay, FunnyContent
{
  tipData: any;
  tipType: EmWindow;
  ...
  public refreshStatus(): void {
    ...
    if (userInfo && userInfo.userId > 0 && userInfo.state == 0) {
      //可领取
    ...
    } else if (userInfo && userInfo.userId > 0 && userInfo.state == 1) {
      //已经领取
