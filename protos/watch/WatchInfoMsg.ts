...
//   protoc               v3.21.12
// source: watch/WatchInfoMsg.proto
...
function createBaseWatchInfoMsg(): WatchInfoMsg {
  return { gridType: 0, gridPos: 0, jion1: 0, jion2: 0, jion3: 0, jion4: 0 };
}

export const WatchInfoMsg: MessageFns<WatchInfoMsg> = {
  encode(message: WatchInfoMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WatchInfoMsg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseWatchInfoMsg();
  ...
  fromJSON(object: any): WatchInfoMsg {
    return {
  ...
  toJSON(message: WatchInfoMsg): unknown {
    const obj: any = {};
    if (message.gridType !== 0) {
  ...
  create<I extends Exact<DeepPartial<WatchInfoMsg>, I>>(base?: I): WatchInfoMsg {
    return WatchInfoMsg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WatchInfoMsg>, I>>(object: I): WatchInfoMsg {
    const message = createBaseWatchInfoMsg();
