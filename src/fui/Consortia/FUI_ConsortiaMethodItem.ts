...
export default class FUI_ConsortiaMethodItem extends fgui.GComponent {
	...
	public static createInstance():FUI_ConsortiaMethodItem {
		return <FUI_ConsortiaMethodItem>(fgui.UIPackage.createObject("Consortia", "ConsortiaMethodItem"));
	}
	...
	protected onConstruct():void {
		...
		this.functionNameTxt = <fgui.GRichTextField>(this.getChild("functionNameTxt"));
