...
export default class OutyardBattleRecordItem extends FUI_OutyardBattleRecordtem {
  ...
  public set info(value: OutyardReportInfo) {
    ...
    if (this._info) {
      let timeTxt =
        "[color=#FFECC6][" + this._info.reportTime + "][/color]&nbsp;&nbsp;";
      ...
      if (this._type == 1) {
        ...
        if (this._info.isWin) {
          ...
          this.descTxt.text =
            ...
            LangManager.Instance.GetTranslation(
              "OutyardBattleRecordItem.attackDescTxt1",
              attackUserName,
              underAttackConsortia,
              underAttackUserName,
              changeScore,
            );
        } else {
          ...
          this.descTxt.text =
            timeTxt +
            LangManager.Instance.GetTranslation(
              "OutyardBattleRecordItem.attackDescTxt2",
              attackUserName,
              underAttackConsortia,
              underAttackUserName,
              defencePower,
        ...
        if (this._info.isWin) {
          ...
          this.descTxt.text =
            timeTxt +
            LangManager.Instance.GetTranslation(
              "OutyardBattleRecordItem.defenceDescTxt1",
              attackConsortia,
              attackUserName,
              defenceUserName,
              defenceUserName,
          ...
          this.descTxt.text =
            timeTxt +
            LangManager.Instance.GetTranslation(
              "OutyardBattleRecordItem.defenceDescTxt2",
              attackConsortia,
              attackUserName,
              defenceUserName,
              changeScore,
