...
export default class Promotion extends FUI_Promotion {
    ...
    private initData() {
        let datalist = TempleteManager.Instance.getRechargeTempletes(ProductType.PROMOTION);
        let dataweeklist = TempleteManager.Instance.getRechargeTempletes(ProductType.PROMOTION_WEEK);
    ...
    private initView() {
        ...
        this.txt_describe.text = LangManager.Instance.GetTranslation("Shop.Promotion.describe");
    }
