...
export default class PetChallengeRewardWnd extends BaseWindow {
    ...
    OnShowWind() {
        super.OnShowWind();
        this.weekRewadList.itemRenderer = Laya.Handler.create(this, this.onRenderWeekRewadListItem, null, false);
    ...
    private onRenderWeekRewadListItem(index: number, item: PetChallengeScoreRewardItem) {
