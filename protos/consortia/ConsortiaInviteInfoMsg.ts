...
//   protoc               v3.21.12
// source: consortia/ConsortiaInviteInfoMsg.proto
...
export interface ConsortiaInviteInfoMsg {
  id: number;
  consortiaId: number;
...
function createBaseConsortiaInviteInfoMsg(): ConsortiaInviteInfoMsg {
  return {
    id: 0,
    consortiaId: 0,
    consortiaName: "",
...
export const ConsortiaInviteInfoMsg: MessageFns<ConsortiaInviteInfoMsg> = {
  encode(message: ConsortiaInviteInfoMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ConsortiaInviteInfoMsg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseConsortiaInviteInfoMsg();
  ...
  fromJSON(object: any): ConsortiaInviteInfoMsg {
    return {
  ...
  toJSON(message: ConsortiaInviteInfoMsg): unknown {
    const obj: any = {};
    if (message.id !== 0) {
  ...
  create<I extends Exact<DeepPartial<ConsortiaInviteInfoMsg>, I>>(base?: I): ConsortiaInviteInfoMsg {
    return ConsortiaInviteInfoMsg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ConsortiaInviteInfoMsg>, I>>(object: I): ConsortiaInviteInfoMsg {
    const message = createBaseConsortiaInviteInfoMsg();
