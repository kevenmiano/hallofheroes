...
export default class FUI_MazeItem extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.groundDoubleProfitG = <fgui.GGroup>(this.getChild("groundDoubleProfitG"));
		this.CurrentFloorTxt = <fgui.GTextField>(this.getChild("CurrentFloorTxt"));
		this.CurrentFloorValue = <fgui.GTextField>(this.getChild("CurrentFloorValue"));
		...
		this.TodayFreeCountTxt = <fgui.GTextField>(this.getChild("TodayFreeCountTxt"));
		this.TodayFreeCountValue = <fgui.GTextField>(this.getChild("TodayFreeCountValue"));
