...
export class JobType {
    ...
    public static getJobName(job: number): string {
        switch (job) {
            ...
            case 1:
            case 4:
                return LangManager.Instance.GetTranslation("yishi.datas.consant.JobType.Name02");
                break;
            case 2:
            case 5:
                return LangManager.Instance.GetTranslation("yishi.datas.consant.JobType.Name03");
                break;
            case 3:
            case 6:
                return LangManager.Instance.GetTranslation("yishi.datas.consant.JobType.Name04");
            case 100:
                return LangManager.Instance.GetTranslation("yishi.datas.consant.JobType.Name06");
                break;
        }
