...
//   protoc               v3.21.12
// source: lucky/MultilordsArmyMsg.proto
...
export interface MultilordsArmyMsg {
  id: number;
  userId: number;
  name: string;
  type: number;
  ...
  fightPower: number;
  uid: string;
  multiLordsInspireLevel: number;
}

function createBaseMultilordsArmyMsg(): MultilordsArmyMsg {
  return {
    id: 0,
    userId: 0,
    name: "",
    ...
    fightPower: 0,
    uid: "",
    multiLordsInspireLevel: 0,
  };
}

export const MultilordsArmyMsg: MessageFns<MultilordsArmyMsg> = {
  encode(message: MultilordsArmyMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
    ...
    if (message.uid !== "") {
      writer.uint32(154).string(message.uid);
    }
    if (message.multiLordsInspireLevel !== 0) {
      writer.uint32(160).int32(message.multiLordsInspireLevel);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MultilordsArmyMsg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMultilordsArmyMsg();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 20: {
          ...
          message.multiLordsInspireLevel = reader.int32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): MultilordsArmyMsg {
    return {
      ...
      multiLordsInspireLevel: isSet(object.multiLordsInspireLevel)
        ? globalThis.Number(object.multiLordsInspireLevel)
        : 0,
    };
  },

  toJSON(message: MultilordsArmyMsg): unknown {
    const obj: any = {};
    if (message.id !== 0) {
    ...
    if (message.multiLordsInspireLevel !== 0) {
      obj.multiLordsInspireLevel = Math.round(message.multiLordsInspireLevel);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<MultilordsArmyMsg>, I>>(base?: I): MultilordsArmyMsg {
    return MultilordsArmyMsg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MultilordsArmyMsg>, I>>(object: I): MultilordsArmyMsg {
    const message = createBaseMultilordsArmyMsg();
    ...
    message.multiLordsInspireLevel = object.multiLordsInspireLevel ?? 0;
    return message;
  },
};
