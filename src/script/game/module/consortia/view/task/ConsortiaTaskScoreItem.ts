...
export default class ConsortiaTaskScoreItem extends FUI_ConsortiaTaskScoreItem implements ITipedDisplay {
    ...
    private getTipsStr(arr: GoodsInfo[]): string {
        let str: string = LangManager.Instance.GetTranslation("dayguide.LimitedSellView.ActiveBoxItemTips") + "<br>";
        if (arr != null) {
