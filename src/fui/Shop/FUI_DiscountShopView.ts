...
export default class FUI_DiscountShopView extends fgui.GComponent {
  ...
  public static createInstance(): FUI_DiscountShopView {
    return <FUI_DiscountShopView>(
      fgui.UIPackage.createObject("Shop", "DiscountShopView")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.txt_myDiscountDesc1 = <fgui.GTextField>(
      this.getChild("txt_myDiscountDesc1")
    );
    this.txt_myDiscountDescOverSea = <FUI_ComDiscountShopText>(
      this.getChild("txt_myDiscountDescOverSea")
    );
    this.txt_myDiscountDesc = <FUI_ComDiscountShopText>(
      this.getChild("txt_myDiscountDesc")
    );
    this.txtMyDiscount = <FUI_ComDiscountShopText>(
      this.getChild("txtMyDiscount")
    );
    this.mcMyDiscount = <FUI_ComDiscountShopTextMC>(
      this.getChild("mcMyDiscount")
    );
