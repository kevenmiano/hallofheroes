...
export default class VipPrivilegeItem extends FUI_VipPrivilegeItem {
  ...
  public set itemData(value: PrivilegeItemData) {
    ...
    this.vipPro.text = LangManager.Instance.GetTranslation(
      "vip.vipPrivilegeWnd.title0",
      value.grade.toString(),
      value.count.toString(),
    );
    this.vipDayGift.title.text = LangManager.Instance.GetTranslation(
      "vip.vipPrivilegeWnd.title1",
      value.grade.toString(),
    );
    this.vipWelfare.title.text = LangManager.Instance.GetTranslation(
      "vip.vipPrivilegeWnd.title2",
      value.grade.toString(),
    );
    this.vipProGift.title.text = LangManager.Instance.GetTranslation(
      "vip.vipPrivilegeWnd.title3",
      value.grade.toString(),
    );

    //每日礼包
    let itemData = TempleteManager.Instance.getVipPackageByType(
      value.grade,
      -1,
    );
