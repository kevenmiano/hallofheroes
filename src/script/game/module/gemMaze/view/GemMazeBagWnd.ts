...
import { BagEvent, GemMazeEvent } from "../../../constant/event/NotificationEvent";
...
export default class GemMazeBagWnd extends BaseWindow {
    ...
    initLanguage() {
        this.frame.getChild('title').text = LangManager.Instance.GetTranslation('gemMaze.str1');
        this.btn_claim.title = LangManager.Instance.GetTranslation('gemMaze.GemMazeBagView.getAll');
    ...
    private addEvent() {
        ...
        GoodsManager.Instance.addEventListener(BagEvent.UPDATE_BAG, this.updateItemlist, this);
        GoodsManager.Instance.addEventListener(BagEvent.DELETE_BAG, this.updateItemlist, this);
    }

    private removeEvent() {
        this.btn_adjust.offClick(this, this.onAdjust);
        this.btn_claim.offClick(this, this.onClaim);
        GoodsManager.Instance.removeEventListener(BagEvent.UPDATE_BAG, this.updateItemlist, this);
        GoodsManager.Instance.removeEventListener(BagEvent.DELETE_BAG, this.updateItemlist, this);
