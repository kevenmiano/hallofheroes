...
export default class RoomHallCtrl extends FrameCtrlBase {
  ...
  public senPlayerStart() {
    ...
    if (this.roomSceneType == RoomSceneType.PVP) {
      ...
      RoomSocketOuterManager.sendStartCampaignScene(
        this.roomInfo.campaignId,
        0,
        null,
        this.data.isNoGet,
        this.data.isCross,
  ...
  public get openCrossPve2(): boolean {
    ...
    return (
      this.playerInfo &&
      this.playerInfo.isOpenCrossMutiCampaign2 &&
      this.roomSceneType == RoomSceneType.PVE
    );
  }
  ...
  public get openCrossPve(): boolean {
    ...
    return (
      this.playerInfo &&
      this.playerInfo.isOpenCrossMutiCampaign &&
      this.playerInfo.isOpenCrossMutiCampaign2 &&
      this.roomSceneType == RoomSceneType.PVE
    );
  }
  ...
  public initInviteContent(): string {
    ...
    if (this.roomSceneType == RoomSceneType.PVP) {
      ...
      if (this.roomInfo.campaignId == GlobalConfig.CampaignID.AncientRuins) {
        inviteConent = StringHelper.format(
          LangManager.Instance.GetTranslation(
