    ...
    getStr() {
        ...
        switch (this.Privilegetype) {
            case 1:
                ...
                str2 = LangManager.Instance.GetTranslation('QQ.Hall.Dawanka.voStr1', this.Para1);//'充值加赠钻石{0}%';  //Para1
                if (this.Para2 > 0) {
                    str2 += LangManager.Instance.GetTranslation('QQ.Hall.Dawanka.voStr2', this.Para2);//',每月可用优惠{0}次';  //Para2
                }
                break;
            case 2:
                str1 = LangManager.Instance.GetTranslation('QQ.Hall.Dawanka.voStr3', this.Para1);//'每月可领{0}次'; //Para1
                str2 = LangManager.Instance.GetTranslation('QQ.Hall.Dawanka.voStr4', 10, 100, 1);//'{0}元游券, 满{1}元可用*{2}';
                break;
            case 3:
            ...
            case 7:
                ...
                str2 = LangManager.Instance.GetTranslation('QQ.Hall.Dawanka.voStr15', 1);//'可领取特权卡*{0},体验下一等级权益';
                break;
            case 8:
