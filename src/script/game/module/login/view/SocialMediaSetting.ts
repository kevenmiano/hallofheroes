...
export class SocialMediaSetting extends FUI_SocialMediaSetting {
  ...
  private onInitData() {
    let listData = [];
    listData.push({
      textKey: "LoginSetting.SocialMedia.OfficialSite",
      iconName: "Btn_L2_Web",
      btnName: "btnWeb",
      URL: "https://wartunelite.wan.com/",
    });
    listData.push({
      textKey: "LoginSetting.SocialMedia.Facebook",
      iconName: "Btn_L2_Facebook",
      btnName: "btnfacebook",
      URL: "https://www.facebook.com/profile.php?id=100081484060755",
    });
    listData.push({
      textKey: "LoginSetting.SocialMedia.Discord",
      iconName: "Btn_L2_Discord",
      btnName: "btndiscord",
      URL: "https://discord.com/invite/7FxjHsg63d",
    });
    listData.push({
      textKey: "LoginSetting.SocialMedia.Twitter",
      iconName: "Btn_L2_Twitter",
      btnName: "btntwitter",
      URL: "https://twitter.com/WartuneUltra",
    });
    listData.push({
      textKey: "LoginSetting.SocialMedia.YouTube",
      iconName: "Btn_L2_YouTube",
      btnName: "btnyoutube",
      URL: "https://www.youtube.com/channel/UC9b-2u_WcNeieSRsFGcOdAQ",
    });
