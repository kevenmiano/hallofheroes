...
export default class ConsortiaBossSceneWnd extends BaseWindow {
    ...
    private initEvent() {
        this.model.addEventListener(WorldBossEvent.UPDATE_CONSORTIA_BOSS_HP, this.updateBossInfo, this);
    }

    private removeEvent() {
        this.model.removeEventListener(WorldBossEvent.UPDATE_CONSORTIA_BOSS_HP, this.updateBossInfo, this);
    }
    ...
    private updateBossInfo() {
        ...
        if (this._preHp != 0 && this._preHp - this._worldBossModel.consortiaBossCurHp > 0) this._bossInfoView.updateWorldBossHp(this._worldBossModel.consortiaBossCurHp - this._preHp);
    ...
    private updateWorldBossInfo() {
        ...
        for (const key in arr) {
            if (Object.prototype.hasOwnProperty.call(arr, key)) {
                ...
                if (WorldBossHelper.checkConsortiaBoss(CampaignManager.Instance.mapModel.mapId)) {
