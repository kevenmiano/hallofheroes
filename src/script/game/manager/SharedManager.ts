...
export class SharedManager extends GameEventDispatcher {
    ...
    try {
      ...
      if (so && so.data) {
        ...
        if (so.data["allowAttactedEffect" + this._userId] != undefined) {
          this.allowAttactedEffect =
            so.data["allowAttactedEffect" + this._userId];
        }
        ...
        if (
          so.data["consortiaGroupChatShineSwitch" + this._userId] != undefined
        ) {
          this.consortiaGroupChatShineSwitch =
            so.data["consortiaGroupChatShineSwitch" + this._userId];
        }
        ...
        if (so.data["autoReplyList" + this._userId] != undefined) {
          this._autoReplyList = so.data[
            "autoReplyList" + this._userId
          ] as Dictionary;
        }
        ...
        if (so.data["funnyOldDic" + this._userId] != undefined) {
          this._funnyOldDic = so.data[
            "funnyOldDic" + this._userId
          ] as Dictionary;
        }
        if (so.data["headIconClickDic" + this._userId] != undefined) {
          this._headIconClickDic = so.data[
            "headIconClickDic" + this._userId
          ] as Dictionary;
        }
        if (so.data["authorizDic" + this._userId] != undefined) {
          this._authorizDic = so.data[
            "authorizDic" + this._userId
          ] as Dictionary;
        }
        ...
        if (so.data["storeRefreshBinding" + this._userId] != undefined) {
          this.storeRefreshBinding =
            so.data["storeRefreshBinding" + this._userId];
        }
        ...
        if (so.data["storeLockBuyUseBind" + this._userId] != undefined) {
          this.storeLockBuyUseBind =
            so.data["storeLockBuyUseBind" + this._userId];
        }
        if (so.data["mysteryShopRefresh" + this._userId] != undefined) {
          this.mysteryShopRefresh =
            so.data["mysteryShopRefresh" + this._userId];
        }
        if (so.data["mysteryShopRefreshUseBind" + this._userId] != undefined) {
          this.mysteryShopRefreshUseBind =
            so.data["mysteryShopRefreshUseBind" + this._userId];
        }
        if (so.data["offerRewardRefresh" + this._userId] != undefined) {
          this.offerRewardRefresh =
            so.data["offerRewardRefresh" + this._userId];
        }
        ...
        if (so.data["chestCheckDate" + this._userId] != undefined) {
          this.chestCheckDate = so.data[
            "chestCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["inviteCheckDate" + this._userId] != undefined) {
          this.inviteCheckDate = so.data[
            "inviteCheckDate" + this._userId
          ] as Date;
        }
        ...
        if (so.data["qteUpgradeCheckDate" + this._userId] != undefined) {
          this.qteUpgradeCheckDate = so.data[
            "qteUpgradeCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["secretGetBuffTipCheckDate" + this._userId] != undefined) {
          this.secretGetBuffTipCheckDate = so.data[
            "secretGetBuffTipCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["demonGetBuffTipCheckDate" + this._userId] != undefined) {
          this.demonGetBuffTipCheckDate = so.data[
            "demonGetBuffTipCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["vipBoxRefreshTipCheckDate" + this._userId] != undefined) {
          this.vipBoxRefreshTipCheckDate = so.data[
            "vipBoxRefreshTipCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["demonReviveTipCheckDate" + this._userId] != undefined) {
          this.demonReviveTipCheckDate = so.data[
            "demonReviveTipCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["storeComposeCheckDate" + this._userId] != undefined) {
          this.storeComposeCheckDate = so.data[
            "storeComposeCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["resolveStrengthenCheckDate" + this._userId] != undefined) {
          this.resolveStrengthenCheckDate = so.data[
            "resolveStrengthenCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["storeSwitchCheckDate" + this._userId] != undefined) {
          this.storeSwitchCheckDate = so.data[
            "storeSwitchCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["quickInviteCheckDate" + this._userId] != undefined) {
          this.quickInviteCheckDate = so.data[
            "quickInviteCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["storeRefreshBuyCheckDate" + this._userId] != undefined) {
          this.storeRefreshBuyCheckDate = so.data[
            "storeRefreshBuyCheckDate" + this._userId
          ] as Date;
        }
        if (
          so.data["storeRefreshBindingCheckDate" + this._userId] != undefined
        ) {
          this.storeRefreshBindingCheckDate = so.data[
            "storeRefreshBindingCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["storeLockBuyCheckDate" + this._userId] != undefined) {
          this.storeLockBuyCheckDate = so.data[
            "storeLockBuyCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["starQuickSellType" + this._userId] != undefined) {
        ...
        if (
          so.data["mysteryShopRefreshCheckDate" + this._userId] != undefined
        ) {
          this.mysteryShopRefreshCheckDate = so.data[
            "mysteryShopRefreshCheckDate" + this._userId
          ] as Date;
        }
        if (
          so.data["mysteryShopRefreshUseBindDate" + this._userId] != undefined
        ) {
          this.mysteryShopRefreshUseBindDate =
            so.data["mysteryShopRefreshUseBindDate" + this._userId];
        }
        if (so.data["multiFaildedCheckDate" + this._userId] != undefined) {
          this.multiFaildedCheckDate = so.data[
            "multiFaildedCheckDate" + this._userId
          ] as Date;
        }
        if (
          so.data["buyRuneGemBagNotAlertCheckDate" + this._userId] != undefined
        ) {
          this.buyRuneGemBagNotAlertCheckDate = so.data[
            "buyRuneGemBagNotAlertCheckDate" + this._userId
          ] as Date;
        }
        ...
        if (so.data["thewCheckDate" + this._userId] != undefined) {
          this.attackCastleCheckDate = so.data[
            "attackCastleCheckDate" + this._userId
          ] as Date;
        }
        if (
          so.data["worldBossRiverTodayNeedAlertDate" + this._userId] !=
          undefined
        ) {
          this.worldBossRiverTodayNeedAlertCheckDate = so.data[
            "worldBossRiverTodayNeedAlertDate" + this._userId
          ] as Date;
        }
        if (
          so.data["worldBossPointTodayNeedAlertCheckDate" + this._userId] !=
          undefined
        ) {
          this.worldBossPointTodayNeedAlertCheckDate = so.data[
            "worldBossPointTodayNeedAlertCheckDate" + this._userId
          ] as Date;
        }
        if (
          so.data["worldBossGifttokenTodayNeedAlertCheckDate" + this._userId] !=
          undefined
        ) {
          this.worldBossGifttokenTodayNeedAlertCheckDate = so.data[
            "worldBossGifttokenTodayNeedAlertCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["refuseInvitation" + this._userId] != undefined) {
          this.refuseInvitation = Boolean(
            so.data["refuseInvitation" + this._userId],
          );
        }
        if (so.data["advDomesticateAlertDate" + this._userId] != undefined) {
          this.advDomesticateAlertDate = so.data[
            "advDomesticateAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["advDomesticateUseBind"] + this._userId != undefined) {
          this.advDomesticateUseBind =
            so.data["advDomesticateUseBind" + this._userId];
        }
        if (so.data["advDomesticateUseBind2" + this._userId] != undefined) {
          this.advDomesticateUseBind2 =
            so.data["advDomesticateUseBind2" + this._userId];
        }
        if (so.data["advDomesticateUseBindDate"] + this._userId != undefined) {
          this.advDomesticateUseBindDate =
            so.data["advDomesticateUseBindDate" + this._userId];
        }
        if (so.data["advDomesticateAlertDate2" + this._userId] != undefined) {
          this.advDomesticateAlertDate2 = so.data[
            "advDomesticateAlertDate2" + this._userId
          ] as Date;
        }
        if (so.data["pownConverAlertDate" + this._userId] != undefined) {
          this.pownConverAlertDate = so.data[
            "pownConverAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["domesticateAlertDate" + this._userId] != undefined) {
          this.domesticateAlertDate = so.data[
            "domesticateAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["completeRingTaskDate" + this._userId] != undefined) {
          this.completeRingTaskDate = so.data[
            "completeRingTaskDate" + this._userId
          ] as Date;
        }
        if (so.data["completeRingTaskUseBind" + this._userId] != undefined) {
          this.completeRingTaskUseBind =
            so.data["completeRingTaskUseBind" + this._userId];
        }
        if (so.data["petAdvanceAlertDate" + this._userId] != undefined) {
          this.petAdvanceAlertDate = so.data[
            "petAdvanceAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["domesticateAlertDate2" + this._userId] != undefined) {
          this.domesticateAlertDate2 = so.data[
            "domesticateAlertDate2" + this._userId
          ] as Date;
        }
        if (
          so.data[
            "worldBossRiverTodayNeedAlertCheckDate_enterBattle" + this._userId
          ] != undefined
        ) {
          this.worldBossRiverTodayNeedAlertCheckDate_enterBattle = so.data[
            "worldBossRiverTodayNeedAlertCheckDate_enterBattle" + this._userId
          ] as Date;
        }
        if (so.data["specialBtnHadShine" + this._userId] != undefined) {
          this.specialBtnHadShine =
            so.data["specialBtnHadShine" + this._userId];
        }
        if (so.data["talentBtnNeedShine" + this._userId] != undefined) {
          this.talentBtnNeedShine =
            so.data["talentBtnNeedShine" + this._userId];
        }
        ...
        if (so.data["difficultMazeBtnShine" + this._userId] != undefined) {
          this.difficultMazeBtnShine =
            so.data["difficultMazeBtnShine" + this._userId];
        }
        if (
          so.data["fashionComposeBindsAlertDate" + this._userId] != undefined
        ) {
          this.fashionComposeBindsAlertDate = so.data[
            "fashionComposeBindsAlertDate" + this._userId
          ] as Date;
        }
        if (
          so.data["fashionComposeBindsSoulAlertDate" + this._userId] !=
          undefined
        ) {
          this.fashionComposeBindsSoulAlertDate = so.data[
            "fashionComposeBindsSoulAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["openKingContractAlertDate" + this._userId] != undefined) {
          this.openKingContractAlertDate = so.data[
            "openKingContractAlertDate" + this._userId
          ] as Date;
        }
        if (
          so.data["fashionSwitchBindsAlertDate" + this._userId] != undefined
        ) {
          this.fashionSwitchBindsAlertDate = so.data[
            "fashionSwitchBindsAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["petNormalAdvancedAlertDate" + this._userId] != undefined) {
          this.petNormalAdvancedAlertDate = so.data[
            "petNormalAdvancedAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["petSeniorAdvancedAlertDate" + this._userId] != undefined) {
          this.petSeniorAdvancedAlertDate = so.data[
            "petSeniorAdvancedAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["memoryCardBuyAlertDate" + this._userId] != undefined) {
          this.memoryCardBuyAlertDate = so.data[
            "memoryCardBuyAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["turntableBuyAlertDate1001" + this._userId] != undefined) {
          this.turntableBuyAlertDate1001 = so.data[
            "turntableBuyAlertDate1001" + this._userId
          ] as Date;
        }
        if (so.data["turntableBuyAlertDate1002" + this._userId] != undefined) {
          this.turntableBuyAlertDate1002 = so.data[
            "turntableBuyAlertDate1002" + this._userId
          ] as Date;
        }
        if (so.data["turntableBuyAlertDate1003" + this._userId] != undefined) {
          this.turntableBuyAlertDate1003 = so.data[
            "turntableBuyAlertDate1003" + this._userId
          ] as Date;
        }
        ...
        if (so.data["offerRewardRefreshUseBind" + this._userId] != undefined) {
          this.offerRewardRefreshUseBind =
            so.data["offerRewardRefreshUseBind" + this._userId];
        }

        if (so.data["worldBossRiverUseBind" + this._userId] != undefined) {
          this.worldBossRiverUseBind =
            so.data["worldBossRiverUseBind" + this._userId];
        }
        if (so.data["worldBossBuyBuffUseBind" + this._userId] != undefined) {
          this.worldBossBuyBuffUseBind =
            so.data["worldBossBuyBuffUseBind" + this._userId];
        }
        if (
          so.data["petNormalAdvanceCanUsePetStrong" + this._userId] != undefined
        ) {
          this.petNormalAdvanceCanUsePetStrong =
            so.data["petNormalAdvanceCanUsePetStrong" + this._userId];
        }
        if (
          so.data["petSeniorAdvanceCanUsePetStrong" + this._userId] != undefined
        ) {
          this.petSeniorAdvanceCanUsePetStrong =
            so.data["petSeniorAdvanceCanUsePetStrong" + this._userId];
        }
        if (so.data["petNormalAdvanceUseBind" + this._userId] != undefined) {
          this.petNormalAdvanceUseBind =
            so.data["petNormalAdvanceUseBind" + this._userId];
        }
        if (so.data["petSeniorAdvancedUseBind;" + this._userId] != undefined) {
          this.petSeniorAdvancedUseBind =
            so.data["petSeniorAdvancedUseBind;" + this._userId];
        }
        if (so.data["petadvanceWillbeBindCheck1" + this._userId] != undefined) {
          this.petadvanceWillbeBindCheck1 =
            so.data["petadvanceWillbeBindCheck1" + this._userId];
        }
        if (so.data["petadvanceWillbeBindCheck2" + this._userId] != undefined) {
          this.petadvanceWillbeBindCheck2 =
            so.data["petadvanceWillbeBindCheck2" + this._userId];
        }
        if (so.data["petadvanceWillbeBindCheck3" + this._userId] != undefined) {
          this.petadvanceWillbeBindCheck3 =
            so.data["petadvanceWillbeBindCheck3" + this._userId];
        }
        if (so.data["petadvanceWillbeBindCheck4" + this._userId] != undefined) {
          this.petadvanceWillbeBindCheck4 =
            so.data["petadvanceWillbeBindCheck4" + this._userId];
        }
        if (so.data["petadvanceWillbeBindCheck5" + this._userId] != undefined) {
          this.petadvanceWillbeBindCheck5 =
            so.data["petadvanceWillbeBindCheck5" + this._userId];
        }
        if (so.data["petadvanceWillbeBindCheck6" + this._userId] != undefined) {
          this.petadvanceWillbeBindCheck6 =
            so.data["petadvanceWillbeBindCheck6" + this._userId];
        }

        if (
          so.data["petadvanceWillbeBindCheckDate1" + this._userId] != undefined
        ) {
          this.petadvanceWillbeBindCheckDate1 =
            so.data["petadvanceWillbeBindCheckDate1" + this._userId];
        }
        if (
          so.data["petadvanceWillbeBindCheckDate2" + this._userId] != undefined
        ) {
          this.petadvanceWillbeBindCheckDate2 =
            so.data["petadvanceWillbeBindCheckDate2" + this._userId];
        }
        if (
          so.data["petadvanceWillbeBindCheckDate3" + this._userId] != undefined
        ) {
          this.petadvanceWillbeBindCheckDate3 =
            so.data["petadvanceWillbeBindCheckDate3" + this._userId];
        }
        if (
          so.data["petadvanceWillbeBindCheckDate4" + this._userId] != undefined
        ) {
          this.petadvanceWillbeBindCheckDate4 =
            so.data["petadvanceWillbeBindCheckDate4" + this._userId];
        }
        if (
          so.data["petadvanceWillbeBindCheckDate5" + this._userId] != undefined
        ) {
          this.petadvanceWillbeBindCheckDate5 =
            so.data["petadvanceWillbeBindCheckDate5" + this._userId];
        }
        if (
          so.data["petadvanceWillbeBindCheckDate6" + this._userId] != undefined
        ) {
          this.petadvanceWillbeBindCheckDate6 =
            so.data["petadvanceWillbeBindCheckDate6" + this._userId];
        }
        if (so.data["buyPetChallengeCountDate" + this._userId] != undefined) {
          this.buyPetChallengeCountDate = so.data[
            "buyPetChallengeCountDate" + this._userId
          ] as Date;
        }
        if (so.data["buyPetChallengeCountDate2" + this._userId] != undefined) {
          this.buyPetChallengeCountDate2 = so.data[
            "buyPetChallengeCountDate2" + this._userId
          ] as Date;
        }
        ...
        if (so.data["expendCrystalAlertDate" + this._userId] != undefined) {
          this.expendCrystalCheckDate = so.data[
            "expendCrystalAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["todayFullScreenBtnShine" + this._userId] != undefined) {
          this.todayFullScreenBtnShine =
            so.data["todayFullScreenBtnShine" + this._userId];
        }
        if (so.data["currentTreasureMapId" + this._userId] != undefined) {
          this.currentTreasureMapId =
            so.data["currentTreasureMapId" + this._userId];
        }
        ...
        if (so.data["sharePetComposeBtn" + this._userId] != undefined) {
          this.sharePetComposeBtn = so.data[
            "sharePetComposeBtn" + this._userId
          ] as boolean;
        }
        if (
          so.data["singlePassBugleOpenCardUseBind"] + this._userId !=
          undefined
        ) {
          this.singlePassBugleOpenCardUseBind =
            so.data["singlePassBugleOpenCardUseBind" + this._userId];
        }
        if (
          so.data["singlePassBugleOpenCardUseBindDate"] + this._userId !=
          undefined
        ) {
          this.singlePassBugleOpenCardUseBindDate =
            so.data["singlePassBugleOpenCardUseBindDate" + this._userId];
        }
        ...
        if (so.data["addSlotUseBindDate"] + this._userId != undefined) {
          this.addSlotUseBindDate = so.data[
            "addSlotUseBindDate" + this._userId
          ] as Date;
        }
        ...
        if (so.data["starQuickSellCheckDate" + this._userId] != undefined) {
          this.starQuickSellCheckDate = so.data[
            "starQuickSellCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["secretNextLevelCheckDate" + this._userId] != undefined) {
          this.secretNextLevelCheckDate = so.data[
            "secretNextLevelCheckDate" + this._userId
          ] as Date;
        }
        ...
        if (so.data["emailReceiveTipCheckDate" + this._userId] != undefined) {
          this.emailReceiveTipCheckDate = so.data[
            "emailReceiveTipCheckDate" + this._userId
          ] as Date;
        }
        ...
        if (so.data["emailDeleteTipCheckDate" + this._userId] != undefined) {
          this.emailDeleteTipCheckDate = so.data[
            "emailDeleteTipCheckDate" + this._userId
          ] as Date;
        }
        ...
        if (
          so.data["emailBattleReadTipCheckDate" + this._userId] != undefined
        ) {
          this.emailBattleReadTipCheckDate = so.data[
            "emailBattleReadTipCheckDate" + this._userId
          ] as Date;
        }
        if (
          so.data["worldBossBuyStunmanFoCheckDate" + this._userId] != undefined
        ) {
          this.worldBossBuyStunmanFoCheckDate = so.data[
            "worldBossBuyStunmanFoCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["refreshRewardNotAlert" + this._userId] != undefined) {
          this.refreshRewardNotAlert =
            so.data["refreshRewardNotAlert" + this._userId];
        }
        if (so.data["refreshRewardUseBind" + this._userId] != undefined) {
          this.refreshRewardUseBind =
            so.data["refreshRewardUseBind" + this._userId];
        }
        if (
          so.data["quicklyRefreshRewardNotAlert" + this._userId] != undefined
        ) {
          this.quicklyRefreshRewardNotAlert =
            so.data["quicklyRefreshRewardNotAlert" + this._userId];
        }
        if (
          so.data["quicklyRefreshRewardUseBind" + this._userId] != undefined
        ) {
          this.quicklyRefreshRewardUseBind =
            so.data["quicklyRefreshRewardUseBind" + this._userId];
        }
        ...
        if (
          so.data["outercityshopFreshAlertDate" + this._userId] != undefined
        ) {
          this.outercityshopFreshAlertDate = so.data[
            "outercityshopFreshAlertDate" + this._userId
          ] as Date;
        }
        if (so.data["outercityshopFreshUseBind" + this._userId] != undefined) {
          this.outercityshopFreshUseBind = so.data[
            "outercityshopFreshUseBind" + this._userId
          ] as boolean;
        }
        if (so.data["foisonHornClick" + this._userId] != undefined) {
          this.foisonHornClick = so.data[
            "foisonHornClick" + this._userId
          ] as boolean;
        }
        ...
        if (so.data["newbieFinishNodeStr" + this._userId] != undefined) {
          this.newbieFinishNodeStr = so.data[
            "newbieFinishNodeStr" + this._userId
          ] as string;
        }
        ...
        if (so.data["tattooBaptizeCheckDate" + this._userId] != undefined) {
          this.tattooBaptizeCheckDate = so.data[
            "tattooBaptizeCheckDate" + this._userId
          ] as Date;
        }
        if (so.data["tattooUpdateCheckDate" + this._userId] != undefined) {
          this.tattooUpdateCheckDate = so.data[
            "tattooUpdateCheckDate" + this._userId
          ] as Date;
        }
      }
    } catch (e) {
  ...
  public saveFunnyExchangeTodayNeedAlert() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["funnyExchangeNotAlert" + this._userId] =
        this.funnyExhchangeNotAlert;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveWorldBossPointTodayNeedAlert() {
    try {
      ...
      let so = JSON.parse(localItem);
      so.data["worldBossPointTodayNeedAlertCheckDate" + this._userId] =
        this.worldBossPointTodayNeedAlertCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveWorldBossGifttokenTodayNeedAlert() {
    try {
      ...
      let so = JSON.parse(localItem);
      so.data["worldBossGifttokenTodayNeedAlertCheckDate" + this._userId] =
        this.worldBossGifttokenTodayNeedAlertCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveWorldBossRiverTodayNeedAlert() {
    try {
      ...
      let so = JSON.parse(localItem);
      so.data["worldBossRiverTodayNeedAlertDate" + this._userId] =
        this.worldBossRiverTodayNeedAlertCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public worldBossBuyStunmanFoDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["worldBossBuyStunmanFoCheckDate" + this._userId] =
        this.worldBossBuyStunmanFoCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveWorldBossRiverTodayNeedAlertCheckDate_enterBattle() {
    try {
      ...
      so.data[
        "worldBossRiverTodayNeedAlertCheckDate_enterBattle" + this._userId
      ] = this.worldBossRiverTodayNeedAlertCheckDate_enterBattle;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveDemonReviveTipCheck() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["demonReviveTipCheckDate" + this._userId] =
        this.demonReviveTipCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveAttackCastleCheck() {
    try {
      ...
      so.data["attackCastleCheckDate" + this._userId] =
        this.attackCastleCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
  ...
  public saveSecretGetBuffTipCheck() {
    try {
      ...
      so.data["secretGetBuffTipCheckDate" + this._userId] =
        this.secretGetBuffTipCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveDeleteFriendTipCheck() {
    try {
      ...
      so.data["deleteFriendCheckDate" + this._userId] =
        this.deleteFriendCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveVipBoxRefreshTipCheck() {
    try {
      ...
      so.data["vipBoxRefreshTipCheckDate" + this._userId] =
        this.vipBoxRefreshTipCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveDemonGetBuffTipCheck() {
    try {
      ...
      so.data["demonGetBuffTipCheckDate" + this._userId] =
        this.demonGetBuffTipCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveComposeTipCheck() {
    try {
      ...
      so.data["storeComposeCheckDate" + this._userId] =
        this.storeComposeCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveResolveStrengthenTipCheck() {
    try {
      ...
      so.data["resolveStrengthenCheckDate" + this._userId] =
        this.resolveStrengthenCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveSwitchTipCheck() {
    try {
      ...
      so.data["storeSwitchCheckDate" + this._userId] =
        this.storeSwitchCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveStarQuickSellCheck() {
    try {
      ...
      so.data["starQuickSellCheckDate" + this._userId] =
        this.starQuickSellCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveSecretNextLevelCheck() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["secretNextLevelCheckDate" + this._userId] =
        this.secretNextLevelCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveEmailReceiveCheck() {
    try {
      ...
      so.data["emailReceiveTipCheckDate" + this._userId] =
        this.emailReceiveTipCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveEmailDeleteCheck() {
    try {
      ...
      so.data["emailDeleteTipCheckDate" + this._userId] =
        this.emailDeleteTipCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveEmailBattleReadCheck() {
    try {
      ...
      so.data["emailBattleReadTipCheckDate" + this._userId] =
        this.emailBattleReadTipCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public savequickInviteTipCheck() {
    try {
      ...
      so.data["quickInviteCheckDate" + this._userId] =
        this.quickInviteCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveStoreRefreshBuyCheck() {
    try {
      ...
      so.data["storeRefreshBuyCheckDate" + this._userId] =
        this.storeRefreshBuyCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveStoreLockBuyCheck() {
    try {
      ...
      so.data["storeLockBuyCheckDate" + this._userId] =
        this.storeLockBuyCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveStoreRefreshBindingCheck() {
    try {
      ...
      so.data["storeRefreshBindingCheckDate" + this._userId] =
        this.storeRefreshBindingCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveExpendCrystalCheck() {
    try {
      ...
      so.data["expendCrystalAlertDate" + this._userId] =
        this.expendCrystalCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveMultiFailedCheck() {
    try {
      ...
      so.data["multiFaildedCheckDate" + this._userId] =
        this.multiFaildedCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public saveNotalertCheck() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["buyRuneGemBagNotAlert" + this._userId] =
        this.buyRuneGemBagNotAlert;
      so.data["buyRuneGemBagNotAlertCheckDate" + this._userId] =
        this.buyRuneGemBagNotAlertCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveTattooBaptizeCheckDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["tattooBaptizeCheckDate" + this._userId] =
        this.tattooBaptizeCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveTattooUpdateCheckDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["tattooUpdateCheckDate" + this._userId] =
        this.tattooUpdateCheckDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveCompleteRingTaskDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["completeRingTaskDate" + this._userId] =
        this.completeRingTaskDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveDomesticateAlert() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["domesticateAlertDate" + this._userId] =
        this.domesticateAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveDomesticate2Alert() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["domesticateAlertDate2" + this._userId] =
        this.domesticateAlertDate2;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public savefashionComposeBindsAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["fashionComposeBindsAlertDate" + this._userId] =
        this.fashionComposeBindsAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public savefashionComposeBindsSoulAlertDate() {
    try {
      ...
      let so = JSON.parse(localItem);
      so.data["fashionComposeBindsSoulAlertDate" + this._userId] =
        this.fashionComposeBindsSoulAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public savefashionSwitchBindsAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["fashionSwitchBindsAlertDate" + this._userId] =
        this.fashionSwitchBindsAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveOpenKingContractAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["openKingContractAlertDate" + this._userId] =
        this.openKingContractAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveBuyGemMazeTimesAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["buyGemMazeTimesAlertDate" + this._userId] =
        this.openKingContractAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveBuyGemMazeTimesUseBind() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["bugGemMazeTimesUseBind" + this._userId] =
        this.bugGemMazeTimesUseBind;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {
      //				Logger.log("Load shared object error:",e);
    }
  ...
  public savePetNormalAdvancedAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["petNormalAdvancedAlertDate" + this._userId] =
        this.petNormalAdvancedAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public savePetSeniorAdvancedAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["petSeniorAdvancedAlertDate" + this._userId] =
        this.petSeniorAdvancedAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveMemoryCardBuyAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["memoryCardBuyAlertDate" + this._userId] =
        this.memoryCardBuyAlertDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveTurntableBuyAlertDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["turntableBuyAlertDate1001" + this._userId] =
        this.turntableBuyAlertDate1001;
      so.data["turntableBuyAlertDate1002" + this._userId] =
        this.turntableBuyAlertDate1002;
      so.data["turntableBuyAlertDate1003" + this._userId] =
        this.turntableBuyAlertDate1003;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveBuyPetChallengeCountDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["buyPetChallengeCountDate" + this._userId] =
        this.buyPetChallengeCountDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveBuyPetChallengeCountDate2() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["buyPetChallengeCountDate2" + this._userId] =
        this.buyPetChallengeCountDate2;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveQuickActiveMouseWorkDate() {
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["quickActiveMouseWorkDate" + this._userId] =
        this.quickActiveMouseWorkDate;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public set fashionIdentityProgress(value: number) {
    ...
    try {
      let localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["fashionIdentityProgress" + this._userId] =
        this._fashionIdentityProgress;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveOutercityshopUseBind() {
    try {
      ...
      let so = JSON.parse(localItem);
      so.data["outercityshopFreshUseBind" + this._userId] =
        this.newbieAutoFight;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
  ...
  public saveOutercityshopFreshAlert() {
    try {
      var localItem = this.SharedObject.getItem(this.LOCAL_FILE);
      let so = JSON.parse(localItem);
      so.data["outercityshopFreshAlertDate" + this._userId] =
        this.newbieAutoFight;
      this.SharedObject.setItem(this.LOCAL_FILE, JSON.stringify(so));
    } catch (e) {}
  }
