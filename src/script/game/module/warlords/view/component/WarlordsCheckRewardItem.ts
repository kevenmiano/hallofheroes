...
export default class WarlordsCheckRewardItem extends FUI_WarlordsCheckRewardItem {
  ...
  private updateView() {
    ...
    if (this._selectedType == 0) {
      ...
      if (num == 1 || num == 2 || num == 3) {
        ...
        mountRewardInfo.picUrl =
          IconFactory.getCommonIconPath("/mount_lord.png");
        mountRewardInfo.tipData = tempInfo;
        mountRewardInfo.nameStr = LangManager.Instance.GetTranslation(
          "warlords.WarlordsCheckRewardFrame.str05",
        );
        ...
        if (num == 1) {
          ...
          appellRewardInfo.picUrl =
            IconFactory.getCommonIconPath("/lordappell.png");
          appellRewardInfo.type = WarlordsModel.REWARD_TYPE_THREE;
          appellRewardInfo.tipData = LangManager.Instance.GetTranslation(
            "warlords.WarlordsCheckRewardFrame.str06",
          );
          appellRewardInfo.nameStr = LangManager.Instance.GetTranslation(
            "warlords.WarlordsCheckRewardFrame.str06",
          );
          this._listData.push(appellRewardInfo);

          let shenxiangInfo: WarlordsRewardInfo = new WarlordsRewardInfo();
          shenxiangInfo.picUrl = IconFactory.getCommonIconPath(
            "/warlordsavatar.png",
          );
          shenxiangInfo.type = WarlordsModel.REWARD_TYPE_FOUR;
          shenxiangInfo.tipData = LangManager.Instance.GetTranslation(
            "warlords.WarlordsCheckRewardFrame.str08",
          );
          shenxiangInfo.nameStr = LangManager.Instance.GetTranslation(
            "warlords.WarlordsCheckRewardFrame.warlordsavatar",
          );
        ...
        goodsRewardInfo2.nameStr =
          goodsInfo.templateInfo.TemplateNameLang +
          " x" +
          (4000 - 200 * (this._index - 4));
      ...
      if (num == 1 || num == 2 || num == 3) {
        ...
        goodsRewardInfo4.nameStr =
          goodsInfo.templateInfo.TemplateNameLang +
          " x" +
          (2600 - 200 * (this._index - 4));
  ...
  private getWarlordMount(tempId: number): t_s_mounttemplateData {
    ...
    var originalTempInfo: t_s_mounttemplateData =
      TempleteManager.Instance.getMountTemplateById(tempId);
