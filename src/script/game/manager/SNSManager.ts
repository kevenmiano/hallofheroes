...
export class SNSManager extends GameEventDispatcher
{
    ...
    private addEvent()
    {
        ServerDataManager.listen(S2CProtocol.U_CH_SNS_UPDATED, this, this.__updateSnsInfoHandler);
    }
    ...
    private __updateSnsInfoHandler(pkg:PackageIn)
    {
        ...
        {
            let str:string = LangManager.Instance.GetTranslation("sns.SNSManager.command01");
