  ...
  loginGame() {
    ...
    if (!StringUtils.hasText(platform.toString())) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation("login.platformNotEmpty"),
      );
    ...
    if (!StringUtils.isNumeric(platform.toString())) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation("login.platformMustDigital"),
      );
      this.btnEnterGame.enabled = true;
      return;
    }
    ...
    if (!StringUtils.hasText(userName)) {
      MessageTipManager.Instance.show(
        LangManager.Instance.GetTranslation("login.usernameNotEmpty"),
      );
      this.btnEnterGame.enabled = true;
      return;
    }
    ...
    SharedManager.Instance.setProperty(
      "userName",
      this.bSaveAccount ? userName : "",
      "userNameDate",
      nowDate,
    );
    SharedManager.Instance.setProperty(
      "userPassword",
      this.bSavePwd ? password : "",
      "userPasswordDate",
      nowDate,
    );
    SharedManager.Instance.setProperty(
