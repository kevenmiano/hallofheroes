...
export default class PvpRewardsWnd extends BaseWindow {
    ...
    initText() {
        this.txt1.text = LangManager.Instance.GetTranslation('RoomList.pvp.rewards.text1');
        this.txt2.text = LangManager.Instance.GetTranslation('RoomList.pvp.rewards.text2');
        this.txt3.text = LangManager.Instance.GetTranslation('RoomList.pvp.rewards.text3');
        this.frame.title = LangManager.Instance.GetTranslation('funny.FunnyRightView.active.previewText');
    }
