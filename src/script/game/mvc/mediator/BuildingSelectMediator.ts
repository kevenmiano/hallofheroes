...
import { WorldBossHelper } from "../../utils/WorldBossHelper";
	...
	export class BuildingSelectMediator implements IMediator
	{
		...
		{
			var timeline1:TimelineMax = new TimelineMax({repeat:-1, yoyo:true, repeatDelay:0.5});
			var timeline2:TimelineMax = new TimelineMax({repeat:-1, yoyo:true, repeatDelay:0.5});
