...
export default class NewbieSpecialActionMediator {
  ...
  public static tinaTreatEffect(callback: Function, callArgs: Array<any>) {
    ...
    var armyView = mapModel.selfMemberData
      ? CampaignManager.Instance.controller.getArmyView(mapModel.selfMemberData)
      : null;
    ...
    let aniData = AnimationHelper.getSkillEffectAniData(
      AnimationEffectName.BUFF_ACTION_CURE,
    );
    ResMgr.Instance.loadRes(aniData.fullUrl, (res) => {
      if (!res) {
        Logger.warn(
          "[NewbieSpecialActionMediator]tinaTreatEffect 加载蒂娜治疗效果 失败",
        );
        return;
      }
      ...
      if (success) {
        ...
        TweenMax.to(tinaEffect, 1, {
          delay: 1,
          yoyo: true,
          repeat: 1,
          onComplete: NewbieSpecialActionMediator.tweenCompleteCall,
          onCompleteParams: [tinaEffect, true, aniData, true, null, null],
        });
        TweenMax.to(armyEffect, 1, {
          delay: 1,
          yoyo: true,
          repeat: 1,
          onComplete: NewbieSpecialActionMediator.tweenCompleteCall,
        ...
        MessageTipManager.Instance.show(
          LangManager.Instance.GetTranslation(
            "newbie.newbieBaseActionMediator.tinaUsehealed",
          ),
        );
      } else {
        Logger.warn(
          "[NewbieSpecialActionMediator]tinaTreatEffect 播放蒂娜治疗效果 失败",
        );
      }
    });
  }
   ...
   * 2.加上战争迷雾 暂时不加
   */
  public static showOutCityBattleMovie(
    callback: Function,
    callArgs: Array<any>,
  ) {
    ...
    if (_myCity != null) {
      ...
      let attackingMC: fgui.GMovieClip = fgui.UIPackage.createObject(
        EmWindow.OuterCity,
  ...
  private static __initCurrentWildLandHandler() {
    if (OuterCityManager.Instance.model.getPhysicsByXY(1080, 1280))
      OuterCityManager.Instance.model.getPhysicsByXY(1080, 1280).visible =
        false;
    if (OuterCityManager.Instance.model.getPhysicsByXY(1420, 1080))
      OuterCityManager.Instance.model.getPhysicsByXY(1420, 1080).visible =
        false;
    ...
    if (OuterCityManager.Instance.model.getPhysicsByXY(1180, 1120))
      OuterCityManager.Instance.model.getPhysicsByXY(1180, 1120).visible =
        false;
  ...
  public static getWorldMapMovie(callback: Function, callArgs: Array<any>) {
    ...
    Logger.xjy(
      "[NewbieBaseConditionMediator]TODO 获得世界地图11-20那个movieimage",
    );
  ...
  public static weaponEquipGuild(callback: Function, callArgs: Array<any>) {
    ...
    var itemView = bagFrame.getBaseBagItemByType(
    ...
    NewbieBaseActionMediator.createGuildFrame1(
      "",
      -150,
      20,
      4201,
      "1",
      4,
      itemView.displayObject,
    );
    NewbieBaseActionMediator.drawTargetOnMask(
      null,
      null,
      "",
      "1",
  ...
  public static weaponEquipGuild2(callback: Function, callArgs: Array<any>) {
    ...
    NewbieBaseActionMediator.cleanAll();
    NewbieBaseActionMediator.showMask();
    NewbieBaseActionMediator.createGuildArrow1(
      "",
      -58,
      92,
      4,
      4203,
      bagFrame["closeButton"],
    );
    NewbieBaseActionMediator.drawTargetOnMask(
      null,
      null,
  ...
  public static pawnAllocateGuild(callback: Function, callArgs: Array<any>) {
    ...
    var allocateFrame = NewbieUtils.getFrame(
    ...
    let itemView: AllocateItem = allocateFrame.SoliderList.getChildAt(
      0,
    ) as AllocateItem;
    ...
    Laya.timer.frameLoop(
      1,
      NewbieSpecialActionMediator,
      NewbieSpecialActionMediator.iconFrame,
    );
  }
  ...
  private static iconFrame(e: Event) {
    ...
    if (
      allocateFrame["allocateView"].getPawnDragCellByMasterType(1) == null ||
      allocateFrame["allocateView"].getPawnDragCellByMasterType(1)["icon"] ==
        null
    ) {
      // NewbieBaseActionMediator.setKeyboardState(null, null, "1", 2);
      NewbieSpecialActionMediator.completeCallback();
  ...
  private static gotoSoldierPawn() {
    //指引拖动枪兵图标到带兵格子
    // NewbieSpecialActionMediator.flag = 2;
  ...
  public static weaponIntensifyGuild(callback: Function, callArgs: Array<any>) {
    ...
    Laya.timer.frameLoop(
      1,
      NewbieSpecialActionMediator,
      NewbieSpecialActionMediator.__storeFrame,
    );
  ...
  private static __gotoOneItem(cell: StoreBagCell, value: number) {
    //指向铁匠铺背包中的一个item
  ...
  private static completeCallback(callback?: Function, callargs?: any[]) {
    if (callback) {
      ...
      NewbieUtils.execFunc(
        NewbieSpecialActionMediator.callback,
  ...
  private static tweenCompleteCall(
    targetObj: object,
