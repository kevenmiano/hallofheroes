...
export class GvgAddMembersWnd extends BaseWindow {
    ...
    private initView() {
        this.list_0.itemRenderer = Laya.Handler.create(this, this.onListItemRender1, null, false);
        this.list_1.itemRenderer = Laya.Handler.create(this, this.onListItemRender2, null, false);
    ...
    private setListView1() {
        this._memberList1 = ConsortiaManager.Instance.model.getSortMemberList(this._sortField, this._isReverse);
