...
export class AndroidWebviewChannel extends BaseChannel {
  ...
  constructor(id: number) {
    ...
    NotificationManager.Instance.addEventListener(
      WebViewEvent.RECEIVE_WEBVIEW_INFO,
      this.receiveWebViewData,
      this,
    );
  }
  ...
  public postGameEvent(code: number, exInfo: string = null) {
    ...
    //@ts-expect-error: webViewMethod is defined externally and not recognized by TypeScript
...
window["showWebViewAlert"] = function (info) {
  ...
  let channel: AndroidWebviewChannel =
    SDKManager.Instance.getChannel() as AndroidWebviewChannel;
  if (channel) {
    channel.showAlert(obj);
  }
};
