...
export default class FUI_ShopDiscountGoodItem extends fgui.GButton {
  ...
  public static createInstance(): FUI_ShopDiscountGoodItem {
    return <FUI_ShopDiscountGoodItem>(
      fgui.UIPackage.createObject("Shop", "ShopDiscountGoodItem")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.txtOriginalPriceDesc = <fgui.GTextField>(
      this.getChild("txtOriginalPriceDesc")
    );
