    ...
    setData(data:t_s_systemopentipsData){
        ...
        switch (data.Type) {
            ...
            case 26://命运守护
                ...
                break;
            case 27://专精
                this.loader.icon = FUIHelper.getItemURL(EmPackName.Home, 'Btn_Mastery_Stats');
                break;
            case 28://秘境
                this.loader.icon = FUIHelper.getItemURL(EmPackName.Home, 'Btn_Main_Campaign');
                break;
            case 29://时装
                this.loader.icon = FUIHelper.getItemURL(EmPackName.Home, 'Btn_Eve_Fashion');
                break;
        }
    }
