    ...
    showEffect() {
        ...
        switch (showType) {
            ...
            case EnUIShowType.POPUP://需设置界面锚点为中心点 缩放特效,初始尺寸为0.3
                ...
                Laya.Tween.to(this._view, { scaleX: 1, scaleY: 1 }, 100, undefined,
            ...
            case EnUIShowType.FROM_TOP://
                ...
                Laya.Tween.to(this._view, { y: targetY }, 250).to(this._view, { y: 0 }, 180, undefined,
                    Laya.Handler.create(this, () => {
                        this.onAddToStage();
                    }));
                break;
            case EnUIShowType.FADEIN://透明度变化 由0-1
                this._view.alpha = 0;
                Laya.Tween.to(this._view, { alpha: 1 }, 250, undefined, Laya.Handler.create(this, () => {
                    this.onAddToStage();
                }));
                break;
            default:
    ...
    hideEffect() {
        ...
        switch (showType) {
            ...
            case EnUIHideType.POP://需设置界面锚点为中心点 缩放特效,初始尺寸为0.3
                ...
                Laya.Tween.to(this._view, { scaleX: 0, scaleY: 0 }, 100, undefined,
                    Laya.Handler.create(this, () => {
                        callFunc();
                    }), 100);
                break;
            ...
            case EnUIHideType.FADEOUT://透明度变化 由0-1
                this._view.alpha = 1;
                Laya.Tween.to(this._view, { alpha: 0 }, 250, undefined, Laya.Handler.create(this, () => {
                    callFunc();
                }));
                break;
            default:
