...
export default class QQGiftManager extends GameEventDispatcher {
    ...
    public setup() {
        // this.addEvent();
        this.model.setLevelGiftDic(ConfigMgr.Instance.getDicSync(ConfigType.t_s_qqgradepackage));
    }

    public addEvent() {
        ServerDataManager.listen(S2CProtocol.U_C_QQ_GIFT_BAG, this, this.__onGiftBag);
    }
