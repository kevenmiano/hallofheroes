...
export class BaseCastle extends NodeMapPhysics {
  ...
  public state: EmOuterCityWarCastlePeriodType =
    EmOuterCityWarCastlePeriodType.None;
  ...
  public get uncontestable(): boolean {
    return (
      this._tempInfo &&
      this._tempInfo.PhysicId == GlobalConfig.OuterCity.UncontestablePhysicId
    );
  }
  ...
  public get defenceNpcTemp(): t_s_herotemplateData {
    ...
    let heroTemplateData: t_s_herotemplateData =
      ConfigMgr.Instance.getTemplateByID(ConfigType.t_s_herotemplate, heroId);
  ...
  public static getCastleStateColor(state: number) {
    ...
    switch (state) {
      case EmOuterCityWarCastlePeriodType.Peace:
        str = ColorConstant.GREEN_COLOR;
        break;
      case EmOuterCityWarCastlePeriodType.DeclareWar:
        str = ColorConstant.BLUE_COLOR;
        break;
      case EmOuterCityWarCastlePeriodType.DeclaringWar:
        str = ColorConstant.BLUE_COLOR;
        break;
      case EmOuterCityWarCastlePeriodType.Fighting:
        ...
        break;
      case EmOuterCityWarCastlePeriodType.Protected:
        str = ColorConstant.LIGHT_TEXT_COLOR;
        break;
    }
    return str;
  }
