...
export class CampaignRankManager extends GameEventDispatcher implements IManager {
    ...
    private initEvent() {
        ServerDataManager.listen(S2CProtocol.U_C_RANK_LIST, this, this.__rankListHandler);
    }
