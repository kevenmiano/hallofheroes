...
export class TimerTicker extends GameEventDispatcher implements IEnterFrame {
    ...
    constructor(delay: number, repeatCount: number = 0, tickFunc: Function = null, completeFunc: Function = null) {
        super();
