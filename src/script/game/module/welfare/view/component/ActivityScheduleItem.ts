...
export default class ActivityScheduleItem extends FUI_ActivityScheduleItem {
    ...
    protected onConstruct() {
        super.onConstruct();
        this.activityStatusTxt.text = LangManager.Instance.GetTranslation("activity.ActivityManager.command03");
        this.addEvent();
    }
    ...
    private getGetHookStatus(): number {
        ...
        for (let index = 0; index < HookManager.Instance.hookInfolist.length; index++) {
