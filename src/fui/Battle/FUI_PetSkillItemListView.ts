...
export default class FUI_PetSkillItemListView extends fgui.GComponent {
	...
	public static createInstance():FUI_PetSkillItemListView {
		return <FUI_PetSkillItemListView>(fgui.UIPackage.createObject("Battle", "PetSkillItemListView"));
	}
	...
	protected onConstruct():void {
		...
		this.itemSkill_10 = <FUI_BattleSkillItemCircle>(this.getChild("itemSkill_10"));
	}
}