...
export default class FUI_SuperGiftITitleItemCell extends fgui.GComponent {
	...
	public static createInstance():FUI_SuperGiftITitleItemCell {
		return <FUI_SuperGiftITitleItemCell>(fgui.UIPackage.createObject("Funny", "SuperGiftITitleItemCell"));
	}
	...
	protected onConstruct():void {
		...
		this.txt_lastPrice_value = <fgui.GTextField>(this.getChild("txt_lastPrice_value"));
		this.txt_nowPrice = <fgui.GTextField>(this.getChild("txt_nowPrice"));
		this.tipBtn2 = <fgui.GButton>(this.getChild("tipBtn2"));
		this.txt_nowPrice_value = <fgui.GTextField>(this.getChild("txt_nowPrice_value"));
