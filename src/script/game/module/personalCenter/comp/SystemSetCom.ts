...
export default class SystemSetCom extends FUI_SystemSetCom {
    ...
    private initData() {
        ...
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData5");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.refuseTeamInvite;
        this.listData.push(settingData);

        settingData = new SettingData();
        settingData.Type = SettingType.REFUSE_ROOM_INVITE;
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData2");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.refuseInvite;
        this.listData.push(settingData);
        //拒绝切磋邀请
        settingData = new SettingData();
        settingData.Type = SettingType.REFUSE_INVITATION;
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData6");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.refuseFamInvite;
        this.listData.push(settingData);
        //拒绝被添加好友
        settingData = new SettingData();
        settingData.Type = SettingType.REFUSE_FRIEND;
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData7");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.refuseFriend;
        this.listData.push(settingData);

        settingData = new SettingData();
        settingData.Type = SettingType.REFUSE_CONSORTIA_INVITE;
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData13");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.refuseConsortiaInvite;
        this.listData.push(settingData);
        //拒绝被查看信息
        // settingData = new SettingData();
        ...
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData15");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.isOpenSettingType5;
        this.listData1.push(settingData);

        settingData = new SettingData();
        settingData.Type = SettingType.mbSetingYW;
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData16");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.isOpenSettingType6;
        this.listData1.push(settingData);

        settingData = new SettingData();
        settingData.Type = SettingType.mbSetingFB;
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData17");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.isOpenSettingType7;
        this.listData1.push(settingData);
        ...
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData18");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.isOpenSettingType9;
        this.listData1.push(settingData);

        settingData = new SettingData();
        settingData.Type = SettingType.mbSetingDW;
        settingData.Value = LangManager.Instance.GetTranslation("SettingWnd.settingData19");
        settingData.Progress = PlayerManager.Instance.currentPlayerModel.playerInfo.isOpenSettingType10;
        this.listData1.push(settingData);
    ...
    private onSelectItem(target: any) {
        ...
        switch (itemData.Type) {
            ...
            case SettingType.REFUSE_INVITATION://拒绝切磋邀请
                SocketSendManager.Instance.reqPlayerSetting(OptType.refuseFamInvite, targetState ? 1 : 0);
                break;
            ...
            case SettingType.REFUSE_ACCESS_INFO://拒绝被查看信息
                SocketSendManager.Instance.reqPlayerSetting(OptType.refuseLookInfo, targetState ? 1 : 0);
                break;
            case SettingType.REFUSE_CONSORTIA_INVITE://
                SocketSendManager.Instance.reqPlayerSetting(OptType.refuseConsortiaInvite, targetState ? 1 : 0);
                break;
            case SettingType.mbSetingTK://
                SocketSendManager.Instance.reqPlayerSetting(OptType.mbSetingTK, targetState ? 1 : 0);
                break;
            case SettingType.mbSetingYW://
                SocketSendManager.Instance.reqPlayerSetting(OptType.mbSetingYW, targetState ? 1 : 0);
                break;
            case SettingType.mbSetingFB://
                SocketSendManager.Instance.reqPlayerSetting(OptType.mbSetingFB, targetState ? 1 : 0);
                break;
            case SettingType.mbSetingHD://
                SocketSendManager.Instance.reqPlayerSetting(OptType.mbSetingHD, targetState ? 1 : 0);
                break;
            case SettingType.mbSetingZD://
                SocketSendManager.Instance.reqPlayerSetting(OptType.mbSetingZD, targetState ? 1 : 0);
                break;
            case SettingType.mbSetingDW://
                SocketSendManager.Instance.reqPlayerSetting(OptType.mbSetingDW, targetState ? 1 : 0);
                break;
    ...
    public removeEvent(): void {
        for (let i = 0; i < this.list.numChildren; i++) {
            let btn_switch: fairygui.GButton = (this.list.getChildAt(i) as SetItem).asButton;
        ...
        for (let i = 0; i < this.list2.numChildren; i++) {
            let btn_set: fairygui.GButton = (this.list2.getChildAt(i) as SetItem1).asButton;
