        ...
        if (value) {
            ...
            if(gTemp){
                ...
                if (parseInt((gTemp.Property1 / 60).toString()) <= 0)
                    timeStr = LangManager.Instance.GetTranslation("public.needMinutes", gTemp.Property1 % 60);
                else if (gTemp.Property1 % 60 == 0)
                    timeStr = parseInt((gTemp.Property1 / 60).toString()) + LangManager.Instance.GetTranslation("public.time.hour");
                else
                    timeStr = LangManager.Instance.GetTranslation("public.needHM", parseFloat((gTemp.Property1 / 60).toString()), gTemp.Property1 % 60);
