...
// import LoaderInfo from "../../data/loader";
...
export default class DisplayLoader {
  ...
  public static get tempContext(): any {
    if (!DisplayLoader._tempContext) {
      ...
      DisplayLoader._tempContext.requestedContentParent =
        DisplayLoader._tempContainer;
      DisplayLoader._tempContext.allowCodeImport = true;
    }
  ...
  public loadFromBytes(data: ByteArray, $info: any) {
    this._info = $info;
    data.position = 0;
