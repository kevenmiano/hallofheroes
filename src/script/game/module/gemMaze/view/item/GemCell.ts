 ...
 */
 export default class GemCell extends FUI_GemCell{
    ...
    {
        this.movie = FUIHelper.createFUIInstance('GemMaze', "asset.GemMaze.GemAction_" + this.gemInfo.type) as fgui.GMovieClip;
        this.movie.playing = false;
        this.addChild(this.movie);
        this._lightMc = FUIHelper.createFUIInstance('GemMaze', "asset.GemMaze.GemLight") as fgui.GMovieClip;
        this._lightMc.playing = false;
    ...
    */		
    ...
    {
        TweenMax.to(this, this.MOVE_TIME, {x:_x, y:_y, onComplete:this.onMoveComplete} );
    }
    
    private onMoveComplete():void
    {			
        GemMazeManager.Instance.dispatchEvent(GemMazeEvent.GEMMAZE_GEM_ACTION_COMPLETE,this);
    }
    ...
    public playAni():void
    {
        this.movie.setPlaySettings(0, -1, 1, -1, Laya.Handler.create(this, this.playEnd));   
