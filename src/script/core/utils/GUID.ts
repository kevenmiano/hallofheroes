...
//			var id3:string = System.capabilities.serverString;
    ...
    private core_sha1(x:Array<any>, len:number):Array<any> {
        ...
        x[((len+64 >> 9) << 4)+15] = len;
        var w:Array<any> = new Array(80), a:number = 1732584193;
        ...
        for (var i:number = 0; i<x.length; i += 16) {
            ...
            for (var j:number = 0; j<80; j++) {
                ...
                var t:number = this.safe_add(this.safe_add(this.rol(a, 5), this.sha1_ft(j, b, c, d)), this.safe_add(this.safe_add(e, w[j]), this.sha1_kt(j)));
                e = d; d = c;
                c = this.rol(b, 30);
                b = a; a = t;
            }
