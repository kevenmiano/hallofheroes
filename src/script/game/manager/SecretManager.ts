...
export class SecretManager {
  ...
  public static get Instance(): SecretManager {
    if (SecretManager._instance == null)
      SecretManager._instance = new SecretManager();
  ...
  private initEvent() {
    ServerDataManager.listen(
      S2CProtocol.U_C_SECRET_INFO,
      this,
      this.onSecretInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_SECRET_LAYER_INFO,
      this,
      this.onSecretRecordInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_SECRET_GET_TREASURE,
      this,
      this.onSecretTresureHandler,
    );
  }
  ...
  public sendCreateRoom(
    capacity: number,
    secretId: number,
    enterType: SecretEnterType,
    startType: SecretStartType,
  ) {
    RoomListSocketOutManager.sendCreateSecretRoom(
      capacity,
      secretId,
      enterType,
      startType,
