...
export class OuterCityMainBuidingLayer extends Sprite implements Disposeable {
    ...
    public static NAME: string = "map.outercity.view.layer.OuterCityMainBuidingLayer";
    ...
    private initRegister(): void {
        ...
        this._mediatorKey = MediatorMananger.Instance.registerMediatorList(arr, this, OuterCityMainBuidingLayer.NAME);
    }

    public set mapData(data: MapInfo) {
        this._model = <OuterCityModel>data;
        this._model.addEventListener(OuterCityEvent.CURRENT_CASTLES, this.__initCurrentCastlesHandler, this);
        ...
        this._model.addEventListener(OuterCityEvent.REMOVE_NODE_MOVIE, this.__removeNodeHandler, this);
        this._model.addEventListener(OuterCityEvent.REMOVE_CASTLE, this.__removeCastleHandler, this);
        NotificationManager.Instance.addEventListener(OuterCityEvent.UPDATE_TREASURE_INFO, this.updateTreasureInfo, this);
        NotificationManager.Instance.addEventListener(OuterCityEvent.UPDATE_SECOND_NODE_SELE_DATA, this.updateWildInfo, this);
    }
    ...
    private __initCurrentCastlesHandler(arr: any[]): void {
        ...
        NotificationManager.Instance.dispatchEvent(OuterCityEvent.ADD_DENSEFOG_BY_BUILD, itemArr);
    }
    ...
    private __initCurrentWildLandHandler(arr: any[]): void {
        ...
        for (let i = 0; i < len; i++) {
            ...
            if (wl.info.types == PosType.RESOURCE
        ...
        this.outSceneMovies();
        NotificationManager.Instance.dispatchEvent(OuterCityEvent.ADD_DENSEFOG_BY_MINE, arr);
    }
    ...
    private addWildLand(wl: WildLand) {
        ...
        if (isAdd && wl.info.state == NodeState.EXIST || wl.info.state == NodeState.FIGHTING)//添加新的野地
        {
    ...
    public dispose(): void {
        ...
        if (this._model) {
            ...
            this._model.removeEventListener(OuterCityEvent.CURRENT_CASTLES, this.__initCurrentCastlesHandler, this);
            this._model.removeEventListener(OuterCityEvent.CURRENT_CONFIG_CHANGE, this.__moviesHandler, this);
            this._model.removeEventListener(OuterCityEvent.REMOVE_NODE_MOVIE, this.__removeNodeHandler, this);
            this._model.removeEventListener(OuterCityEvent.REMOVE_CASTLE, this.__removeCastleHandler, this);
            NotificationManager.Instance.removeEventListener(OuterCityEvent.UPDATE_TREASURE_INFO, this.updateTreasureInfo, this);
            NotificationManager.Instance.removeEventListener(OuterCityEvent.UPDATE_SECOND_NODE_SELE_DATA, this.updateWildInfo, this);
