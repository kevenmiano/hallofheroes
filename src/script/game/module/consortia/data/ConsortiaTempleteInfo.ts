...
export class ConsortiaTempleteInfo extends GameEventDispatcher
{
    ...
    {
        return TempleteManager.Instance.getConsortiaTempleteByTypeAndLevel(this.type, this.level);
    }
    ...
    public get nextTemplateInfo():t_s_consortialevelData
    {
        ...
        return TempleteManager.Instance.getConsortiaTempleteByTypeAndLevel(this.type, this.level + 1);
    }
