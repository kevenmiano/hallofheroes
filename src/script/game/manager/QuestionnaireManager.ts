...
export default class QuestionnaireManager extends GameEventDispatcher {
    ...
    private __getQuestionnaireHandler(pkg: PackageIn) {
        ...
        var msg: QuestionnarieInfoMsg = pkg.readBody(QuestionnarieInfoMsg) as QuestionnarieInfoMsg;
        ...
        QuestionnaireManager.Instance.model.questionNaireRedpoint = this.model.questionnaireVisible;
        this.model.questionGoodList = new Array();
    ...
    private __getAnswerHandler(pkg: PackageIn) {
        var msg: QuestionDataRspMsg = pkg.readBody(QuestionDataRspMsg) as QuestionDataRspMsg;
     ...
     */
    public sendQuestionAnswer(isFirst: number, id: number = 0, infoList: Array<any> = null) {
