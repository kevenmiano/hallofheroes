...
export class CampaignOverTransaction extends TransactionBase {
  ...
  public handlePackage() {
    ...
    let campaignTemp: t_s_campaignData = ConfigMgr.Instance.getTemplateByID(
      ...
      this.mapModel.mapTempInfo.CampaignId,
    );
    ...
    if (flag) {
      Logger.info(
        "[CampaignOverTransaction]退出房间 军队的主键id:",
        this.currentArmyId,
      );
