 ...
 */
 export default class RuneGemBag_S extends FUI_RuneBagCom_S{
    ...
    private updateBagGrid(){
        ...
        let arr = str.split(',');
        this.openGridNum = Number(arr[0]) + PlayerManager.Instance.currentPlayerModel.playerInfo.runeGemBagCount ;
    ...
    onCloseBag(){
        NotificationManager.Instance.dispatchEvent(RuneEvent.SHOW_INLAY_RUNE_BAG,0);
    }
