...
export class NumericProgressStepper extends FUI_NumericProgressStepper {
     ...
     */
    public show(type: number = 0, initValue: number = 1, min: number = 1, max: number = 1, limit: number = 1, step: number = 1, changeHandler: Laya.Handler, stepHandler?: Laya.Handler, inputHandler?: Laya.Handler) {
        this._type = type;
    ...
    private initEvent() {
        ...
        this.progress.on(fairygui.Events.STATE_CHANGED, this, this.__onSilderchange);
    }
    ...
    private updateBtnState() {
        this._value <= this._min ? this.btn_reduce.enabled = false : this.btn_reduce.enabled = true;
        this._value >= this._max ? this.btn_plus.enabled = false : this.btn_plus.enabled = true;
    ...
    private removeEvent() {
        ...
        this.progress.off(fairygui.Events.STATE_CHANGED, this, this.__onSilderchange);
    }
