...
export default class FUI_MazeShopView extends fgui.GComponent {
  ...
  public DescribleTxt: fgui.GComponent;
  ...
  public static URL: string = "ui://qcwdul6nps0b2v";

  public static createInstance(): FUI_MazeShopView {
    return <FUI_MazeShopView>(
      fgui.UIPackage.createObject("Shop", "MazeShopView")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.DescribleTxt = <fgui.GComponent>this.getChild("DescribleTxt");
    ...
    this.txtIntensifyLevel = <fgui.GTextField>(
      this.getChild("txtIntensifyLevel")
    );
