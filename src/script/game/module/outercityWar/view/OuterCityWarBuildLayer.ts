...
import { SequenceList, ActionsExecutionMode } from "../../../../core/task/SequenceList";
import Utils from "../../../../core/utils/Utils";
import { DisplayObject } from "../../../component/DisplayObject";
import { OuterCityWarEvent } from "../../../constant/event/NotificationEvent";
import { NotificationManager } from "../../../manager/NotificationManager";
import CastleConfigUtil, { EmCastlePos } from "../../../map/castle/utils/CastleConfigUtil";
...
export class OuterCityWarBuildLayer extends DisplayObject {
    ...
    private initBuild() {
        this._loadBuildTaskMgr = new SequenceList(ActionsExecutionMode.RunInSequence);
        ...
        for (let info of this.fightModel.buildingInfoMap.values()) {
            ...
            let pos: Laya.Point = CastleConfigUtil.Instance.getBuildPos(sonType, EmCastlePos.OuterCityWar);
            this.addChild(view);
            view.x = pos.x
            view.y = pos.y;
        ...
        this._loadBuildTaskMgr.setComplete(new Laya.Handler(this, this.loadComplete));
