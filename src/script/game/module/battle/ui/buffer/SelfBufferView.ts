...
export class SelfBufferView {
    ...
    private initEvent() {
        this.roleInfo.addEventListener(RoleEvent.REFRESH_BUFFER, this.updateBufferData, this);
        this.roleInfo.addEventListener(RoleEvent.REFRESH_BUFFER_TURN, this.refreshBufferViewTurn, this);
    }

    private removeEvent() {
        this.roleInfo.removeEventListener(RoleEvent.REFRESH_BUFFER, this.updateBufferData, this);
        this.roleInfo.removeEventListener(RoleEvent.REFRESH_BUFFER_TURN, this.refreshBufferViewTurn, this);
    }
