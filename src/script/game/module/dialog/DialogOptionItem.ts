...
import { NotificationEvent, RingTaskEvent } from "../../constant/event/NotificationEvent";
 ...
 */
    ...
    private addEvent() {
        ...
        RingTaskManager.Instance.addEventListener(RingTaskEvent.ADDRINGTASK, this.__showTalkNext, this);
    }
    ...
    private __optionBtnClickHandler(evt: MouseEvent) {
        ...
        if (this._level > ArmyManager.Instance.thane.grades) {
            MessageTipManager.Instance.show(LangManager.Instance.GetTranslation("store.view.StoreFrame.command01", this._level));
            return;
        }
        switch (this._type) {
            case 1:
            ...
            case DialogOptionItem.TREASURE_MAP:
                ...
                if (TaskManage.Instance.IsTaskFinish(TaskManage.TTREASURE_MAP_TASK)) {
                    ...
                    let alertStr: string = TaskManage.Instance.getTaskByID(TaskManage.TTREASURE_MAP_TASK).TitleLang;
                    MessageTipManager.Instance.show(LangManager.Instance.GetTranslation("task.isTaskCommit.Alert", alertStr));
                    return;
                }
                break;
            ...
            case DialogOptionItem.RING_TASK:
                ...
                if (ArmyManager.Instance.thane.grades >= 35) {
                    ...
                    MessageTipManager.Instance.show(LangManager.Instance.GetTranslation("map.space.view.frame.DialogOptionItem.Level"));
                }
                break;
            case 12:
                UIManager.Instance.HideWind(EmWindow.SpaceDialogWnd);
                SwitchPageHelp.skipPageByTaskCondictionType(RingTaskManager.Instance.getRingTask(), null, null);
                break;
            ...
            case DialogOptionItem.PET_CAMPAIGN:
                if (ArmyManager.Instance.thane.grades < OpenGrades.PET_CAMPAIGN) {
                    MessageTipManager.Instance.show(LangManager.Instance.GetTranslation("map.sapce.view.frame.DialogOptionItem.petCampaignTips", OpenGrades.PET_CAMPAIGN));
                    return;
                }
            ...
            case DialogOptionItem.REMOTEPET:
                if (ArmyManager.Instance.thane.grades < OpenGrades.REMOTEPET) {
                    MessageTipManager.Instance.show(LangManager.Instance.GetTranslation("map.sapce.view.frame.DialogOptionItem.remotePetTips", OpenGrades.REMOTEPET));
                    return;
                }
    ...
    private removeEvent() {
        ...
        RingTaskManager.Instance.removeEventListener(RingTaskEvent.ADDRINGTASK, this.__showTalkNext, this);
    }
