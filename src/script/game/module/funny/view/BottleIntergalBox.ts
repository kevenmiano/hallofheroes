 ...
 * @ver 1.0
 */
export class BottleIntergalBox extends FUI_BottleIntergalBox implements FunnyContent
{
    //@ts-ignore
    ...
    public refreshStatus():void
    {
        ...
        if(userInfo && userInfo.userId > 0 && userInfo.state == 0 && userInfo.userName == this.playerInfo.nickName)//可领取
        {
