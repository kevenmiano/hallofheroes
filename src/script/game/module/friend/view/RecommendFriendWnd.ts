...
export class RecommendFriendWnd extends BaseWindow {
    ...
    private initEvent() {
        FriendManager.getInstance().addEventListener(TimerEvent.TIMER, this.onTimer, this);
    ...
    private removeEvent() {
        FriendManager.getInstance().removeEventListener(TimerEvent.TIMER, this.onTimer, this);
