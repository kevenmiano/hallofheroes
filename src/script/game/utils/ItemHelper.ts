...
export class ItemHelper
{
    ...
    public static readGoodsInfo2(itemMsg:SimpleItemInfoMsg, goods:GoodsInfo):GoodsInfo
    {
        if(!itemMsg)
        {
            return goods;
    ...
    public static createChatItemInfoMsg(goods:GoodsInfo, name:string):ChatItemInfoMsg
    {
