...
export default class FUI_GoldenTreeView extends fgui.GComponent {
  ...
  public static createInstance(): FUI_GoldenTreeView {
    return <FUI_GoldenTreeView>(
      fgui.UIPackage.createObject("Funny", "GoldenTreeView")
    );
  }

  protected onConstruct(): void {
    this.txt_currentCount = <fgui.GRichTextField>(
      this.getChild("txt_currentCount")
    );
    ...
    this.txt_currOpenNum = <fgui.GRichTextField>(
      this.getChild("txt_currOpenNum")
    );
    ...
    this.bottomIntergalBox1 = <FUI_BottleBottomIntergalBox>(
      this.getChild("bottomIntergalBox1")
    );
    this.bottomIntergalBox2 = <FUI_BottleBottomIntergalBox>(
      this.getChild("bottomIntergalBox2")
    );
    this.bottomIntergalBox3 = <FUI_BottleBottomIntergalBox>(
      this.getChild("bottomIntergalBox3")
    );
    this.bottomIntergalBox4 = <FUI_BottleBottomIntergalBox>(
      this.getChild("bottomIntergalBox4")
    );
    this.bottomIntergalBox5 = <FUI_BottleBottomIntergalBox>(
      this.getChild("bottomIntergalBox5")
    );
  }
}
