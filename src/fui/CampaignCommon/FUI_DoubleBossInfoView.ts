...
export default class FUI_DoubleBossInfoView extends fgui.GComponent {
  ...
  public static createInstance(): FUI_DoubleBossInfoView {
    return <FUI_DoubleBossInfoView>(
      fgui.UIPackage.createObject("CampaignCommon", "DoubleBossInfoView")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.txtRBossTitleName2 = <fgui.GTextField>(
      this.getChild("txtRBossTitleName2")
    );
    ...
    this.txtRBossTitleName1 = <fgui.GTextField>(
      this.getChild("txtRBossTitleName1")
    );
