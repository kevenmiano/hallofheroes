...
export class ConsortiaRecruitMemberWnd extends BaseWindow {
  ...
  private initView() {
    ...
    this.txtTip1.text = "";
    this.txtTip2.text = StringHelper.repHtmlTextToFguiText(
      LangManager.Instance.GetTranslation(
        "consortia.view.myConsortia.chairmanPath.RecruitMemberFrame.describe",
        speakTimes,
      ),
    );
    this.tfInputPrefix.touchable = false;
    this.tfInputPrefix.text = LangManager.Instance.GetTranslation(
      "consortia.view.myConsortia.chairmanPath.RecruitMemberFrame.text",
    );
    this.txtFrameTitle.text = LangManager.Instance.GetTranslation(
      "consortia.view.myConsortia.chairmanPath.ConsortiaChairmanPath.command04",
    );
    this.__onTxtChange();
  }
