...
import LangManager from '../../core/lang/LangManager';
	...
	export class CommonConstant
	{
		...
		/**物品品质框*/
		public static QUALITY_RES = ["Icon_Box_White", "Icon_Box_Green", "Icon_Box_Blue",
			"Icon_Box_Purple", "Icon_Box_Golden", "Icon_Box_Red", "Icon_Box_Fashion"];
		/**角色框背景*/
		public static FIGURE_BG_RES = ["Img_RoleBg_Knight", "Img_RoleBg_Archer", "Img_RoleBg_Mage"];
		/**镶嵌宝石*/
