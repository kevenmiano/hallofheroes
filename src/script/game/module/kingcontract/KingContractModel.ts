...
export class KingContractModel {
  ...
  /** 界面显示的顺序 */
  public static SORT_ARR: any[] = [
    KingContractModel.TREAT_BUFF,
    KingContractModel.MOPUP_BUFF,
    KingContractModel.REWARD_BUFF,
    KingContractModel.TIME_BUFF,
    KingContractModel.SPECIAL_BUFF,
    KingContractModel.SHOP_BUFF,
  ];
  ...
  public getInfoById(id: number = 0): KingContractInfo {
    if (!this._kingContractInfos[id]) {
      ...
      let temp: t_s_kingcontractData = ConfigMgr.Instance.getTemplateByID(
