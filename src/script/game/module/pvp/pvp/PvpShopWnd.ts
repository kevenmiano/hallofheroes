...
export default class PvpShopWnd extends BaseWindow {
    ...
    OnShowWind() {
        ...
        this.frame.getChild('title').text = LangManager.Instance.GetTranslation("pvproomlist.view.AthleticsShopFrame.title");
    ...
    updateBagPage() {
        ...
        this.PageNumTxt.text = (this.ItemList.scrollPane.currentPageX + 1) + "/" + this.shopModel.totalPage;
    }
