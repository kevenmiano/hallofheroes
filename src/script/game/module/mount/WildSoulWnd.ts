...
export default class WildSoulWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.addEvent();
        this.valueTxt.setVar('count', this.curMountInfo.soulScore.toString()).flushVars();
    ...
    private addEvent() {
        ...
        this.avatarList.addEventListener(MountsEvent.MOUNT_LIST_CHANGE, this.__onListChange, this);
        NotificationManager.Instance.addEventListener(NotificationEvent.CLOSE_MOUNT_REFINING_WND, this.__onListChange, this);
    }
    ...
    private removeEvent() {
        ...
        this.avatarList.removeEventListener(MountsEvent.MOUNT_LIST_CHANGE, this.__onListChange, this);
        NotificationManager.Instance.removeEventListener(NotificationEvent.CLOSE_MOUNT_REFINING_WND, this.__onListChange, this);
    }
    ...
    private setDefaultSelected() {
        ...
        //viptab页签是否展示
        this.vipCtrl.selectedIndex = this.avatarList.getMountTemplatesByType(5).length > 0 ? 1 : 0;
    }
    ...
    private onTabChanged(cc: fgui.Controller) {
        ...
        if (!this.cacheArray[tabIndex]) {
            this.cacheArray[tabIndex] = this.avatarList.getMountTemplatesByType(tabIndex)
        }
