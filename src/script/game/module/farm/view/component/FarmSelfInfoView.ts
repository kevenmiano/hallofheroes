...
import { FarmEvent, ResourceEvent } from "../../../../constant/event/NotificationEvent";
...
export class FarmSelfInfoView extends BaseFguiCom {
	...
	private __gradeChanged(event: FarmEvent) {
		if (this._data) {
			this.levelTxt.text = LangManager.Instance.GetTranslation("public.level3", this._data.grade);
