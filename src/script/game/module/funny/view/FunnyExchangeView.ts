...
*/
export default class FunnyExchangeView extends FUI_FunnyExchangeView implements FunnyContent {
    ...
    renderBoxList(index: number, item: ConsumoCalcItem) {
        ...
        item.info = this.awardLists[index] as FunnyData;
    }
