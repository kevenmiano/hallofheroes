...
export default class CarnivalManager extends GameEventDispatcher {
  ...
  public setup() {
    ...
    ServerDataManager.listen(
      S2CProtocol.U_C_CARNIVAL_DATA,
      this,
      this.__activeInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_CARNIVAL_TASK_DATA,
      this,
      this.__taskInfoHandler,
    );
    ServerDataManager.listen(
      S2CProtocol.U_C_TOP_TOOL_BTN,
      this,
      this.__topBtnHandler,
    );
  }
