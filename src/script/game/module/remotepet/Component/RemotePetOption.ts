...
export class RemotePetOption extends FUI_RemotePetOption {
    ...
    protected onConstruct(): void {
        ...
        this.petList.itemRenderer = Laya.Handler.create(this, this.onRender, null, false);
        this._remoteWearyCost = parseInt(ConfigInfoManager.Instance.getPetRemoteWeary());
    }
    ...
    private checkPetCount():boolean{
        let flag:boolean = false;
        let indexArr:Array<string> = this.playerInfo.petChallengeIndexFormation.split(",");
