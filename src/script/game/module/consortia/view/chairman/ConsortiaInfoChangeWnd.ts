...
export default class ConsortiaInfoChangeWnd extends BaseWindow {
  ...
  private initView() {
    ...
    this.txtTip1.text = LangManager.Instance.GetTranslation(
      "ConsortiaInfoChangeWnd.txtTip1",
    );
    this.txtTip2.text = "";
    this.tfInputPrefix.touchable = false;
    this.tfInputPrefix.text = LangManager.Instance.GetTranslation(
      "ConsortiaInfoChangeWnd.tfInputPrefix",
    );
    this.txtFrameTitle.text = LangManager.Instance.GetTranslation(
      "ConsortiaInfoChangeWnd.txtFrameTitle",
    );
    this.__onTxtChange();
  }
