...
export default class FUI_LuckyExchangeView extends fgui.GComponent {
	...
	public static createInstance():FUI_LuckyExchangeView {
		return <FUI_LuckyExchangeView>(fgui.UIPackage.createObject("Funny", "LuckyExchangeView"));
	}
	...
	protected onConstruct():void {
		...
		this.activityTimeDescTxt = <fgui.GTextField>(this.getChild("activityTimeDescTxt"));
		this.activityTimeValueTxt = <fgui.GTextField>(this.getChild("activityTimeValueTxt"));
