...
export class GvgEnterWarItem extends FUI_GvgEnterWarItem
{
    ...
    private onDelBtnClick():void
    {
        ...
        this._controller.sendGvgTeamEdit(this._info.userId, GvgTeamEditType.REMOVE_TEAM, GvgTeamEditType.CANNEL_MANAGER);
    ...
    set info(value:ThaneInfo)
    {
        ...
        if(this._info)
        {
            this._captionIcon.visible = (this._info.dutyId == 1 || this._info.dutyId == 2);
            ...
            this.txt_state.text = (this._info.isInwar == 0 ? "—" : LangManager.Instance.GetTranslation("gvg.view.EnterWarrightitem"));
            ...
            this._delBtn.visible = (this._info.userId != chairmanID && this._controller.model.isFightManager);
            this.state.selectedIndex = this._info.isOnline ? 0 : 1;
