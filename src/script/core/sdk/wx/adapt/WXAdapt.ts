        ...
        if (window.wx) {
            wx.getSystemInfo({
                success: (res: any)=> {
                    ...
                    this.rightSafe = (res.windowWidth - menuRect.left - 0.25 * menuRect.height) * wr;
                    ...
                    Logger.log('XXXX', Laya.stage.width, Laya.stage.height, res.windowWidth, res.windowHeight, res.safeArea);
                    ...
                    if (res.safeArea.width != res.windowWidth) {
                        ...
                        if (res.safeArea.left > 0) {
                            ...
                            Resolution.onMiniGameStatusBar(this.statusBarHeight, this.statusBarHeight, 1);
                        } else {
                            //刘海右 home键左
                            this.statusBarHeight = (res.windowWidth - res.safeArea.width) * wr;
        ...
        if (window.wx) {
            ...
            wx.onDeviceOrientationChange((res) => {
                    ...
                    if (res.value == 'landscape') {
                        Resolution.onMiniGameStatusBar(this.statusBarHeight, this.rightSafe, 1);
                    } else {
                        Resolution.onMiniGameStatusBar(0, this.rightSafe, 3);
                    }
