...
export class Geometry {
    public static getAngle4(p1x: number, p1y: number, p2x: number, p2y: number): number {
    ...
    public static nextPoint2(px: number, py: number, angle: number, distance: number): Point {
    ...
    public static crossAngle(firstAngle: number, secondAngle: number): number {
        return Geometry.standardAngle(Geometry.standardAngle(firstAngle) - Geometry.standardAngle(secondAngle));
    }
    ...
    public static cross_x(x11: number, y11: number, x12: number, y12: number, x21: number, y21: number, x22: number, y22: number): number {
        ...
        let _local14: number = (_local11 - _local13) / ((_local12 * _local11) - (_local10 * _local13));
        return (_local14);
    };

    public static cross_y(x11: number, y11: number, x12: number, y12: number, x21: number, y21: number, x22: number, y22: number): number {
        let _local10: number = (y11 - y12) / ((x12 * y11) - (x11 * y12));
        let _local11: number = (x12 - x11) / ((x12 * y11) - (x11 * y12));
        let _local12: number = (y21 - y22) / ((x22 * y21) - (x21 * y22));
        let _local13: number = (x22 - x21) / ((x22 * y21) - (x21 * y22));
        let _local14: number = (_local10 - _local12) / ((_local13 * _local10) - (_local11 * _local12));
        return (_local14);
    }

    public static crossPoint2D(x11: number, y11: number, x12: number, y12: number, x21: number, y21: number, x22: number, y22: number): Point {
        let _local10: number = (y11 - y12) / ((x12 * y11) - (x11 * y12));
        let _local11: number = (x12 - x11) / ((x12 * y11) - (x11 * y12));
        let _local12: number = (y21 - y22) / ((x22 * y21) - (x21 * y22));
        let _local13: number = (x22 - x21) / ((x22 * y21) - (x21 * y22));
        let _local14: number = (_local11 - _local13) / ((_local12 * _local11) - (_local10 * _local13));
        let _local15: number = (_local10 - _local12) / ((_local13 * _local10) - (_local11 * _local12));
