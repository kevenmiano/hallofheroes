...
export default class listMsgItem extends FUI_listMsgItem implements ITipedDisplay {
    ...
    private refreshView() {
        this._cellVector = [];
        this._cellVector = this._cellVector.concat(ChatFormat.getContentCellData(this._chatData));
