...
export class ChatChannel {
  ...
  public static getChatChannelName(channel: number): string {
    switch (channel) {
      case ChatChannel.CROSS_BIGBUGLE:
        return LangManager.Instance.GetTranslation(
          "chat.datas.getChatChannelName.CrossBUGLE",
        );
        break;
      ...
      case ChatChannel.INFO:
        return LangManager.Instance.GetTranslation(
          "chat.datas.getChatChannelName.INFO",
        );
        break;
      ...
      case ChatChannel.CURRENT:
        return LangManager.Instance.GetTranslation(
          "chat.view.ChatInputView.channel",
        );
        break;
      case ChatChannel.NOTICE:
        return LangManager.Instance.GetTranslation(
          "chat.view.ChatInputView.NOTICE",
        );
        break;
    ...
    return LangManager.Instance.GetTranslation(
      "chat.datas.getChatChannelName.UNKNOWN",
    );
  }
  ...
  public static getChannelFormat(channel: number): any {
    //用户可以输入的频道: 当前, 组队, 公会, 世界, 大喇叭
  ...
  public static getEmojiIconUrl(index: number): string {
    ...
    iconUrl =
      "<img src='res/game/face/" +
      iconUrl +
      "'" +
      " width='45px' height='45px'></img>";
    return iconUrl;
