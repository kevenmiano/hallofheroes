...
export default class DebugModule {
  ...
  public static get Instance(): DebugModule {
    return this._instance
      ? this._instance
      : (this._instance = new DebugModule());
  }
  ...
  private initView() {
    this.view = fgui.UIPackage.createObject(
      EmPackName.Debug,
      "Debug",
    ) as fgui.GComponent;
    ...
    this.txtNewbie = this.view
      .getChild("tfNewbie")
      .asCom.getChild("userName").asLabel;
    this.btnNewbie = this.view.getChild("btnNewbie").asButton;
    this.btnNewbie.onClick(null, () => {});

    this.txtEventType = this.view
      .getChild("tfEventType")
      .asCom.getChild("userName").asLabel;
