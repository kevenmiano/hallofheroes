...
export class FilterFrameText extends Laya.Text {
    static Colors = {
        ...
        [eFilterFrameText.AvatarName]: ["#ffffff", "#9ffb4e", "#00f0ff", "#ffdc57", "#ff2e2e", "#fff600"],
        // 白 绿 蓝 紫 橙 红
        [eFilterFrameText.PetQuality]: ["#ffffff", "#59cd41", "#32a2f8", "#c300ff", "#ff9600", "#ce0f0f"],
        // 白 绿 蓝 紫 橙 红
        [eFilterFrameText.ItemQuality]: ["#ffffff", "#59cd41", "#32a2f8", "#a838f7", "#ff8000", "#ce0f0f", "#ce0f0f"],
        // 白 绿 蓝 紫 橙 红
        [eFilterFrameText.StarQuality]: ["#ffffff", "#59cd41", "#32a2f8", "#a838f7", "#ff8000", "#ce0f0f", "#ce0f0f"],
        // 绿 蓝 紫 橙
        [eFilterFrameText.TreasureMapQuality]: ["#59cd41", "#32a2f8", "#c300ff", "#ff9600"]
    }

    //默认, 天空之城npc
    static baseStrokeColor = ["#000000", "#7a3b10"]

    constructor(w: number, h: number, font = Laya.Text.defaultFont, fontSize: number = 18, color = "#ffffff", align: string = "center", valign = "middle", anchorX = 0.5, anchorY = 0, defStroke: boolean = true, defGlow: boolean = true) {
        super()
