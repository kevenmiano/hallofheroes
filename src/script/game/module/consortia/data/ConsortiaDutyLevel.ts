...
export class ConsortiaDutyLevel {
    ...
    switch (level) {
      case ConsortiaDutyLevel.CHAIRMAN:
        str = LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.chairmanPath.ConsortiaPermissionFrame.name00",
        );
        break;
      case ConsortiaDutyLevel.VICE_CHAIRMAN:
        str = LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.chairmanPath.ConsortiaPermissionFrame.name01",
        );
        break;
      case ConsortiaDutyLevel.OFFICIAL:
        str = LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.chairmanPath.ConsortiaPermissionFrame.name02",
        );
        break;
      case ConsortiaDutyLevel.ELITE:
        str = LangManager.Instance.GetTranslation(
          "consortia.view.myConsortia.chairmanPath.ConsortiaPermissionFrame.name03",
        );
        break;
  ...
  public static showDutyList = [
    ConsortiaDutyLevel.CHAIRMAN,
    ConsortiaDutyLevel.VICE_CHAIRMAN,
    ConsortiaDutyLevel.OFFICIAL,
    ConsortiaDutyLevel.NORMAL,
  ];
}
