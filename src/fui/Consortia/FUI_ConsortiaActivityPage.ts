...
export default class FUI_ConsortiaActivityPage extends fgui.GComponent {
  ...
  public static createInstance(): FUI_ConsortiaActivityPage {
    return <FUI_ConsortiaActivityPage>(
      fgui.UIPackage.createObject("Consortia", "ConsortiaActivityPage")
    );
  }

  protected onConstruct(): void {
    this.c1 = this.getController("c1");
    this.txtConsortiaLevel = <fgui.GTextField>(
      this.getChild("txtConsortiaLevel")
    );
    ...
    this.txtConsortChairman = <fgui.GTextField>(
      this.getChild("txtConsortChairman")
    );
    ...
    this.txtConsortiaWealth = <fgui.GTextField>(
      this.getChild("txtConsortiaWealth")
    );
    this.txtConsortiawuzi = <fgui.GTextField>this.getChild("txtConsortiawuzi");
    this.txtConsortiaMaintain = <fgui.GTextField>(
      this.getChild("txtConsortiaMaintain")
    );
    this.txtConsortiaContribution = <fgui.GTextField>(
      this.getChild("txtConsortiaContribution")
    );
    ...
    this.activityListView = <FUI_ConsortiaActivityListView>(
      this.getChild("activityListView")
    );
