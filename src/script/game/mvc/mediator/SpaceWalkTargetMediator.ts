...
export class SpaceWalkTargetMediator implements IMediator
{
    ...
    public register(target:Sprite)
    {
        ...
        this.model.addEventListener(CampaignMapEvent.UPDATE_WALK_TARGET, this.__updateWalkTargetHandler, this);
    }

    public unregister(target:Sprite)
    {
        this.model.removeEventListener(CampaignMapEvent.UPDATE_WALK_TARGET, this.__updateWalkTargetHandler, this);
    }
