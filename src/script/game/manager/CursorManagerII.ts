...
export class CursorManagerII {
  ...
  private initCursor(): void {
    this._cursorDic[CursorManagerII.DRAG_CURSOR] =
      "asset.core.cursor.DragIconAsset";
    this._cursorDic[CursorManagerII.WATER_CURSOR] =
      "asset.core.cursor.WaterIconAsset";
    this._cursorDic[CursorManagerII.PICK_CURSOR] =
      "asset.core.cursor.PickOverIconAsset";
    this._cursorDic[CursorManagerII.COLLECT_CURSOR] =
      "asset.core.cursor.CollectIconAsset";
    this._cursorDic[CursorManagerII.ATTACK_CURSOR] =
      "asset.core.cursor.AttackIconAsset";
    this._cursorDic[CursorManagerII.NO_WALK_CURSOR] =
      "asset.core.cursor.NoWalkIconAsset";
    this._cursorDic[CursorManagerII.SELL_CIRSOR] =
      "asset.core.cursor.SellIconAsset";
    this._cursorDic[CursorManagerII.SPLITE_CURSOR] =
      "asset.core.cursor.SpliteIconAsset";
    this._cursorDic[CursorManagerII.REMOVE_CURSOR_UP] =
      "asset.core.cursor.RemoveIconUpAsset";
    this._cursorDic[CursorManagerII.REMOVE_CURSOR_DOWN] =
      "asset.core.cursor.RemoveIconDownAsset";
    this._cursorDic[CursorManagerII.FARM_CLEAR_CURSOR] =
      "asset.core.cursor.ClearIconAsset";
    this._cursorDic[CursorManagerII.FARM_PLANT_CURSOR] =
      "asset.core.cursor.SeedIconAsset";
    this._cursorDic[CursorManagerII.FARM_PICK_CURSOR] =
      "asset.core.cursor.CollectIconAsset";
    this._cursorDic[CursorManagerII.FARM_REVIVE_CURSOR] =
      "asset.core.cursor.ReviveIconAsset";
    this._cursorDic[CursorManagerII.FARM_WEED_CURSOR] =
      "asset.core.cursor.WeedIconAsset";
    this._cursorDic[CursorManagerII.FARM_WORM_CURSOR] =
      "asset.core.cursor.WormIconAsset";
    this._cursorDic[CursorManagerII.SPACE_NPC_CURSOR] =
      "asset.core.cursor.SpaceNpcAsset";
    this._cursorDic[CursorManagerII.SPACE_PLAYER_CURSOR] =
      "asset.core.cursor.SpacePlayerAsset";
    this._cursorDic[CursorManagerII.VICE_PASSWORD_LOCK] =
      "asset.common.vp.mouse";
    this._cursorDic[CursorManagerII.PVP_ATTACT_CURSOR] =
      this._cursorDic[CursorManagerII.ATTACK_CURSOR];
  }
  ...
  public resetCursor(): void {
    ...
    // Mouse.cursor = 'auto';
    Mouse.cursor =
      'url("res/game/cursor/asset.core.cursor.SpacePlayerAsset.png"),auto';
  }
