...
export class SimpleScriptAction extends GameBaseAction {
    public inheritType: InheritIActionType = InheritIActionType.SimpleScriptAction
    ...
    constructor(liftTime: number = 0, finishFun: Function = null, autoFinishNum: number = -1) {
        super();
