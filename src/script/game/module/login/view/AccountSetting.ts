...
export class AccountSetting extends FUI_AccountSetting {
    ...
    _onSwitchRegion() {
        SDKManager.Instance.getChannel().trackEvent(0, TrackEventNode.CLICK_AREA_CONFIRM, "click_area_confirm", "点击切换大区按钮", "", "");
    ...
    _onSwitchAccount() {
        ...
        let msg = LangManager.Instance.GetTranslation("LoginSetting.AccountSetting.AccountMsg");
