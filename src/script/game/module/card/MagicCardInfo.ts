...
export default class MagicCardInfo {
    ...
    public set templateId(value: number) {
        if (this._templateId != value) {
            ...
            this.magicCardTemplate = TempleteManager.Instance.getPowerCardTemplateByID(this._templateId);
        }
    }
    ...
    public set currentGP(value: number) {
        ...
        let arr: Array<t_s_upgradetemplateData> = TempleteManager.Instance.getTemplatesByType(this.lvupType);//卡牌升级模板
