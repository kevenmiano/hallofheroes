...
export class OuterCityMapDirectionKeyMediator implements IMediator
{
    ...
    public register(target:Object):void
    {
        ...
        KeyBoardRegister.Instance.registerMapKey(this.__leftMove, this.__rightMove, this.__topMove, this.__downMove);
    }

    public unregister(target:Object):void
    {
        KeyBoardRegister.Instance.removeMapKey(this.__leftMove, this.__rightMove, this.__topMove, this.__downMove);
        this._target = null;
    }
