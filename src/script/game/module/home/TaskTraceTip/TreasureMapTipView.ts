...
export class TreasureMapTipView extends TaskTraceTipWnd {
	...
	initView() {
		super.initView();
		let text = LangManager.Instance.GetTranslation("tasktracetip.view.TreasureMapTipView.btnTxt");
		this.setContentText(text);
		this.setBtnTitle(LangManager.Instance.GetTranslation("tasktracetip.view.TreasureMapTipView.btnTxt"));
	}
