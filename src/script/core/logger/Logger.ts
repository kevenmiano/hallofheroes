// import { BufferDamageData } from "../../game/battle/data/BufferDamageData.js";
...
export default class Logger {
  ...
  public static openBattleBuffCon(buffer: any) {
  ...
  public static debug(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.DEBUG) == -1
    ) {
      return;
    }
  ...
  public static socket(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.SOCKET) == -1
    ) {
      return;
    }
    ...
    if (this.Terminal_Log) {
      ...
      console.log.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.SOCKET],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static log(...params: any[]) {
    ...
    if (this.Terminal_Log) {
      ...
      console.log.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.LOG],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static info(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.INFO) == -1
    ) {
      return;
    }
    ...
    if (this.Terminal_Log) {
      ...
      console.info.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.INFO],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static warn(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.WARN) == -1
    ) {
      return;
    }
    ...
    if (this.Terminal_Log) {
      ...
      console.warn.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.WARN],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static error(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.ERROR) == -1
    ) {
      return;
    }
    ...
    if (this.Terminal_Log) {
      ...
      console.error.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.ERROR],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static base(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.BASE) == -1
    ) {
      return;
    }
    ...
    if (this.Terminal_Log) {
      ...
      console.info.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.BASE],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static yyz(...params: any[]) {
    ...
    if (this.Terminal_Log) {
      console.warn.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.yyz],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static xjy(...params: any[]) {
    ...
    if (this.Terminal_Log) {
      console.warn.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.xjy],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static ricky(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.ricky) == -1
    ) {
      return;
    }
    ...
    if (this.Terminal_Log) {
      console.log.call(
        null,
        "%c%s%s:%s",
        this.Log_Color_Config[LOG_LEVEL_TYPES.ricky],
        this.stack(5),
        str,
        ...params,
      );
  ...
  public static outcityWar(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.outcityWar) == -1
    ) {
      return;
    }
  ...
  public static battle(...params: any[]) {
    if (
      !Logger._open ||
      Logger.logFilters.indexOf(LOG_LEVEL_TYPES.battle) == -1
    ) {
      return;
    }
