...
export class BindPhoneView extends FUI_BindPhoneView {
    ...
    private initEvent() {
        ...
        NotificationManager.Instance.addEventListener(EmailEvent.WELFARE_BIND_STATE, this.__phoneCheckInfoHandler, this);
    }

    private initView() {
        let configTemp = TempleteManager.Instance.getConfigInfoByConfigName("bind_mobile_rewards");
    ...
    private removeEvent() {
        NotificationManager.Instance.removeEventListener(EmailEvent.WELFARE_BIND_STATE, this.__phoneCheckInfoHandler, this);
    }
