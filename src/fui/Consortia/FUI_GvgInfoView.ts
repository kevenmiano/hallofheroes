...
export default class FUI_GvgInfoView extends fgui.GComponent {
	...
	public static createInstance():FUI_GvgInfoView {
		return <FUI_GvgInfoView>(fgui.UIPackage.createObject("Consortia", "GvgInfoView"));
	}
	...
	protected onConstruct():void {
		...
		this._selfOccupyNumTxt = <fgui.GTextField>(this.getChild("_selfOccupyNumTxt"));
		...
		this._targetOccupyNumTxt = <fgui.GTextField>(this.getChild("_targetOccupyNumTxt"));
