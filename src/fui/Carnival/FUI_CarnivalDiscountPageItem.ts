...
export default class FUI_CarnivalDiscountPageItem extends fgui.GComponent {
  ...
  public static createInstance(): FUI_CarnivalDiscountPageItem {
    return <FUI_CarnivalDiscountPageItem>(
      fgui.UIPackage.createObject("Carnival", "CarnivalDiscountPageItem")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.Img_Collected_SealBg = <fgui.GImage>(
      this.getChild("Img_Collected_SealBg")
    );
