 ...
 * 登录Socket
 */
export class LoginSocketManager extends GameEventDispatcher implements IManager {
    ...
    public close() {
        ...
        if (socket) {
            ...
            socket.createWeakNet().model.off(WeakNetCheckModel.WeakNetClose, this.onClose, this);
