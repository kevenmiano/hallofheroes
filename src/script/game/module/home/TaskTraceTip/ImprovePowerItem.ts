    ...
    switch (type) {
      case FightingType.F_EQUIP: //装备
        this.nameTxt.text = LangManager.Instance.GetTranslation(
          "tasktracetip.view.IntensifyTipView.text",
        );
