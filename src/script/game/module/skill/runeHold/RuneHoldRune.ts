...
export class RuneHoldRune extends FUI_RuneHoldRune {
  ...
  protected onConstruct(): void {
    super.onConstruct();
    this._runesItem = [
      this.rr0 as RuneHoldRuneItem2,
      this.rr1 as RuneHoldRuneItem2,
      this.rr2 as RuneHoldRuneItem2,
      this.rr3 as RuneHoldRuneItem2,
      this.rr4 as RuneHoldRuneItem2,
    ];
  ...
  private updateDetailTips() {
    ...
    ).getAllRuneHoldPropery();
    let propertyStr =
      "[color=#FFC68F]" +
      LangManager.Instance.GetTranslation("playerInfo.runeInfo") +
      "[/color]";
    let haved = false;
