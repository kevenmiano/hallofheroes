...
export class RuneHoldListItem extends FUI_RuneHoldListItem {
    ...
    protected onConstruct(): void {
        super.onConstruct();
        this.runeItems = [this.rr0 as RuneHoldRuneItem, this.rr1 as RuneHoldRuneItem, this.rr2 as RuneHoldRuneItem, this.rr3 as RuneHoldRuneItem, this.rr4 as RuneHoldRuneItem];
    }
    ...
    private updateRune() {
        ...
        this.openTips.setVar("level", RuneHoleInfo.RuneHoleOpenLevel[this._info.holeId - 1]).flushVars();
