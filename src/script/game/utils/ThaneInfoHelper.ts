...
export class ThaneInfoHelper {
     ...
     * @param aMsg 
     */
    public static readHeroHp(thane: ThaneInfo, pkgInfo: SimpleHeroInfoMsg, aMsg: ArmyMsg = null) {
        thane.beginChanges();
        if (pkgInfo) {
     ...
     *
     */
    public static readHeroInfo(thane: ThaneInfo, pkgInfo: SimpleHeroInfoMsg, aMsg: ArmyMsg = null) {
        thane.beginChanges();
        if (aMsg) {
    ...
    private static readHeroRuneInfo(thane: ThaneInfo, pkgInfo: SimpleHeroInfoMsg) {
