...
export default class MarketListCom extends FUI_MarketListCom {
    ...
    private init() {
        ...
        this.goodsList.itemRenderer = Laya.Handler.create(this, this.onMarketItemRender, null, false);
        // this.goodsList.on(fgui.Events.CLICK_ITEM, this, this.onItemTap);
        this.initTranslate();
    }

    private initTranslate() {
        this.goodsNameLab.text = LangManager.Instance.GetTranslation("Market.list.goodsName");
        this.onlineCountLab.text = LangManager.Instance.GetTranslation("Market.list.onlineCount");
        this.priceLab.text = LangManager.Instance.GetTranslation("Market.list.price");
