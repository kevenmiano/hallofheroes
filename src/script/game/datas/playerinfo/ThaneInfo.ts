...
export class ThaneInfo extends SimplePlayerInfo {
    ...
    public set templateId(value: number) {
        this._templateInfo = ConfigMgr.Instance.getTemplateByID(ConfigType.t_s_herotemplate, value.toString());
        ...
        if (this._onlineTime != value) {
            ...
            if (channelId == 20360) {
                ...
                if (value <= postEventTime) {
                    Laya.timer.once(postEventTime - value, this, () => { SDKManager.Instance.getChannel().postGameEvent(GameEventCode.Code_2020); });
                }
            }
        }
    }
    ...
    public set hideFashion(value: boolean)//设置隐藏时装
    {
    ...
    public set petTemplateId(value: number) {
        ...
        this.petTemplate = ConfigMgr.Instance.getTemplateByID(ConfigType.t_s_pettemplate, value.toString());
    ...
    public commit() {
        ...
        if (this._changeObj[ThaneInfo.BODY_AVATAR] || this._changeObj[ThaneInfo.ARMS_AVATAR] ||
            this._changeObj[ThaneInfo.HAIR_AVATAR] || this._changeObj[ThaneInfo.CLOAK_AVATAR] || this._changeObj[ThaneInfo.CHANGE_SHAPE_ID] ||
            this._changeObj[ThaneInfo.WING_AVATAR] || this._changeObj[ThaneInfo.MOUNT_AVATR] || this._changeObj[ThaneInfo.HIDE_FASHION] ||
            this._changeObj[ThaneInfo.PET_AVATAR] || this._changeObj[ThaneInfo.TEMPLATEID]) {
