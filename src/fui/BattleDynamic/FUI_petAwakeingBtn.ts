...
export default class FUI_petAwakeingBtn extends fgui.GButton {
	...
	public static createInstance():FUI_petAwakeingBtn {
		return <FUI_petAwakeingBtn>(fgui.UIPackage.createObject("BattleDynamic", "petAwakeingBtn"));
	}
	...
	protected onConstruct():void {
		...
		this.txtAwakenNormalTip = <fgui.GTextField>(this.getChild("txtAwakenNormalTip"));
