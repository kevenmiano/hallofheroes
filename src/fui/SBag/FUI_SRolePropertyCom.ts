...
export default class FUI_SRolePropertyCom extends fgui.GComponent {
  ...
  public static createInstance(): FUI_SRolePropertyCom {
    return <FUI_SRolePropertyCom>(
      fgui.UIPackage.createObject("SBag", "SRolePropertyCom")
    );
  }
  ...
  protected onConstruct(): void {
    ...
    this.txt_property_value4 = <fgui.GTextField>(
      this.getChild("txt_property_value4")
    );
    this.txt_property_value5 = <fgui.GTextField>(
      this.getChild("txt_property_value5")
    );
