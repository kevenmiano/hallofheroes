...
export default class CrystalWnd extends BaseWindow {
    ...
    public OnInitWind() {
        ...
        this.frame.getChild('title').text = LangManager.Instance.GetTranslation("CrystalWnd.title");
        this.n3Txt.text = LangManager.Instance.GetTranslation("CrystalWnd.title");
        this.n4Txt.text = LangManager.Instance.GetTranslation("ResidenceFrameWnd.n5Txt");
