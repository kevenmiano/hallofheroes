...
import { SimpleAlertWnd } from "../component/SimpleAlertHelper.ts";
import BattleFallGoodsWnd from "../map/campaign/view/fall/BattleFallGoodsWnd.ts";
import MineralDialogWnd from "../map/campaign/view/frame/MineralDialogWnd.ts";
import PetLandDialogWnd from "../map/campaign/view/frame/PetLandDialogWnd.ts";
import AllocateWnd from "../module/allocate/AllocateWnd.ts";
import CasernRecruitWnd from "../module/allocate/CasernRecruitWnd.ts";
import CasernWnd from "../module/allocate/CasernWnd.ts";
import ConfigSoliderWnd from "../module/allocate/ConfigSoliderWnd.ts";
import { PawnLevelUpWnd } from "../module/allocate/PawnLevelUpWnd.ts";
import PawnSpecialAbilityWnd from "../module/allocate/PawnSpecialAbilityWnd.ts";
import SeveranceSoliderWnd from "../module/allocate/SeveranceSoliderWnd.ts";
import SoliderInfoTipWnd from "../module/allocate/SoliderInfoTipWnd.ts";
import SoliderSkillTipWnd from "../module/allocate/SoliderSkillTipWnd.ts";
import SpecialSelecteWnd from "../module/allocate/SpecialSelecteWnd.ts";
import SpecialSwitchWnd from "../module/allocate/SpecialSwitchWnd.ts";
import AnnounceWnd from "../module/announce/AnnounceWnd.ts";
import AppellGetTips from "../module/appell/AppellGetTips.ts";
import AppellWnd from "../module/appell/AppellWnd.ts";
import TeamFormationWnd from "../module/army/teamFormation/TeamFormationWnd.ts";
import { BagWnd } from "../module/bag/view/BagWnd.ts";
import { BatchUseConfirmWnd } from "../module/bag/view/BatchUseConfirmWnd.ts";
import { HeadIconModifyWnd } from "../module/bag/view/HeadIconModifyWnd.ts";
import { RenameWnd } from "../module/bag/view/RenameWnd.ts";
import { SaleConfirmWnd } from "../module/bag/view/SaleConfirmWnd.ts";
import { SplitConfirmWnd } from "../module/bag/view/SplitConfirmWnd.ts";
import BattleFailedSimpleWnd from "../module/battle/BattleFailedSimpleWnd.ts";
import BattleFailedWnd from "../module/battle/BattleFailedWnd.ts";
import BattleVictorySimpleWnd from "../module/battle/BattleVictorySimpleWnd.ts";
import BattleVictoryWnd from "../module/battle/BattleVictoryWnd.ts";
import BattleWnd from "../module/battle/BattleWnd.ts";
import CampaignResultWnd from "../module/campaignResult/CampaignResultWnd.ts";
import CrystalWnd from "../module/castle/CrystalWnd.ts";
import DepotWnd from "../module/castle/DepotWnd.ts";
import PoliticsFrameWnd from "../module/castle/PoliticsFrameWnd.ts";
import ResidenceFrameWnd from "../module/castle/ResidenceFrameWnd.ts";
import SeminaryUpWnd from "../module/castle/SeminaryUpWnd.ts";
import SeminaryWnd from "../module/castle/SeminaryWnd.ts";
import ChatBugleWnd from "../module/chat/ChatBugleWnd.ts";
import ChatFaceWnd from "../module/chat/ChatFaceWnd.ts";
import ChatItemMenu from "../module/chat/ChatItemMenu.ts";
import ChatWnd from "../module/chat/ChatWnd.ts";
import ChestFrameWnd from "../module/chestFrame/ChestFrameWnd.ts";
import FightingUpdateWnd from "../module/common/FightingUpdateWnd.ts";
import HelpWnd from "../module/common/HelpWnd.ts";
import ShopCommWnd from "../module/common/ShopCommWnd.ts";
import { ConsortiaStorageWnd } from "../module/consortia/view/building/ConsortiaStorageWnd.ts";
import { ConsortiaDevilWnd } from "../module/consortia/view/chairman/ConsortiaDevilWnd.ts";
import { ConsortiaPermissionWnd } from "../module/consortia/view/chairman/ConsortiaPermissionWnd.ts";
import { ConsortiaRecruitMemberWnd } from "../module/consortia/view/chairman/ConsortiaRecruitMemberWnd.ts";
import { ConsortiaRenameWnd } from "../module/consortia/view/chairman/ConsortiaRenameWnd.ts";
import { ConsortiaTransferWnd } from "../module/consortia/view/chairman/ConsortiaTransferWnd.ts";
import { ConsortiaUpgradeWnd } from "../module/consortia/view/chairman/ConsortiaUpgradeWnd.ts";
import { ConsortiaEmailMemberWnd } from "../module/consortia/view/chairman/email/ConsortiaEmailMemberWnd.ts";
import { ConsortiaEmailWnd } from "../module/consortia/view/chairman/email/ConsortiaEmailWnd.ts";
import ConsortiaPlayerMenu from "../module/consortia/view/component/ConsortiaPlayerMenu.ts";
import ConsortiaAltarWnd from "../module/consortia/view/ConsortiaAltarWnd.ts";
import { ConsortiaApplyWnd } from "../module/consortia/view/ConsortiaApplyWnd.ts";
import { ConsortiaAuditingWnd } from "../module/consortia/view/ConsortiaAuditingWnd.ts";
import { ConsortiaContributeWnd } from "../module/consortia/view/ConsortiaContributeWnd.ts";
import { ConsortiaCreateWnd } from "../module/consortia/view/ConsortiaCreateWnd.ts";
import { ConsortiaEventWnd } from "../module/consortia/view/ConsortiaEventWnd.ts";
import { ConsortiaInfoWnd } from "../module/consortia/view/ConsortiaInfoWnd.ts";
import ConsortiaPrizeAllotWnd from "../module/consortia/view/ConsortiaPrizeAllotWnd.ts";
import { ConsortiaRankWnd } from "../module/consortia/view/ConsortiaRankWnd.ts";
import ConsortiaSecretInfoWnd from "../module/consortia/view/ConsortiaSecretInfoWnd.ts";
import { ConsortiaSkillTowerWnd } from "../module/consortia/view/ConsortiaSkillTowerWnd.ts";
import { ConsortiaTreasureBoxWnd } from "../module/consortia/view/ConsortiaTreasureBoxWnd.ts";
import { ConsortiaWnd } from "../module/consortia/view/ConsortiaWnd.ts";
import { GvgAddMembersWnd } from "../module/consortia/view/GvgAddMembersWnd.ts";
import { GvgBattleWnd } from "../module/consortia/view/GvgBattleWnd.ts";
import { GvgEnterWarWnd } from "../module/consortia/view/GvgEnterWarWnd.ts";
import { GvgRankListWnd } from "../module/consortia/view/GvgRankListWnd.ts";
import { GvgRiverWnd } from "../module/consortia/view/GvgRiverWnd.ts";
import VipCoolDownFrameWnd from "../module/cooldowm/VipCoolDownFrameWnd.ts";
import DialogWnd from "../module/dialog/DialogWnd.ts";
import { SpaceDialogWnd } from "../module/dialog/SpaceDialogWnd.ts";
import DisplayItemsWnd from "../module/displayItems/DisplayItemsWnd.ts";
import FarmBagTipWnd from "../module/farm/view/FarmBagTipWnd.ts";
import FarmEventWnd from "../module/farm/view/FarmEventWnd.ts";
import { FarmLandMenuWnd } from "../module/farm/view/FarmLandMenuWnd.ts";
import FarmLandUpWnd from "../module/farm/view/FarmLandUpWnd.ts";
import { FarmPetSelectWnd } from "../module/farm/view/FarmPetSelectWnd.ts";
import FarmShopWnd from "../module/farm/view/FarmShopWnd.ts";
import FarmWnd from "../module/farm/view/FarmWnd.ts";
import FirstPayWnd from "../module/firstpay/FirstPayWnd.ts";
import ForgeWnd from "../module/forge/ForgeWnd.ts";
import { AddFriendsWnd } from "../module/friend/view/AddFriendsWnd.ts";
import { FriendInviteWnd } from "../module/friend/view/FriendInviteWnd.ts";
import { FriendWnd } from "../module/friend/view/FriendWnd.ts";
import FunnyWnd from "../module/funny/view/FunnyWnd.ts";
import BuyHpWnd from "../module/home/BuyHpWnd.ts";
import CampaignMapWnd from "../module/home/CampaignMapWnd.ts";
import HomeWnd from "../module/home/HomeWnd.ts";
import SmallMapWnd from "../module/home/SmallMapWnd.ts";
import SpaceTaskInfoWnd from "../module/home/SpaceTaskInfoWnd.ts";
import JoyStickWnd from "../module/joystick/JoyStickWnd.ts";
import LevelUpWnd from "../module/levelup/LevelUpWnd.ts";
import { LoadingWnd } from "../module/loading/LoadingWnd.ts";
import DebugLoginWnd from "../module/login/view/DebugLoginWnd.ts";
import LoginWnd from "../module/login/view/LoginWnd.ts";
import ServerlistWnd from "../module/login/view/ServerlistWnd.ts";
import AddFriendWnd from "../module/mail/AddFriendWnd.ts";
import MailWnd from "../module/mail/MailWnd.ts";
import WriteMailWnd from "../module/mail/WriteMailWnd.ts";
import MazeFrameWnd from "../module/maze/MazeFrameWnd.ts";
import MazeRankWnd from "../module/maze/MazeRankWnd.ts";
import MazeRiverWnd from "../module/maze/MazeRiverWnd.ts";
import MazeShopWnd from "../module/maze/MazeShopWnd.ts";
import MazeViewWnd from "../module/maze/MazeViewWnd.ts";
import MineralShopWnd from "../module/mineral/MineralShopWnd.ts";
import MopupWnd from "../module/mopup/MopupWnd.ts";
import MountsWnd from "../module/mount/MountsWnd.ts";
import TodayNotAlertWnd from "../module/mount/TodayNotAlertWnd.ts";
import WildSoulWnd from "../module/mount/WildSoulWnd.ts";
import OfferRewardWnd from "../module/offerReward/OfferRewardWnd.ts";
import PetPotencyWnd from "../module/pet/view/PetPotencyWnd.ts";
import { PetRenameWnd } from "../module/pet/view/PetRenameWnd.ts";
import { PetSelectWnd } from "../module/pet/view/PetSelectWnd.ts";
import PetWnd from "../module/pet/view/PetWnd.ts";
import QuestionNaireWnd from "../module/questionnaire/QuestionNaireWnd.ts";
import QuestionWnd from "../module/questionnaire/QuestionWnd.ts";
import RankWnd from "../module/rank/RankWnd.ts";
import RvrBattleGetResourceWnd from "../module/rvrBattle/RvrBattleGetResourceWnd.ts";
import RvrBattleMapRightWnd from "../module/rvrBattle/RvrBattleMapRightWnd.ts";
import RvrBattleMapTopCenterWnd from "../module/rvrBattle/RvrBattleMapTopCenterWnd.ts";
import RvrBattlePlayerRiverWnd from "../module/rvrBattle/RvrBattlePlayerRiverWnd.ts";
import RvrBattleResultWnd from "../module/rvrBattle/RvrBattleResultWnd.ts";
import RvrBattleWnd from "../module/rvrBattle/RvrBattleWnd.ts";
import SettingWnd from "../module/setting/SettingWnd.ts";
import { BuyFrameI } from "../module/shop/view/BuyFrameI.ts";
import { ShopWnd } from "../module/shop/view/ShopWnd.ts";
import RunesUpgradeWnd from "../module/skill/RunesUpgradeWnd.ts";
import SkillWnd from "../module/skill/SkillWnd.ts";
import SortWnd from "../module/sort/SortWnd.ts";
import WarlordsWnd from "../module/sort/WarlordsWnd.ts";
import StarBagWnd from "../module/star/StarBagWnd.ts";
import StarOperateWnd from "../module/star/StarOperateWnd.ts";
import StarWnd from "../module/star/StarWnd.ts";
import TaskWnd from "../module/task/TaskWnd.ts";
import TestFigureWnd from "../module/test/TestFigureWnd.ts";
import TrailDialogWnd from "../module/trailMap/TrailDialogWnd.ts";
import TrialMapShopWnd from "../module/trailMap/TrailMapShopWnd.ts";
import TrailMapWnd from "../module/trailMap/TrailMapWnd.ts";
import VipPrivilegeWnd from "../module/vip/VipPrivilegeWnd.ts";
import WarlordRoomWnd from "../module/warlords/view/WarlordRoomWnd.ts";
import WarlordsBetSelectWnd from "../module/warlords/view/WarlordsBetSelectWnd.ts";
import WarlordsBetWnd from "../module/warlords/view/WarlordsBetWnd.ts";
import WarlordsCheckRewardWnd from "../module/warlords/view/WarlordsCheckRewardWnd.ts";
import WarlordsFinalReportWnd from "../module/warlords/view/WarlordsFinalReportWnd.ts";
import WarlordsMainWnd from "../module/warlords/view/WarlordsMainWnd.ts";
import WarlordsPrelimReportWnd from "../module/warlords/view/WarlordsPrelimReportWnd.ts";
import WarlordsWinPrizesWnd from "../module/warlords/view/WarlordsWinPrizesWnd.ts";
import WelfareWnd from "../module/welfare/WelfareWnd.ts";
import WorldBossSceneWnd from "../module/worldboss/view/WorldBossSceneWnd.ts";
import WorldBossRiverWnd from "../module/worldboss/view/WorldBossRiverWnd.ts";
import BeingInviteWnd from "../room/room/invite/BeingInviteWnd.ts";
import InviteWnd from "../room/room/invite/InviteWnd.ts";
import QuickInviteWnd from "../room/room/invite/QuickInviteWnd.ts";
import RoomHallWnd from "../room/room/roomHall/RoomHallWnd.ts";
import RoomListWnd from "../room/room/roomList/RoomListWnd.ts";
import RoomPwdWnd from "../room/room/roomList/RoomPwdWnd.ts";
import Appelltips from "../tips/Appelltips.ts";
import { BattleGuardItemTips } from "../tips/BattleGuardItemTips.ts";
import { CommonTips } from "../tips/CommonTips.ts";
import { ComposeTip } from "../tips/ComposeTip.ts";
import { EquipContrastTips } from "../tips/EquipContrastTips.ts";
import { EquipTip } from "../tips/EquipTip.ts";
import { GvgBufferTips } from "../tips/GvgBufferTips.ts";
import { MountCardTip } from "../tips/MountCardTip.ts";
import { MountTips } from "../tips/MountTips.ts";
import { PropTips } from "../tips/PropTips.ts";
import { RuneTip } from "../tips/RuneTip.ts";
import SkillTips from "../tips/SkillTips.ts";
import { StarPowerTip } from "../tips/StarPowerTip.ts";
import { StarTips } from "../tips/StarTips.ts";
import IconAlertHelperWnd from "../utils/IconAlertHelperWnd.ts";
import PersonalCenterWnd from "../module/personalCenter/PersonalCenterWnd.ts";
import PetChallengeConfirmWnd from "../module/petChallenge/PetChallengeConfirmWnd.ts";
import PetChallengeEventWnd from "../module/petChallenge/PetChallengeEventWnd.ts";
import PetChallengeRankWnd from "../module/petChallenge/PetChallengeRankWnd.ts";
import PetChallengeRewardWnd from "../module/petChallenge/PetChallengeRewardWnd.ts";
import PetChallengeWnd from "../module/petChallenge/PetChallengeWnd.ts";
import { PetTip } from "../tips/PetTip.ts";
import { PetExchangeShopWnd } from "../module/shop/view/PetExchangeShopWnd.ts";
import { TransferBuildWnd } from "../module/castle/TransferBuildWnd.ts";
import { WorldMapWnd } from "../module/outercity/view/WorldMapWnd.ts";
import TreasureMapWnd from "../module/treasuremap/view/TreasureMapWnd.ts";
import TreasureClaimMapWnd from "../module/treasuremap/view/TreasureClaimMapWnd.ts";
import BufferTips from "../tips/BufferTips.ts";
import ConsortiaElectionWnd from "../module/consortia/view/ConsortiaElectionWnd.ts";
import { SinglePassWnd } from "../module/singlepass/SinglePassWnd.ts";
import { PlayerInfoWnd } from "../module/playerinfo/PlayerInfoWnd.ts";
import { PlayerProfileWnd } from "../module/playerinfo/PlayerProfileWnd.ts";
import { MyMountWnd } from "../module/playerinfo/MyMountWnd.ts";
import { PlayerMountWnd } from "../module/playerinfo/PlayerMountWnd.ts";
import { MyPetWnd } from "../module/playerinfo/MyPetWnd.ts";
import { PlayerPetWnd } from "../module/playerinfo/PlayerPetWnd.ts";
import LookPlayerList from "../module/playerinfo/LookPlayerList.ts";
import { OuterCityOperateMenu } from "../module/outercity/view/OuterCityOperateMenu.ts";
import HookWnd from "../module/hook/HookWnd.ts";
import SinglePassRankWnd from "../module/singlepass/SinglePassRankWnd.ts";
import { ForgeEquipTip } from "../tips/ForgeEquipTip.ts";
import { ForgePropTip } from "../tips/ForgePropTip.ts";
import { QuantitySelector } from "../module/common/QuantitySelector.ts";
import { OuterCityTransmitWnd } from "../module/outercity/view/OuterCityTransmitWnd.ts";
import { OuterCityFieldInfoWnd } from "../module/outercity/view/OuterCityFieldInfoWnd.ts";
import { OuterCityCastleTips } from "../module/outercity/view/OuterCityCastleTips.ts";
import { OuterCityCastleInfoWnd } from "../module/outercity/view/OuterCityCastleInfoWnd.ts";
import SinglePassBugleWnd from "../module/singlepass/SinglePassBugleWnd.ts";
import SinglepassResultWnd from "../module/singlepass/SinglepassResultWnd.ts";
import { OuterCityFieldTips } from "../module/outercity/view/OuterCityFieldTips.ts";
import { OuterCityArmyTips } from "../module/outercity/view/OuterCityArmyTips.ts";
import ExchangeWnd from "../module/funny/view/ExchangeWnd.ts";
import MountInfoWnd from "../module/mount/MountInfoWnd.ts";
import CheckMailWnd from "../module/personalCenter/mailcheck/CheckMailWnd.ts";
import ChangePasswordWnd from "../module/personalCenter/password/ChangePasswordWnd.ts";
import SetPasswordWnd from "../module/personalCenter/password/SetPasswordWnd.ts";
import InputPasswordWnd from "../module/personalCenter/password/InputPasswordWnd.ts";
import SuggestWnd from "../module/personalCenter/mailcheck/SuggestWnd.ts";
import SendFlowerWnd from "../module/chat/SendFlowerWnd.ts";
import ReceiveFlowerWnd from "../module/chat/ReceiveFlowerWnd.ts";
import OuterCityResourceInfoWnd from "../module/castle/OuterCityResourceInfoWnd.ts";
import PotionBufferTips from "../tips/PotionBufferTips.ts";
import { CrystalTips } from "../tips/CrystalTips.ts";
import UseGoodsAlert from "../utils/UseGoodsAlert.ts";
import MapNameMovieWnd from "../module/mapNameMovie/MapNameMovieWnd.ts";
import { HintWnd } from "../module/common/HintWnd.ts";
import CustomerServiceWnd from "../module/personalCenter/mailcheck/CustomerServiceWnd.ts";
import PveRoomListWnd from "../room/room/roomList/pve/PveRoomListWnd.ts";
import FindRoomWnd from "../room/room/roomList/FindRoomWnd.ts";
import CumulativeRechargeItemInfoWnd from "../module/funny/view/CumulativeRechargeItemInfoWnd.ts";
import FightingDescribleWnd from "../module/home/TaskTraceTip/FightingDescribleWnd.ts";
import FightingPetWnd from "../module/home/TaskTraceTip/FightingPetWnd.ts";
import BuyGoodsAlert from "../utils/BuyGoodsAlert.ts";
import AllocateFormationWnd from "../module/allocate/AllocateFormationWnd.ts";
import BattleBuffDetailInfoWnd from "../module/battle/BattleBuffDetailInfoWnd.ts";
import ServiceReplyWnd from "../module/personalCenter/customer/ServiceReplyWnd.ts";
import ExpBackShowTipsWnd from "../module/welfare/view/component/ExpBackShowTipsWnd.ts";
import OuterCityShopWnd from "../module/outercityshop/OuterCityShopWnd.ts";
import { BuyFrame2 } from "../module/outercityshop/view/BuyFrame2.ts";
import ConsortiaSplitWnd from "../module/consortia/view/building/ConsortiaSplitWnd.ts";
import MountRefiningWnd from "../module/mount/MountRefiningWnd.ts";
import PlayerDescribeWnd from "../module/home/PlayerDescribeWnd.ts";
import SpacePKAlert from "../map/space/view/SpacePKAlert.ts";
import CrossPvPSuccessWnd from "../module/crosspvp/CrossPvPSuccessWnd.ts";
import CorssPvPCenterShowWnd from "../module/crosspvp/CorssPvPCenterShowWnd.ts";
import CrossPvPVoteWnd from "../module/crosspvp/CrossPvPVoteWnd.ts";
import RvrBattleMapCombatWnd from "../module/rvrBattle/RvrBattleMapCombatWnd.ts";
import MiniGameWnd from "../module/gemMaze/view/MiniGameWnd.ts";
import GemMazeWnd from "../module/gemMaze/view/GemMazeWnd.ts";
import GemMazeRankWnd from "../module/gemMaze/view/GemMazeRankWnd.ts";
import { AppellPowerTip } from "../tips/AppellPowerTip.ts";
import ShortCutSetWnd from "../module/personalCenter/shortCut/ShortCutSetWnd.ts";
import PassAdvanceWnd from "../module/welfare/view/pass/PassAdvanceWnd.ts";
import PassBuyWnd from "../module/welfare/view/pass/PassBuyWnd.ts";
import PassRewardWnd from "../module/welfare/view/pass/PassRewardWnd.ts";
import GemMazeBagWnd from "../module/gemMaze/view/GemMazeBagWnd.ts";
import ConsortiaBossWnd from "../module/consortia/view/ConsortiaBossWnd.ts";
import ConsortiaBossRewardWnd from "../module/consortia/view/ConsortiaBossRewardWnd.ts";
import ConsortiaBossTaskView from "../module/consortia/view/ConsortiaBossTaskView.ts";
import ConsortiaBossSceneWnd from "../module/consortia/view/ConsortiaBossSceneWnd.ts";
import ConsortiaBossDialogWnd from "../map/campaign/view/frame/ConsortiaBossDialogWnd.ts";
import MemToolWnd from "../module/memTool/MemToolWnd.ts";
import ChatAirBubbleWnd from "../module/chatairbubble/ChatAirBubbleWnd.ts";
import PetGuardWnd from "../module/petguard/PetGuardWnd.ts";
import PetGuardTipWnd from "../module/petguard/PetGuardTipWnd.ts";
import LogWnd from "../module/log/LogWnd.ts";
import OfficialAccountWnd from "../module/personalCenter/OfficialAccountWnd.ts";
import RegisterSWnd from "../module/login/view/RegisterSWnd.ts";
import SkillEditWnd from "../module/fightEdit/view/SkillEditWnd.ts";
import SkillEditSelectWnd from "../module/fightEdit/view/SkillEditSelectWnd.ts";
import SkillEditPetWnd from "../module/fightEdit/view/SkillEditPetWnd.ts";
import ConsortiaTreasureWnd from "../module/consortia/view/ConsortiaTreasureWnd.ts";
import OuterCityTreasureCDAlertWnd from "../map/outercity/OuterCityTreasureCDAlertWnd.ts";
import OuterCityTreasureCDWnd from "../map/outercity/OuterCityTreasureCDWnd.ts";
import OuterCityTreasureWnd from "../module/outercity/view/OuterCityTreasureWnd.ts";
import MultiBoxSelectWnd from "../module/bag/view/MultiBoxSelectWnd.ts";
import RuneCarveWnd from "../module/skill/runeGem/RuneCarveWnd.ts";
import RuneGemUpgradeWnd from "../module/skill/runeGem/RuneGemUpgradeWnd.ts";
import StarSellSelectWnd from "../module/star/StarSellSelectWnd.ts";
import WaitingWnd from "../module/common/WaitingWnd.ts";
import StatutoryAgeWnd from "../module/announce/StatutoryAgeWnd.ts";
import PetCampaignWnd from "../module/petCampaign/PetCampaignWnd.ts";
import PetGetRewardWnd from "../module/petCampaign/PetGetRewardWnd.ts";
import ScreenWnd from "../module/pet/view/peteuip/ScreenWnd.ts.ts";
import RuneHoleHelpWnd from "../module/skill/runeGem/RuneHoleHelpWnd.ts";
import PetCampaignResultWnd from "../module/petCampaign/PetCampaignResultWnd.ts";
import ChatTranslateSetWnd from "../module/chat/ChatTranslateSetWnd.ts";
import PetEuipTrainWnd from "../module/pet/view/peteuip/PetEuipTrainWnd.ts";
import PetEquipStrenOkWnd from "../module/pet/view/peteuip/PetEquipStrenOkWnd.ts";
import { PetEquipTip } from "../tips/PetEquipTip.ts";
import GetGoodsAlert from "../utils/GetGoodsAlert.ts";
import { PetEquipContrastTips } from "../tips/PetEquipContrastTips.ts";
import MountShareWnd from "../module/mount/MountShareWnd.ts";
import { EvaluationWnd } from "../module/evaluation/EvaluationWnd.ts";
import MicroAppWnd from "../module/microapp/MicroAppWnd.ts";
import FaceSlappingWnd from "../module/faceSlapping/FaceSlappingWnd.ts";
import DiscountWnd from "../module/shop/view/DiscountWnd.ts";
import { WeakNetWnd } from "../module/common/WeakNetWnd.ts";
import GoldenSheepBoxWnd from "../module/goldensheep/GoldenSheepBoxWnd.ts";
import GoldenSheepWnd from "../module/goldensheep/GoldenSheepWnd.ts";
import HTMLWnd from "../module/login/view/HTMLWnd.ts";
import MonopolyFinishWnd from "../module/monopoly/view/MonopolyFinishWnd.ts";
import MonopolyResultWnd from "../module/monopoly/view/MonopolyResultWnd.ts";
import { RemotePetReadyWnd } from "../module/remotepet/RemotePetReadyWnd.ts";
import { RemotePetTurnWnd } from "../module/remotepet/RemotePetTurnWnd.ts";
import ChooseDiceWnd from "../module/monopoly/view/ChooseDiceWnd.ts";
import MonopolyDiceWnd from "../module/monopoly/view/MonopolyDiceWnd.ts";
import WearySupplyWnd from "../module/wearySupply/WearySupplyWnd.ts";
import { RemotePetChallengeWnd } from "../module/remotepet/RemotePetChallengeWnd.ts";
import { RemoteMopupWnd } from "../module/remotepet/RemoteMopupWnd.ts";
import { RemotePetOrderWnd } from "../module/remotepet/RemotePetOrderWnd.ts";
import { RemotePetSkillLevelUp } from "../module/remotepet/view/RemotePetSkillLevelUp.ts";
import { SRoleWnd } from "../module/sbag/SRoleWnd.ts";
import { TattooBaptizeWnd } from "../module/sbag/tattoo/TattooBaptizeWnd.ts";
import RingTaskRewardWnd from "../module/dialog/RingTaskRewardWnd.ts";
import { FashionBonusWnd } from "../module/sbag/fashion/FashionBonusWnd.ts";
import AutoWalkWnd from "../module/home/AutoWalkWnd.ts";
import StarAutoSettingWnd from "../module/star/StarAutoSettingWnd.ts";
import PetFirstSelectWnd from "../module/common/PetFirstSelectWnd.ts";
import QQDawankaWnd from "../module/qqDawanka/QQDawankaWnd.ts";
import ItemTips from "../tips/ItemTips.ts";
import AvatarTips from "../tips/AvatarTips.ts";
import QQGiftWnd from "../module/qqGift/QQGiftWnd.ts";
import OutyardChangeWnd from "../module/outyard/OutyardChangeWnd.ts";
import OutyardBlessWnd from "../module/outyard/OutyardBlessWnd.ts";
import OutyardFigureWnd from "../module/outyard/OutyardFigureWnd.ts";
import OutyardMemberWnd from "../module/outyard/OutyardMemberWnd.ts";
import OutyardNoticeWnd from "../module/outyard/OutyardNoticeWnd.ts";
import OutyardOpenWnd from "../module/outyard/OutyardOpenWnd.ts";
import OutyardRewardWnd from "../module/outyard/OutyardRewardWnd.ts";
import { SkillItemTips } from "../tips/SkillItemTips.ts";
import { RuneItemTips } from "../tips/RuneItemTips.ts";
import OutyardRewardAlertWnd from "../module/outyard/OutyardRewardAlertWnd.ts";
import { GoldenTreePreviewWnd } from "../module/funny/view/GoldenTreePreviewWnd.ts";
import { GoldenTreeRecordWnd } from "../module/funny/view/GoldenTreeRecordWnd.ts";
import { BottleIntergalBoxTips } from "../module/funny/view/BottleIntergalBoxTips.ts";
import { BottleBottomIntergalBoxTips } from "../module/funny/view/BottleBottomIntergalBoxTips.ts";
import PvpRewardsWnd from "../room/room/roomList/PvpRewardsWnd.ts";
import PvpPreviewWnd from "../room/room/roomList/PvpPreviewWnd.ts";
import PvpRoomResultWnd from "../room/room/roomList/PvpRoomResultWnd.ts";
import BattleSettingWnd from "../module/personalCenter/BattleSettingWnd.ts";
import WorldBossWnd from "../module/worldboss/view/WorldBossWnd.ts";
import { TalentItemTips } from "../tips/TalentItemTips.ts";
import RuneHoldEquipWnd from "../module/skill/runeHold/RuneHoldEquipWnd.ts";
import { FilterRuneWnd } from "../module/skill/runeHold/FilterRuneWnd.ts";
import OutyardBuyEnergyWnd from "../module/outyard/OutyardBuyEnergyWnd.ts";
import CarnivalWnd from "../module/carnival/CarnivalWnd.ts";
import RuneGemWnd from "../module/skill/content/RuneGemWnd.ts";
import AirGardenGameMemoryCardWnd from "../module/carnival/games/AirGardenGameMemoryCardWnd.ts";
import AirGardenGameLLKWnd from "../module/carnival/games/AirGardenGameLlkWnd.ts";
import BindVertifyWnd from "../module/welfare/BindVertifyWnd.ts";
import { NewPropTips } from "../tips/NewPropTips.ts";
import SiteZoneWnd from "../module/login/view/SiteZoneWnd.ts";
import { RemotePetWnd } from "../module/remotepet/RemotePetWnd.ts";
import { RemotePetAdjustWnd } from "../module/remotepet/RemotePetAdjustWnd.ts";
import OutyardBattleRecordWnd from "../module/outyard/OutyardBattleRecordWnd.ts";
import PreviewGoodsWnd from "../tips/PreviewGoodsWnd.ts";
import PreviewBoxWnd from "../tips/PreviewBoxWnd.ts";
import { PetChallengeAdjustWnd } from "../module/petChallenge/PetChallengeAdjustWnd.ts";
import WishPoolResultWnd from "../module/shop/view/WishPoolResultWnd.ts";
import ImprovePowerWnd from "../module/home/TaskTraceTip/ImprovePowerWnd.ts";
import OuterCityMapWnd from "../module/outercity/view/OuterCityMapWnd.ts";
import PetEquipSuccinctWnd from "../module/pet/view/peteuip/PetEquipSuccinctWnd.ts";
import FunOpenWnd from "../module/funpreview/FunOpenWnd.ts";
import OuterCityMapCastleTips from "../module/outercity/view/OuterCityMapCastleTips.ts";
import OuterCityMapTreasureTips from "../module/outercity/view/OuterCityMapTreasureTips.ts";
import OuterCityMapBossTips from "../module/outercity/view/OuterCityMapBossTips.ts";
import OuterCityMapMineTips from "../module/outercity/view/OuterCityMapMineTips.ts";
import OutercityGoldMineWnd from "../module/outercity/view/OutercityGoldMineWnd.ts";
import { PropertyCompareTips } from "../tips/PropertyCompareTips.ts";
import ExpBackWnd from "../module/expback/ExpBackWnd.ts";
import { PetAttrTip } from "../module/pet/view/PetAttrTip.ts";
import OuterCityBossInfoWnd from "../module/outercity/view/OuterCityBossInfoWnd.ts";
import PetSkillTips from "../tips/PetSkillTips.ts";
import LoginSettingWnd from "../module/login/view/LoginSettingWnd.ts";
import { RecommendFriendWnd } from "../module/friend/view/RecommendFriendWnd.ts";
import AirGardenGameSuDuWnd from "../module/carnival/games/AirGardenGameSuDuWnd.ts";
import { PetSaveSureWnd } from "../module/pet/view/PetSaveSureWnd.ts";
import { PetSaveWnd } from "../module/pet/view/PetSaveWnd.ts";
import MarketBuyWnd from "../module/market/MarketBuyWnd.ts";
import MarketSellWnd from "../module/market/MarketSellWnd.ts";
import MarketWnd from "../module/market/MarketWnd.ts";
import { TattooReinforceWnd } from "../module/sbag/tattoo/TattooReinforceWnd.ts";
import OuterCityMapPlayerTips from "../module/outercity/view/OuterCityMapPlayerTips.ts";
import OuterCityWarWnd from "../module/outercityWar/OuterCityWarWnd.ts";
import OuterCityWarAttackerBuildWnd from "../module/outercityWar/OuterCityWarAttackerBuildWnd.ts";
import OuterCityWarDefenceSettingWnd from "../module/outercityWar/OuterCityWarDefenceSettingWnd.ts";
import OuterCityWarDefencerBuildWnd from "../module/outercityWar/OuterCityWarDefencerBuildWnd.ts";
import OuterCityWarEnterWarSettingWnd from "../module/outercityWar/OuterCityWarEnterWarSettingWnd.ts";
import OuterCityWarNoticeWnd from "../module/outercityWar/OuterCityWarNoticeWnd.ts";
import ArtifactTips from "../tips/ArtifactTips.ts";
import ArtifactResetWnd from "../module/pet/view/ArtifactResetWnd.ts";
import { CommonTips2 } from "../tips/CommonTips2.ts";
import BattleShortCutWnd from "../module/battle/BattleShortCutWnd.ts";
import { QuickOpenFrameWnd } from "../module/debug/quickOpenFrame/QuickOpenFrameWnd.ts";
import { DebugHelpWnd } from "../module/debug/help/DebugHelpWnd.ts";
import OuterCityVehicleInfoWnd from "../module/outercity/view/OuterCityVehicleInfoWnd.ts";
import OuterCityVehicleTips from "../module/outercity/view/OuterCityVehicleTips.ts";
import PveCampaignWnd from "../module/pve/pveCampaign/PveCampaignWnd.ts";
import PveMultiCampaignWnd from "../module/pve/pveMultiCampaign/PveMultiCampaignWnd.ts";
import ColosseumEventWnd from "../module/pvp/colosseum/ColosseumEventWnd.ts";
import MasterySoulWnd from "../module/sbag/mastery/MasterySoulWnd.ts";
import { SecretBookTips } from "../tips/SecretBookTips.ts";
import { SoulEquipTip } from "../tips/SoulEquipTip.ts";
import ColosseumRankRewardWnd from "../module/pvp/colosseum/ColosseumRankRewardWnd.ts";
import ColosseumRewardsWnd from "../module/pvp/colosseum/ColosseumRerewardsWnd.ts";
import ColosseumWnd from "../module/pvp/colosseum/ColosseumWnd.ts";
import PvpShopWnd from "../module/pvp/pvp/PvpShopWnd.ts";
import PvpGateWnd from "../module/pvp/gate/PvpGateWnd.ts";
import PveGateWnd from "../module/pve/gate/PveGateWnd.ts";
import { MyMasteryWnd } from "../module/playerinfo/MyMasteryWnd.ts";
import { PlayerMasteryWnd } from "../module/playerinfo/PlayerMasteryWnd.ts";
import ConsortiaNewWnd from "../module/consortia/view/ConsortiaNewWnd.ts";
import ConsortiaInfoChangeWnd from "../module/consortia/view/chairman/ConsortiaInfoChangeWnd.ts";
import PveSecretWnd from "../module/pve/pveSecret/PveSecretWnd.ts";
import PveSecretSceneWnd from "../module/pve/pveSecretScene/PveSecretSceneWnd.ts";
import LoginWndOS from "../module/login/view/LoginWndOS.ts";
import UpgradeAccountWnd from "../module/home/UpgradeAccountWnd.ts";
import ActivityTimeWnd from "../module/activityTime/ActivityTimeWnd.ts";
import LoginSettingWndOS from "../module/login/view/LoginSettingWndOS.ts";
import { SecretTresureTip } from "../tips/SecretTresureTip.ts";
import ConsortiaPrayWnd from "../module/consortia/view/ConsortiaPrayWnd.ts";
import ConsortiaTaskWnd from "../module/consortia/view/task/ConsortiaTaskWnd.ts";
import WearyTips from "../tips/WearyTips.ts";
import CastleBuildInfoWnd from "../module/castle/CastleBuildInfoWnd.ts";
import SevenGoalsWnd from "../module/sevengoals/SevenGoalsWnd.ts";
