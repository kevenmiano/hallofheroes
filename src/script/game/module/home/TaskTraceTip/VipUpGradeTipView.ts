...
export class VipUpGradeTipView extends TaskTraceTipWnd {
	...
	initView() {
		...
		let text = LangManager.Instance.GetTranslation("tasktracetip.view.VipUpGradeTipView.ContentTxt",vipGrade);
		this.setContentText(text);
		this.setBtnTitle(LangManager.Instance.GetTranslation("tasktracetip.view.VipUpGradeTipView.BtnTxt"));
	}
