...
export default class WXChannel extends BaseChannel {
  ...
  constructor(id: ChannelID) {
    ...
    wx.setKeepScreenOn({
      keepScreenOn: true,
      success: () => {
        Logger.log("Screen kept on successfully.");
      },
      fail: () => {
        Logger.log("Failed to keep screen on.");
      },
      complete: () => {
        Logger.log("setKeepScreenOn operation completed.");
      },
    });
  }
  ...
  vibrateShort() {
    wx.vibrateShort({
      success: () => Logger.log("Vibration successful."),
      fail: () => Logger.log("Vibration failed."),
      complete: () => Logger.log("Vibration operation completed."),
    });
  }
  ...
  previewImage(imgUrl: string) {
    wx.previewImage({
      ...
      success: () => Logger.log("Image preview successful."),
      fail: () => Logger.log("Image preview failed."),
      complete: () => Logger.log("Image preview operation completed."),
    });
  }
  ...
  navigateToMiniProgram(appID: string) {
    wx.navigateToMiniProgram({
      ...
      extraData: {}, // Pass any extra data if required
      envVersion: "release", // Use 'release', 'trial', or 'develop' as needed
      success: () => {
        Logger.log("Navigation to mini program successful.");
      },
      fail: () => {
        Logger.log("Navigation to mini program failed.");
      },
      complete: () => {
        Logger.log("Navigation to mini program operation completed.");
      },
    });
  }
  showToast(title: string) {
    wx.showToast({
      ...
      mask: false,
      image: "",
      success: () => Logger.log("Toast displayed successfully."),
      fail: () => Logger.log("Failed to display toast."),
      complete: () => Logger.log("Toast display operation completed."),
    });
  }
  postMessage(msg: any) {
