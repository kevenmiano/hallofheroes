...
import { BattleNotic, ChatEvent, IMEvent, NativeEvent } from "../../constant/event/NotificationEvent";
...
export default class BattleWnd extends BaseWindow {
    ...
    */
    ...
    private initView() {
        Logger.battle("战斗UI界面初始化 isPvP:", this.battleModel.isPvP(), "isTrail:", this.battleModel.isTrail(), "录像模式:", BattleRecordReader.inRecordMode)

        /**
         * 动态添加 需要时候创建
         */
        this._hurtUpHandler = new HurtUpHandler(this, this.battleModel.getHurtMode());
        ...
        //初始化自动战斗文本
        let fightTxt = LangManager.Instance.GetTranslation("battle.view.ui.BattleAutoFightAnimation");
        ...
        } else if (BattleManager.Instance.batterModel && BattleManager.Instance.battleModel.battleType != BattleType.OUTYARD_BATLE) {
        ...
        this.gPropSkills.visible = ArmyManager.Instance.thane.grades >= OpenGrades.VEHICEL;

        let showBtnChat = ArmyManager.Instance.thane.grades >= OpenGrades.BATTLE_CHAT
        this.chatMessage.visible = this.btnChat.visible = this.chatMessageBg.visible = this.btnVoice.visible = showBtnChat;
        ...
        if (this.battleModel.isShowAutoFight) {
            NotificationManager.Instance.addEventListener(BattleNotic.AUTO_FIGHT_CHANGED, this.onAutoFightChanged.bind(this), this)
        }
    ...
    private addEvent() {
        this.btnAutoAttack.view.on(fgui.Events.STATE_CHANGED, this, this.btnAutoAttackChangeHandler);
        NotificationManager.Instance.addEventListener(BattleNotic.SET_BATTERUI_VISIBLE, this.__batterUIVisible.bind(this), this);
        NotificationManager.Instance.addEventListener(BattleNotic.SET_RESIST_VISIBLE, this.__resistUIVisible.bind(this), this);
        ...
        NotificationManager.Instance.addEventListener(BattleNotic.SHOW_SKILL_USE_SUCCESS, this.__skillUseSuccess.bind(this), this);
        NotificationManager.Instance.addEventListener(BattleNotic.SKILL_ENABLE, this.__skillEnable.bind(this), this);
        NotificationManager.Instance.addEventListener(ChatEvent.CHAT_FROM_CONSORTIA, this.__receiveGroupChatHandler.bind(this), this);
        IMManager.Instance.addEventListener(IMEvent.MSGBOX_SHINING_UPDATE, this.__msgboxShiningUpdateHandler.bind(this), this);
        NotificationManager.Instance.addEventListener(NativeEvent.AFTER_STATUS_BAR_CHANGE, this.onAfterStatusBarChange, this);

    }

    private removeEvent() {
        this.btnAutoAttack.view.off(fgui.Events.STATE_CHANGED, this, this.btnAutoAttackChangeHandler);
        NotificationManager.Instance.removeEventListener(BattleNotic.SHOW_SKILL_USE_SUCCESS, this.__skillUseSuccess.bind(this), this);
        NotificationManager.Instance.removeEventListener(BattleNotic.SET_BATTERUI_VISIBLE, this.__batterUIVisible.bind(this), this);
        NotificationManager.Instance.removeEventListener(BattleNotic.SET_RESIST_VISIBLE, this.__resistUIVisible.bind(this), this);
        ...
        NotificationManager.Instance.removeEventListener(BattleNotic.SKILL_ENABLE, this.__skillEnable.bind(this), this);
        NotificationManager.Instance.removeEventListener(ChatEvent.CHAT_FROM_CONSORTIA, this.__receiveGroupChatHandler.bind(this), this);
        IMManager.Instance.removeEventListener(IMEvent.MSGBOX_SHINING_UPDATE, this.__msgboxShiningUpdateHandler.bind(this), this);
    ...
    private __resistUIVisible(visible: boolean, side: number) {
        ...
        let _resistUIView: ResistUIView = (side == 1) ? this._resistUIView1 : this._resistUIView2;
    ...
    OnHideWind() {
        ...
        NotificationManager.Instance.removeEventListener(BattleNotic.AUTO_FIGHT_CHANGED, this.onAutoFightChanged.bind(this), this)
        // GodArriveManager.Instance.removeEventListener(GodArriveEvent.GOD_INFO, this.__godArriveHandler.bind(this), this)
    ...
    private btnOwnRoleInfoListClick() {
        FrameCtrlManager.Instance.open(EmWindow.BattleBuffDetailInfo, { type: BattleRoleBufferType.ALL })
    }

    private btnExitRecordClick() {
        let str = LangManager.Instance.GetTranslation("battle.record.closePlay")
        SimpleAlertHelper.Instance.Show(SimpleAlertHelper.SIMPLE_ALERT, null, null, str, null, null, (b: boolean) => {
            if (b) {
