...
export default class FUI_ChatAirBubbleItemCell extends fgui.GComponent {
	...
	public static createInstance():FUI_ChatAirBubbleItemCell {
		return <FUI_ChatAirBubbleItemCell>(fgui.UIPackage.createObject("ChatAirBubble", "ChatAirBubbleItemCell"));
	}
	...
	protected onConstruct():void {
		...
		this.txt_bubble_name = <fgui.GRichTextField>(this.getChild("txt_bubble_name"));
