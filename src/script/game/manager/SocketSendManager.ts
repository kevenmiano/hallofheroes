...
import { Message } from "../../../../../node_modules/protobufjs/index";
...
export class SocketSendManager {
  ...
  public sendUseItem(
    ...
    if (itemInfos) msg.selectItemInfos = itemInfos;
   ...
   *
   */
  public sendSessionOverToBattle(
    mapId: number,
    nodeId: number,
    command: number,
  ) {
  ...
  public sendUseSexChangeCard(pos: number) {
    ...
    let content: string = LangManager.Instance.GetTranslation(
      "yishi.service.managers.SocketSendManager.sendUseSexChangeCard",
    );
  ...
  /**批量移入公会宝箱 */
  public sendOneMoveBagToBag(
    arr: Array<GoodsInfo>,
    beginBagType: number = BagType.Player,
    endBagType: number = BagType.Storage,
  ) {
